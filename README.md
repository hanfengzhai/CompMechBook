...
The table of contents lives in [`src/SUMMARY.md`](src/SUMMARY.md). The narrative is ~100k words across 33 chapters plus prologue, preface, epilogue, and appendix.
