...
chmod +x scripts/sync-writings.sh scripts/build-all-writings.sh scripts/clone-writings.sh
./scripts/clone-writings.sh  # optional: fetch upstream Writings.git
