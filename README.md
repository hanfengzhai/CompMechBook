...
Last verified: Sep 24 2026 00:00 UTC (cron) — sync OK, fixtures PASS, mdbook build OK, links OK, ~289k words; appendix README reading map (rows 26–27 Story so far / Closing the arc) + preface reading-rhythm stitch.
