...
Last verified: Sep 23 2026 19:00 UTC (cron) — sync OK, fixtures PASS, mdbook build OK, links OK, build-all-writings OK, ~290k words; Part VI–IX intra-part Bridge reunion (descent).
