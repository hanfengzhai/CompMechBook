...
Last verified: Sep 23 2026 04:02 UTC (cron) — sync OK, fixtures PASS, mdbook build OK, links OK (~289k words); archived `fixtures/cht_export.yaml` for Handshake 2 pedigree links.
