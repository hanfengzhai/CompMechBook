...
Last verified: Sep 23 2026 15:01 UTC (cron) — sync OK, fixtures PASS, mdbook build OK, links OK (~289k words); [Writings index](writings/SUMMARY.md#one-diagram-ascent-then-descent) ascent/descent arc; Parts I–IX + [appendix continuity map](writings/appendix/README.md#appendix-reading-map-continuity-when-the-plot-stutters) mirror the Functional Analysis Notes chapter guide.
