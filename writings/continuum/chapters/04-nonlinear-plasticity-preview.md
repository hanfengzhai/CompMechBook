...
The [preface descent preview chain](../preface.md#descent-preview-chain) maps the full descent ahead: [Part VII's mesoscale preview](../part07-defects/00-opening.md#the-descent-in-one-paragraph) and [first descent rung](../part07-defects/00-opening.md#first-descent-rung-vi-midpoint-reunion), then [Part VIII's atomistic preview](../part08-md/00-opening.md#the-atomistic-descent-in-one-paragraph), then [Part IX's electronic floor](../part09-dft/00-opening.md#the-electronic-floor-in-one-paragraph). Part VII is the first rung — not the last. Read [Part VII's ME 412 cross-index](../part07-defects/00-opening.md#representative-schematics-me-412-part-vii) when Taylor hardening feels disconnected from the variational ladder you climbed in Parts II–IV.
