...
**Smooth reading rule:** never skip a chapter **Bridge** — it is the hinge that explains why the next scale (or the next discretization) is forced by the physics, not by the syllabus. At the **I.4 → II.0 grammar gate**, read the [Writings canonical hinge](./linear-algebra/chapters/04-toward-infinity.md#writings-canonical-hinge-i4-to-ii0) and [II.0 Closing the arc from Part I](./functional-analysis/chapters/00-opening.md#closing-the-arc-from-part-i) as one continuous handoff (see [row 46](./appendix/chapters/sources.md#rows17-45-writings-canonical-reunion-index-row-46) in the sources appendix). At the **II.5 → III.0 analysis–PDE gate**, read the [Writings canonical hinge](./functional-analysis/chapters/05-spectral-theorem.md#writings-canonical-hinge-ii5-to-iii0) and [III.0 Writings canonical landing](./pde/chapters/00-opening.md#writings-canonical-landing-ii5-to-iii0) as one continuous handoff (see [row 47](./appendix/chapters/sources.md#rows17-46-ii5-iii0-analysis-pde-reunion-index-row-47)). When a turn feels mechanical **inside** Parts I–V, use the [intra-part ascent Bridge reunion tables](./appendix/chapters/sources.md#bridge-reunion-intra-part-ascent-i-v); **inside** Parts VI–IX, use the [intra-part descent Bridge reunion tables](./appendix/chapters/sources.md#bridge-reunion-intra-part-descent-vi-ix) (each part `README.md` links its row).
