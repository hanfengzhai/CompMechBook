...
| IX.3 pedigree row | Act VI subgraph node | Script audit trail parser | Script audit trail row ↔ subgraph node audit | Preface row 16 step | Step audit row |
|-------------------|----------------------|---------------------------|---------------------------------------------|---------------------|----------------|
