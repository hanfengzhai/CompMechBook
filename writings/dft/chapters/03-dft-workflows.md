...
| IX.3 pedigree row | Script audit trail parser | Preface row 16 step | Step audit row |
|-------------------|---------------------------|---------------------|----------------|
| **1 — DFT → continuum** | [`parse_dft_workflow.sh`](../../scripts/parse_dft_workflow.sh), [`parse_elastic.sh`](../../scripts/parse_elastic.sh) | Step 2 — Foundation folder | Row 2 |
| **2 — Joule → CHT** | [`parse_cht.sh`](../../scripts/parse_cht.sh) | Step 1 (understood) + Step 4 (\(\Delta T\) pedigree) | Rows 1, 4 |
| **3 — thermal → mechanical** | [`parse_alpha.sh`](../../scripts/parse_alpha.sh) | Step 1 + Step 4 | Rows 1, 4 |
| **4a — rate hardening** | [`parse_rate.sh`](../../scripts/parse_rate.sh), [`parse_lifetime.sh`](../../scripts/parse_lifetime.sh) | Step 1 + Step 4 (\(\tau_{\text{ph}}\) at \(T_w\)) | Rows 1, 4 |
| **4b — notch localization** | [`parse_fe2.sh`](../../scripts/parse_fe2.sh), [`parse_gsf.sh`](../../scripts/parse_gsf.sh) | Step 1 (understood) | Row 1 |
| **All — orchestrated chain** | [`parse_multiscale_workflow.sh`](../../scripts/parse_multiscale_workflow.sh) | Step 3 — Orchestrated chain | Row 3 |
