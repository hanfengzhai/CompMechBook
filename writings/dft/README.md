...
| SCF converges but `cu.foundation/` archive is missing | [Kohn–Sham → DFT workflows reunion (row 39)](../appendix/chapters/sources.md#kohn-sham-dft-workflows-reunion-index-row-39) · [IX.2 Bridge](chapters/02-kohn-sham.md#bridge) · [IX.3 opening hinge](chapters/03-dft-workflows.md#opening-hinge-ix2-to-ix3) · [foundation archive Lab act](chapters/03-dft-workflows.md#lab-act-archive-the-foundation-run-before-the-wire-scale-solve-act-vi--foundation) |
| `cu.foundation/` complete but handbook \(\alpha\) persists at load cell | [IX.3 → Handshake 3 reunion (row 40)](../appendix/chapters/sources.md#ix3-handshake3-reunion-index-row-40) · [IX.3 opening hinge to Handshake 3](chapters/03-dft-workflows.md#opening-hinge-ix3-to-handshake3) · [quasiharmonic \(\alpha\) Lab act](chapters/03-dft-workflows.md#lab-act-quasiharmonic-alpha-handshake-3-pedigree) · [epilogue Handshake 3 opening hinge](../epilogue/chapters/multiscale.md#opening-hinge-ix3-handshake3) |
