...
When the continuous book stutters mid-read (part boundaries, export pedigree, [thermoelastic assembly (row 29)](./appendix/chapters/sources.md#thermoelastic-assembly-reunion-index-row-29), [CHT outer-loop reunion (row 30)](./appendix/chapters/sources.md#cht-outer-loop-reunion-index-row-30), descent handshakes), use the [appendix reading map](./appendix/README.md#reading-map-continuous-book) — the same navigation table mirrored at the end of [SUMMARY.md](./SUMMARY.md#continuous-reading-order).
