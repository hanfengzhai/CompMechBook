...
**VII.3 → VIII descent handoff reunion (row 35).** If rows 17–34 all read correctly but this Bridge and [Part VIII](../part08-md/00-opening.md) still feel like separate subjects — `mobility.yaml` cites `MD_NVT_shear_PartVIII` without an atomic box, or Peierls stress feels like a fitted constant — read the [VII.3 → VIII descent handoff reunion index](../appendix/sources.md#vii3-viii-descent-handoff-reunion-index-row-35). Complete the mesoscale [Lab act](#lab-act-archive-the-opendis--damask--fem-handoff-act-ivv) first, then read this Bridge export table, the [Part VIII descent hinge](../part08-md/00-opening.md#descent-hinge-cores-mobility-and-tw-pedigree), and the [VIII.1 opening hinge](../part08-md/01-potentials-phase-space.md#opening-hinge-vii3-to-viii1) before running dynamics. Row 35 does not replace row 34 — it reunites **parameter exports with atomistic foundation** when bulk and notch handoffs are archived but the ink behind lines has no atomic address yet.
