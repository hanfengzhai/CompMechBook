...
| Row 0 — Act I mounting (prologue → Part I) | Name how the nine-scale ladder becomes explicit \(\mathbf{K}\mathbf{u}=\mathbf{f}\) grammar with fixed DOFs and zero load | **Step 1:** [Prologue Bridge](../prologue/00-many-scales.md#bridge-to-part-i) one-sentence audit · **Step 2:** four questions filled for FEM on the wire · **Step 3:** \(\mathbf{K}\mathbf{u}=\mathbf{f}\) with boundary tags and \(\mathbf{f}=\mathbf{0}\) · **Step 4:** rigid-body mode removed — [preface row 0](../preface.md#skill-navigation-row-0); [prologue row 0 preview](../prologue/00-many-scales.md#prologue-preview-row-0); [prologue row 0 closing stitch](../prologue/00-many-scales.md#row-0-closing-stitch); [memory sheet row 0 baby picture](../appendix/memory-sheet.md#row-0-baby-picture-act-i-mounting); [row 0 closing loop](#row-0-closing-loop) |
| Row 1 — finite → infinite (I.4 → II.0) | Name how mesh refinement sends \(\mathbf{K}_N\) toward an operator and nodal vectors toward \(H^1\) fields | **Step 1:** [I.4 Bridge](../part01-linear-algebra/04-toward-infinity.md#bridge-to-part-ii) one-sentence audit · **Step 2:** refinement overlay sketch on the bar · **Step 3:** discrete ↔ \(L^2\) inner product table · **Step 4:** link to [Part II opening](../part02-functional-analysis/00-opening.md) — [preface row 1](../preface.md#skill-navigation-row-1); [prologue row 1 preview](../prologue/00-many-scales.md#prologue-preview-row-1); [prologue row 1 closing stitch](../prologue/00-many-scales.md#row-1-closing-stitch); [memory sheet row 1 baby picture](../appendix/memory-sheet.md#row-1-baby-picture-finite-to-infinite); [row 1 closing loop](#row-1-closing-loop) |
| Row 2 — analysis → PDEs (II.5 → III.0) | Name how completeness and spectral theory hand off to weak Poisson/heat forms; Schematic 14 begins | **Step 1:** [II.5 Bridge](../part02-functional-analysis/05-spectral-theorem.md#bridge-to-part-iii) one-sentence audit · **Step 2:** \(H^1_0\)/\(L^2\) vocabulary table on the wire · **Step 3:** [variational ladder](../part03-pdes/00-opening.md#the-variational-ladder-me-412-schematic-14) row completed · **Step 4:** first weak form integral written — [preface row 2](../preface.md#skill-navigation-row-2); [prologue row 2 preview](../prologue/00-many-scales.md#prologue-preview-row-2); [prologue row 2 closing stitch](../prologue/00-many-scales.md#row-2-closing-stitch); [memory sheet row 2 baby picture](../appendix/memory-sheet.md#row-2-baby-picture-analysis-to-pdes); [row 2 closing loop](#row-2-closing-loop) |
| Row 3 — well-posedness → assembly (III.4 → IV.0) | Name how Lax–Milgram and Rayleigh–Ritz become Galerkin assembly; verify energy minimization and \(\mathbf{K}\mathbf{U}=\mathbf{F}\) are the same story | **Step 1:** [III.4 Bridge](../part03-pdes/04-energy-methods.md#bridge-to-part-iv) one-sentence audit · **Step 2:** map \(\Pi[u]\) to \(a(u,v)=\ell(v)\) on the bar · **Step 3:** show hat functions on \(V_h\) yield the same \(\mathbf{K}\) as [IV.2 assembly](../part04-fem/02-galerkin-assembly.md) · **Step 4:** [Galerkin ladder](../part04-fem/00-opening.md#the-galerkin-ladder-me-412-schematic-14-continued) handoff from [variational ladder](../part03-pdes/00-opening.md#the-variational-ladder-me-412-schematic-14) — [preface row 3](../preface.md#skill-navigation-row-3); [prologue row 3 preview](../prologue/00-many-scales.md#prologue-preview-row-3); [prologue row 3 closing stitch](../prologue/00-many-scales.md#row-3-closing-stitch); [memory sheet row 3 baby picture](../appendix/memory-sheet.md#row-3-baby-picture-lax-milgram-to-assembly); [row 3 closing loop](#row-3-closing-loop) |
| Row 4 — discretization fork (IV/V → VI) | Name how Galerkin and conservation dialects split from one weak form; verify both doors reach Part VI | **Step 1:** [III.4 Bridge](../part03-pdes/04-energy-methods.md#bridge-to-part-iv) one-sentence audit · **Step 2:** [IV.5 two doors](../part04-fem/05-convergence.md#bridge-two-doors-from-here) path sketch · **Step 3:** map one FEM row and one FVM row on the wire · **Step 4:** reunion gate to [Part VI midpoint](../part06-continuum/00-opening.md#midpoint-ascent-complete-descent-ahead) — [preface row 4](../preface.md#skill-navigation-row-4); [prologue row 4 preview](../prologue/00-many-scales.md#prologue-preview-row-4); [prologue row 4 closing stitch](../prologue/00-many-scales.md#row-4-closing-stitch); [memory sheet row 4 baby picture](../appendix/memory-sheet.md#row-4-baby-picture-twin-ladders-split); [row 4 closing loop](#row-4-closing-loop) |
| Row 5 — twin ladders reunion (IV/V → VI.0) | Name how Galerkin and conservation dialects reunite on Cauchy stress; verify virtual work connects \(\mathbf{K}\) to force balance | **Step 1:** [Part VI midpoint](../part06-continuum/00-opening.md#midpoint-ascent-complete-descent-ahead) one-sentence audit · **Step 2:** [twin ladders reunion](../part06-continuum/00-opening.md#the-twin-ladders-reunite-galerkin-and-conservation) diagram sketch · **Step 3:** map IV Galerkin row and V conservation row to [VI.3 virtual work](../part06-continuum/03-variational-elasticity.md) · **Step 4:** completed Part VI concept-map row — [preface mathematical midpoint](../preface.md#continuity-hinges-ascent-descent); [prologue row 5 preview](../prologue/00-many-scales.md#prologue-preview-row-5); [prologue row 5 closing stitch](../prologue/00-many-scales.md#row-5-closing-stitch); [memory sheet row 5 baby picture](../appendix/memory-sheet.md#row-5-baby-picture-twin-ladders-reunion); [row 5 closing loop](#row-5-closing-loop) |
| Row 6 — \(J_2\) intermission (VI.4 → VII) | Name why phenomenological \(H\) is a placeholder; verify mesh convergence does not fix wrong hardening slope | **Step 1:** [VI.4 intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) one-sentence audit · **Step 2:** [return-mapping Lab act](../part06-continuum/04-nonlinear-plasticity-preview.md#lab-act-return-mapping-on-the-load-cell-knee-act-iv-hardening) table · **Step 3:** mesh-halving signal documented · **Step 4:** `hardening.yaml` + `viscoplastic.yaml` archived as placeholders — [preface row 6](../preface.md#skill-navigation-row-6); [prologue row 6 preview](../prologue/00-many-scales.md#prologue-preview-row-6); [prologue row 6 closing stitch](../prologue/00-many-scales.md#row-6-closing-stitch); [memory sheet row 6 baby picture](../appendix/memory-sheet.md#row-6-baby-picture-j2-intermission); [row 6 closing loop](#row-6-closing-loop) |
| Row 7 — mesoscale → atomistic (VII.3 → VIII) | Name what DDD borrowed on trust; verify `mobility.yaml` cites MD folder with EAM and core structure | **Step 1:** [VII.3 Bridge](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-to-part-viii) scale-boundary table · **Step 2:** screw-core RVE sketch · **Step 3:** `mobility.yaml` cites `MD_NVT_shear_PartVIII/` · **Step 4:** \(w\), \(\tau_P\), \(\gamma_{\text{sf}}\) from MD → OpenDiS — [preface row 7](../preface.md#skill-navigation-row-7); [prologue row 7 preview](../prologue/00-many-scales.md#prologue-preview-row-7); [prologue row 7 closing stitch](../prologue/00-many-scales.md#row-7-closing-stitch); [VIII.1 opening hinge](../part08-md/01-potentials-phase-space.md#opening-hinge-vii3-to-viii1); [memory sheet row 7 baby picture](../appendix/memory-sheet.md#row-7-baby-picture-mesoscale-to-atomistic); [row 7 closing loop](#row-7-closing-loop) |
| Row 8 — \(T_w\) pedigree (Act II → MD/DDD) | Archive converged \(T_w\) before NVT shear, WHAM, or OpenDiS mobility at 300 K defaults | [`parse_cht.sh`](../../scripts/parse_cht.sh) → `cht_export.yaml`; NVT shear and `mobility_cu_screw_{T_w}K.yaml` at converged \(T_w\); [preface row 8](../preface.md#skill-navigation-row-8); [prologue row 8 preview](../prologue/00-many-scales.md#prologue-preview-row-8); [prologue row 8 closing stitch](../prologue/00-many-scales.md#row-8-closing-stitch); [VIII.0 descent hinge](../part08-md/00-opening.md#descent-hinge-cores-mobility-and-tw-pedigree); [memory sheet rows 8–9 baby picture](../appendix/memory-sheet.md#rows-8-9-baby-picture-tw-temperature-pedigree); [row 8 closing loop](#row-8-closing-loop) |
| Row 9 — phonon audit at \(T_w\) (MD → DFT) | Evaluate \(\alpha(T_w)\) and \(\tau_{\text{ph}}(T_w)\) beside SCF logs, not 300 K folklore alone | [`parse_dft_workflow.sh`](../../scripts/parse_dft_workflow.sh) with `T_w_K` from README or `cht_export.yaml`; [`parse_alpha.sh`](../../scripts/parse_alpha.sh) + [`parse_lifetime.sh`](../../scripts/parse_lifetime.sh) at converged \(T_w\); [preface row 9](../preface.md#skill-navigation-row-9); [prologue row 9 preview](../prologue/00-many-scales.md#prologue-preview-row-9); [prologue row 9 closing stitch](../prologue/00-many-scales.md#row-9-closing-stitch); [IX.0 thermal phonon audit](../part09-dft/00-opening.md#thermal-phonon-audit-at-tw); [memory sheet rows 8–9 baby picture](../appendix/memory-sheet.md#rows-8-9-baby-picture-tw-temperature-pedigree); [row 9 closing loop](#row-9-closing-loop) |
| Row 10 — coupling hinge (IX.3 → epilogue) | Map foundation exports to Handshakes 1–4b; name 4a (Act IV) vs 4b (Act V) split on `hardening.yaml` | Completed [IX.3 epilogue pedigree table](../part09-dft/03-dft-workflows.md#ix3-epilogue-pedigree-table) sketch; [preface row 10](../preface.md#skill-navigation-row-10); [prologue row 10 preview](../prologue/00-many-scales.md#prologue-preview-row-10); [prologue row 10 closing stitch](../prologue/00-many-scales.md#row-10-closing-stitch); [memory sheet row 10](../appendix/memory-sheet.md#continuity-hinges-master-map); [row 10 closing loop](#row-10-closing-loop) |
...
### Row 0 closing loop (Act I mounting reunion) {#row-0-closing-loop}

This subsection is the **downstream half** of [memory sheet row 0](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface opening continuity hinge](../preface.md#opening-continuity-hinge), and the [preface row 0 skill checkpoint](../preface.md#skill-navigation-row-0). The [prologue row 0 preview](../prologue/00-many-scales.md#prologue-preview-row-0) and [prologue row 0 closing stitch](../prologue/00-many-scales.md#row-0-closing-stitch) are the **upstream halves** — return there when the nine-scale ladder feels like a menu before Part I.1 assembles the first matrix. Row 0 closes the prologue → Part I loop that [row 12](#row-12-closing-loop) reopens on the next project: row 0 names **panorama becomes grammar**; [row 1](#row-1-closing-loop) names **vectors become fields**.

**Row 0 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([row 0](../prologue/00-many-scales.md#prologue-preview-row-0)) | [Preface row 0](../preface.md#skill-navigation-row-0) | Workflow exam ([row 0 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | Nine rungs named; four questions for two scales | Step 1 — Ladder sketch | Completed ladder sketch with export column |
| 2 | Four questions table on FEM and MD | Step 2 — Four questions | Completed two-row table from prologue |
| 3 | \(\mathbf{K}\mathbf{u}=\mathbf{f}\) with fixed DOFs, zero load | Step 3 — Mounting model | Sparse \(\mathbf{K}\); \(\mathbf{f}=\mathbf{0}\); \(\mathbf{u}=\mathbf{0}\) |
| 4 | Boundary tags export to every later mesh | Step 4 — BC discipline | Annotated sketch: fixed nodes, removed translation mode |

When the scale ladder feels overwhelming mid-read, start at the [Prologue Bridge](../prologue/00-many-scales.md#bridge-to-part-i) — not at Handshake 1 moduli — and walk forward through [Part I's mounting Lab act](../part01-linear-algebra/00-opening.md#lab-act-i--mounting) before opening [row 1](#row-1-closing-loop). The [memory sheet row 0 baby picture](../appendix/memory-sheet.md#row-0-baby-picture-act-i-mounting) compresses the chain; the [epilogue Act I reunion paragraph](#lab-act-reunion-six-acts-one-afternoon) is the workflow-time mirror. Do not conflate zero-load mounting with Act III's ramp — row 0 certifies boundary discipline; Act III certifies nonzero mechanical load. Proceed to [row 1](#row-1-closing-loop) when \(\mathbf{K}\mathbf{u}=\mathbf{f}\) with fixed DOFs names the same wire the prologue promised.

### Row 1 closing loop (finite → infinite reunion) {#row-1-closing-loop}

This subsection is the **downstream half** of [memory sheet row 1](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface ascent continuity hinges row](../preface.md#ascent-continuity-hinges) (finite → infinite dimensions), and the [preface row 1 skill checkpoint](../preface.md#skill-navigation-row-1). The [prologue row 1 preview](../prologue/00-many-scales.md#prologue-preview-row-1) and [prologue row 1 closing stitch](../prologue/00-many-scales.md#row-1-closing-stitch) are the **upstream halves** — return there when \(\mathbf{K}_N\mathbf{u}_N=\mathbf{f}_N\) feels unrelated to PDEs. Row 1 closes the grammar → analysis loop that [row 0](#row-0-closing-loop) opened at mounting: row 0 names **explicit \(\mathbf{K}\mathbf{u}=\mathbf{f}\)**; row 1 names **\(N\to\infty\) sends nodal values toward fields** before [row 2](#row-2-closing-loop) hands off to weak PDEs.

**Row 1 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([row 1](../prologue/00-many-scales.md#prologue-preview-row-1)) | [Preface row 1](../preface.md#skill-navigation-row-1) | Workflow exam ([row 1 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | One sentence: "Refine until nodal profiles converge to \(u(x)\)" | Step 1 — Bridge audit | Completed [I.4 Bridge](../part01-linear-algebra/04-toward-infinity.md#bridge-to-part-ii) one-sentence audit |
| 2 | Mesh refinement on the bar | Step 2 — Refinement sketch | Annotated \(N=8,16,32\) overlay plot |
| 3 | Riemann sum → \(L^2\) inner product | Step 3 — Inner product limit | Completed discrete ↔ integral table |
| 4 | [Part II opening](../part02-functional-analysis/00-opening.md) handoff | Step 4 — Operator handoff | Link to Part II and [row 2 preview](../prologue/00-many-scales.md#prologue-preview-row-2) documented |

When \(\mathbf{K}\mathbf{u}=\mathbf{f}\) feels unrelated to function spaces, start at [I.4's Bridge](../part01-linear-algebra/04-toward-infinity.md#bridge-to-part-ii) — not at another element type — and recite the [I.4 plot spine](../part01-linear-algebra/04-toward-infinity.md#plot-spine-one-line) before opening [row 2](#row-2-closing-loop). The [memory sheet row 1 baby picture](../appendix/memory-sheet.md#row-1-baby-picture-finite-to-infinite) compresses the chain. Do not conflate eigenmodes in \(\mathbb{R}^N\) with operators on \(H^1\) — I.4 names the limit; Part II names the space. Proceed to [row 2](#row-2-closing-loop) when refinement and \(L^2\) inner products name the same copper-wire profile.

### Row 2 closing loop (analysis → PDEs reunion) {#row-2-closing-loop}

This subsection is the **downstream half** of [memory sheet row 2](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface ascent continuity hinges row](../preface.md#ascent-continuity-hinges) (analysis → PDEs), and the [preface row 2 skill checkpoint](../preface.md#skill-navigation-row-2). The [prologue row 2 preview](../prologue/00-many-scales.md#prologue-preview-row-2) and [prologue row 2 closing stitch](../prologue/00-many-scales.md#row-2-closing-stitch) are the **upstream halves** — return there when Sobolev norms feel abstract and the weak form is not yet the next dialogue. Row 2 closes the analysis → variational loop that [row 1](#row-1-closing-loop) opened at finite → infinite: row 1 names **fields live in \(H^1\)**; row 2 names **completeness hands off to weak forms** before [row 3](#row-3-closing-loop) certifies Lax–Milgram → Galerkin assembly.

**Row 2 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([row 2](../prologue/00-many-scales.md#prologue-preview-row-2)) | [Preface row 2](../preface.md#skill-navigation-row-2) | Workflow exam ([row 2 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | One sentence: "Part II built the room; Part III writes equilibrium in that room" | Step 1 — Bridge audit | Completed [II.5 Bridge](../part02-functional-analysis/05-spectral-theorem.md#bridge-to-part-iii) one-sentence audit |
| 2 | \(H^1_0\), \(L^2\) on the wire domain | Step 2 — Sobolev vocabulary | Completed space ↔ quantity table |
| 3 | [Variational ladder](../part03-pdes/00-opening.md#the-variational-ladder-me-412-schematic-14) begins Schematic 14 | Step 3 — Schematic 14 start | Annotated Schematic 14 row at Part III |
| 4 | First weak Poisson integral | Step 4 — First weak form | One-line weak form for \(-u''=f\) written |

When Sobolev norms feel abstract, start at [II.5's Bridge](../part02-functional-analysis/05-spectral-theorem.md#bridge-to-part-iii) — not at element quadrature — and walk forward through the [variational ladder](../part03-pdes/00-opening.md#the-variational-ladder-me-412-schematic-14) before opening [row 3](#row-3-closing-loop). The [memory sheet row 2 baby picture](../appendix/memory-sheet.md#row-2-baby-picture-analysis-to-pdes) compresses the chain; [III.1's strong form](../part03-pdes/01-strong-form.md) is the downstream consumer that already asks why corners break strong formulations. Do not conflate spectral convergence with weak-form well-posedness — Part II certifies the target space; Part III certifies equilibrium. Proceed to [row 3](#row-3-closing-loop) when the weak form is the next line of dialogue for the same wire and Schematic 14 is ready for Lax–Milgram → assembly.

### Row 3 closing loop (well-posedness → assembly reunion) {#row-3-closing-loop}

This subsection is the **downstream half** of [memory sheet row 3](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface ascent continuity hinges row](../preface.md#ascent-continuity-hinges) (well-posedness → assembly), and the [preface row 3 skill checkpoint](../preface.md#skill-navigation-row-3). The [prologue row 3 preview](../prologue/00-many-scales.md#prologue-preview-row-3) and [prologue row 3 closing stitch](../prologue/00-many-scales.md#row-3-closing-stitch) are the **upstream halves** — return there when energy minimization in Part III and matrix assembly in Part IV feel like unrelated courses. Row 3 closes the variational → assembly loop that [row 2](../part02-functional-analysis/05-spectral-theorem.md#bridge-to-part-iii) opened at analysis → PDEs: row 2 names **completeness hands off to weak forms**; row 3 names **Lax–Milgram becomes Galerkin** before [row 4](#row-4-closing-loop) splits Schematic 14 into twin discretization dialects.

**Row 3 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([row 3](../prologue/00-many-scales.md#prologue-preview-row-3)) | [Preface row 3](../preface.md#skill-navigation-row-3) | Workflow exam ([row 3 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | One sentence: "Minimize \(\Pi[u_h]\) on \(V_h\); the Euler equations are the assembled stiffness system" | Step 1 — Bridge audit | Completed [III.4 Bridge](../part03-pdes/04-energy-methods.md#bridge-to-part-iv) one-sentence audit |
| 2 | [Variational ladder](../part03-pdes/00-opening.md#the-variational-ladder-me-412-schematic-14) names Schematic 14 in Part III | Step 2 — Energy ↔ weak form | Completed \(\Pi[u]\) ↔ \(a(u,v)=\ell(v)\) table on the bar |
| 3 | [Galerkin ladder](../part04-fem/00-opening.md#the-galerkin-ladder-me-412-schematic-14-continued) continues Schematic 14 in Part IV | Step 3 — Rayleigh–Ritz → assembly | Annotated local \(\mathbf{k}_e\) → global \(\mathbf{K}\) sketch |
| 4 | [Memory sheet row 3 baby picture](../appendix/memory-sheet.md#row-3-baby-picture-lax-milgram-to-assembly) | Step 4 — Schematic 14 handoff | Link to [IV opening: closing the arc from Part III](../part04-fem/00-opening.md#closing-the-arc-from-part-iii) documented |

When energy minimization and the scatter loop feel like separate textbooks, start at [III.4's Bridge](../part03-pdes/04-energy-methods.md#bridge-to-part-iv) — not at element quadrature rules — and walk forward through the [Galerkin ladder](../part04-fem/00-opening.md#the-galerkin-ladder-me-412-schematic-14-continued) before opening [row 4](#row-4-closing-loop). The [memory sheet row 3 baby picture](../appendix/memory-sheet.md#row-3-baby-picture-lax-milgram-to-assembly) compresses the chain; [IV.2's assembly Lab act](../part04-fem/02-galerkin-assembly.md) is the downstream consumer that already builds \(\mathbf{K}\) from the energy Part III minimized. Do not conflate proving well-posedness with choosing \(p\)-refinement — Part III certifies existence; Part IV certifies discretization. Proceed to [row 4](#row-4-closing-loop) when Rayleigh–Ritz and Galerkin assembly name the same equilibrium and Schematic 14 is ready to fork into Galerkin and conservation twins.

### Row 4 closing loop (discretization fork reunion) {#row-4-closing-loop}

This subsection is the **downstream half** of [memory sheet row 4](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface ascent continuity hinges row](../preface.md#ascent-continuity-hinges), and the [preface row 4 skill checkpoint](../preface.md#skill-navigation-row-4). The [prologue row 4 preview](../prologue/00-many-scales.md#prologue-preview-row-4) and [prologue row 4 closing stitch](../prologue/00-many-scales.md#row-4-closing-stitch) are the **upstream halves** — return there when Galerkin assembly and FVM flux balance feel like unrelated courses. Row 4 closes the discretization fork loop that [row 3](#row-3-closing-loop) opened at well-posedness → assembly: row 3 names **Lax–Milgram becomes Galerkin**; row 4 names **Galerkin and FVM as twin dialects** before [row 5](#row-5-closing-loop) reunites both on Cauchy stress.

**Row 4 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([row 4](../prologue/00-many-scales.md#prologue-preview-row-4)) | [Preface row 4](../preface.md#skill-navigation-row-4) | Workflow exam ([row 4 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | One sentence: "Weak forms split into Galerkin energy and conservation flux; Part VI reunites both on Cauchy stress" | Step 1 — Fork audit | Completed [III.4 Bridge](../part03-pdes/04-energy-methods.md#bridge-to-part-iv) one-sentence audit |
| 2 | [IV.5 two doors](../part04-fem/05-convergence.md#bridge-two-doors-from-here) names Door A / Door B | Step 2 — Door map | Annotated path sketch: solids-first or fluids-first with reunion gate |
| 3 | [Galerkin ladder](../part04-fem/00-opening.md#the-galerkin-ladder-me-412-schematic-14-continued) + [conservation ladder](../part05-fvm/00-opening.md#the-conservation-ladder-fvm-parallel-to-schematic-14) | Step 3 — Twin ladders | Completed FEM ↔ FVM quantity table on the wire |
| 4 | [Memory sheet row 4 baby picture](../appendix/memory-sheet.md#row-4-baby-picture-twin-ladders-split) | Step 4 — Reunion gate | Link to [Part VI midpoint](../part06-continuum/00-opening.md#midpoint-ascent-complete-descent-ahead) documented |

When Galerkin and Riemann solvers feel like separate textbooks, start at [IV.5's two doors](../part04-fem/05-convergence.md#bridge-two-doors-from-here) — not at another element type — and walk forward through the [conservation ladder](../part05-fvm/00-opening.md#the-conservation-ladder-fvm-parallel-to-schematic-14) or [Galerkin ladder](../part04-fem/00-opening.md#the-galerkin-ladder-me-412-schematic-14-continued) before opening [row 5](#row-5-closing-loop). The [memory sheet row 4 baby picture](../appendix/memory-sheet.md#row-4-baby-picture-twin-ladders-split) compresses the chain; [V.4's conjugate heat Lab act](../part05-fvm/04-navier-stokes-cfd.md#lab-act-extension-two-domain-picard-loop-with-a-1d-fem-solid) is the downstream consumer that already couples both dialects in Act II. Do not conflate Door A (fluids-first) with skipping Part VI — both doors must reunite on Cauchy stress. Proceed to [row 5](#row-5-closing-loop) when the fork is mapped and Part VI is the mandatory reunion, not an optional appendix.

### Row 5 closing loop (twin ladders reunion) {#row-5-closing-loop}

This subsection is the **downstream half** of [memory sheet row 5](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface mathematical midpoint row](../preface.md#continuity-hinges-ascent-descent), and the [Part VI midpoint anchor](../part06-continuum/00-opening.md#midpoint-ascent-complete-descent-ahead). The [prologue row 5 preview](../prologue/00-many-scales.md#prologue-preview-row-5) and [prologue row 5 closing stitch](../prologue/00-many-scales.md#row-5-closing-stitch) are the **upstream halves** — return there when Parts I–V feel like separate subjects and \(\mathbf{K}\mathbf{U}=\mathbf{F}\) still feels like sparse algebra rather than force balance. Row 5 closes the ascent reunion loop that [row 4](#row-4-closing-loop) opened at the twin-ladder split: row 4 names **FEM and FVM as parallel dialects**; row 5 names **Cauchy stress as their reunion** before [row 6](#row-6-closing-loop) asks why phenomenology stops at the knee.

**Row 5 three-way audit (prologue preview ↔ Part VI midpoint ↔ workflow exam).**

| Step | Prologue preview ([row 5](../prologue/00-many-scales.md#prologue-preview-row-5)) | [Part VI midpoint](../part06-continuum/00-opening.md#midpoint-ascent-complete-descent-ahead) | Workflow exam ([row 5 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | One sentence: "Galerkin energy and conservation flux both approximate \(\boldsymbol{\sigma}\); Part VI names the reunion" | Ascent complete; descent ahead | Completed [Part VI midpoint](../part06-continuum/00-opening.md#midpoint-ascent-complete-descent-ahead) one-sentence audit |
| 2 | [Twin ladders reunion](../part06-continuum/00-opening.md#the-twin-ladders-reunite-galerkin-and-conservation) names Schematic 14 twins | [Galerkin ladder](../part04-fem/00-opening.md#the-galerkin-ladder-me-412-schematic-14-continued) + [conservation ladder](../part05-fvm/00-opening.md#the-conservation-ladder-fvm-parallel-to-schematic-14) | Completed twin-ladder diagram sketch linking IV and V to VI.0 |
| 3 | [VI.3 virtual work](../part06-continuum/03-variational-elasticity.md) connects \(\mathbf{K}\) to balance | [Closing the arc from Parts IV and V](../part06-continuum/00-opening.md#closing-the-arc-from-parts-iv-and-v) table | Map IV Galerkin assembly row and V flux-balance row to VI.3 energy statement |
| 4 | [Memory sheet row 5 baby picture](../appendix/memory-sheet.md#row-5-baby-picture-twin-ladders-reunion) | [Part VI concept map](../part06-continuum/00-opening.md#the-concept-map) | Completed concept-map row: object / structure / theorem / failure mode for Part VI |

When Galerkin assembly and Riemann solvers feel like unrelated courses, start at the [prologue row 4 closing stitch](../prologue/00-many-scales.md#row-4-closing-stitch) — then the [Part VI midpoint](../part06-continuum/00-opening.md#midpoint-ascent-complete-descent-ahead) — and walk forward through the [twin ladders reunion](../part06-continuum/00-opening.md#the-twin-ladders-reunite-galerkin-and-conservation) before opening [row 6](#row-6-closing-loop). The [memory sheet row 5 baby picture](../appendix/memory-sheet.md#row-5-baby-picture-twin-ladders-reunion) compresses the chain; [VI.3's virtual work](../part06-continuum/03-variational-elasticity.md) is the downstream consumer this loop feeds. Do not conflate Céa's lemma with Cauchy stress — IV.5 certifies discretization convergence; row 5 certifies that both discretizations approximate the **same mechanical tensors**. Proceed to [row 6](#row-6-closing-loop) when ascent vocabulary reunites on \(\boldsymbol{\sigma}\) and virtual work before the \(J_2\) intermission names where smooth fields fail.

### Row 6 closing loop (\(J_2\) intermission reunion) {#row-6-closing-loop}

This subsection is the **downstream half** of [memory sheet row 6](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface continuity hinges narrative intermission row](../preface.md#continuity-hinges-ascent-descent), and the [preface row 6 skill checkpoint](../preface.md#skill-navigation-row-6). The [prologue row 6 preview](../prologue/00-many-scales.md#prologue-preview-row-6) and [prologue row 6 closing stitch](../prologue/00-many-scales.md#row-6-closing-stitch) are the **upstream halves** — return there when `hardening.yaml` fits the knee but cites no forest density. Row 6 closes the ascent/descent intermission loop that [row 5](#row-5-closing-loop) opened at the twin-ladder reunion: the [prologue row 5 closing stitch](../prologue/00-many-scales.md#row-5-closing-stitch) and [row 5 closing loop](#row-5-closing-loop) are the upstream ascent halves; row 5 names **ascent complete** on Cauchy stress; row 6 names **why phenomenology stops** before [row 7](#row-7-closing-loop) asks where atomic pedigree enters mobility tables.

**Row 6 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([row 6](../prologue/00-many-scales.md#prologue-preview-row-6)) | [Preface row 6](../preface.md#skill-navigation-row-6) | Workflow exam ([row 6 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | One sentence: "\(H\) fits the curve; Taylor hardening and DDD explain why it bent" | Step 1 — Intermission | Completed [VI.4 intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) one-sentence audit |
| 2 | [Return-mapping Lab act](../part06-continuum/04-nonlinear-plasticity-preview.md#lab-act-return-mapping-on-the-load-cell-knee-act-iv-hardening) names Act IV knee | Step 2 — Return-mapping | Completed return-mapping increment table with \(H\), \(\sigma_{y0}\) |
| 3 | [Memory sheet row 6 baby picture](../appendix/memory-sheet.md#row-6-baby-picture-j2-intermission) | Step 3 — Convergence signal | Mesh-halving audit: post-yield slope unchanged after IV.5 convergence |
| 4 | [VI.4 Bridge to Part VII](../part06-continuum/04-nonlinear-plasticity-preview.md#bridge-to-part-vii) is downstream consumer | Step 4 — Placeholder archive | `hardening.yaml` + `viscoplastic.yaml` with `source: phenomenological fit; pedigree pending Part VII` |

When the return-mapping loop fits the load cell but cold-drawn \(\sigma_{y0}\) still feels arbitrary, start at the [VI.4 intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) — not at Part VII integrators — and walk forward through the [return-mapping Lab act](../part06-continuum/04-nonlinear-plasticity-preview.md#lab-act-return-mapping-on-the-load-cell-knee-act-iv-hardening) before opening [row 7](#row-7-closing-loop). The [memory sheet row 6 baby picture](../appendix/memory-sheet.md#row-6-baby-picture-j2-intermission) compresses the chain; the [Part VII opening](../part07-defects/00-opening.md#the-descent-in-one-paragraph) is the downstream consumer this loop feeds. Do not conflate fitted \(H\) with forest physics — \(H\) homogenizes the knee; \(\rho\) and Taylor \(\tau \propto \sqrt{\rho}\) explain why drawing raised \(\sigma_{y0}\). Proceed to [row 7](#row-7-closing-loop) when `hardening.yaml` is archived as a placeholder and Part VII names the forest explicitly.

### Row 7 closing loop (mesoscale → atomistic reunion) {#row-7-closing-loop}

This subsection is the **downstream half** of [memory sheet row 7](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface descent continuity hinges row 7](../preface.md#descent-continuity-hinges), and the [preface row 7 skill checkpoint](../preface.md#skill-navigation-row-7). The [prologue row 7 preview](../prologue/00-many-scales.md#prologue-preview-row-7) and [prologue row 7 closing stitch](../prologue/00-many-scales.md#row-7-closing-stitch) are the **upstream halves** — return there when `mobility.yaml` cites Part VIII without an atomic box or EAM archive. Row 7 closes the mesoscale → atomistic loop that [VI.4 intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) opened at the forest: the [prologue row 6 closing stitch](../prologue/00-many-scales.md#row-6-closing-stitch) and [row 6 closing loop](#row-6-closing-loop) are the upstream phenomenology halves; row 6 names **why** the curve bent; row 7 names **where** mobility and \(\gamma_{\text{sf}}\) acquire atomic coordinates before [row 8](../preface.md#skill-navigation-row-8) adds the \(T_w\) temperature contract.

**Row 7 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([row 7](../prologue/00-many-scales.md#prologue-preview-row-7)) | [Preface row 7](../preface.md#skill-navigation-row-7) | Workflow exam ([row 7 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | One sentence: "OpenDiS segment laws cite MD; MD cites EAM and relaxed core coordinates" | Step 1 — VII.3 Bridge | Completed [VII.3 scale-boundary handshake table](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-to-part-viii) sketch |
| 2 | [VIII.1 opening hinge](../part08-md/01-potentials-phase-space.md#opening-hinge-vii3-to-viii1) names coordinates and forces | Step 2 — Screw-core RVE | Annotated RVE sketch: ~10 nm cube, screw along [110] |
| 3 | [Memory sheet row 7 baby picture](../appendix/memory-sheet.md#row-7-baby-picture-mesoscale-to-atomistic) | Step 3 — mobility.yaml pedigree | `mobility.yaml` cites `MD_NVT_shear_PartVIII/` with EAM path and \(a_0\) |
| 4 | [VII.2 mobility Lab act](../part07-defects/02-dislocation-dynamics.md#lab-act-calibrate-screw-mobility-from-md-shear-act-iv--mobility-prelude) is downstream consumer | Step 4 — Core structure export | \(w\), \(\tau_P\), \(\gamma_{\text{sf}}\) table from MD → OpenDiS segment laws |

When mobility tables feel like literature defaults without an MD folder path, start at [VII.3's Bridge](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-to-part-viii) — not at Part VIII integrators — and walk forward through the [VIII.1 opening hinge](../part08-md/01-potentials-phase-space.md#opening-hinge-vii3-to-viii1) before opening [row 8](../preface.md#skill-navigation-row-8). The [memory sheet row 7 baby picture](../appendix/memory-sheet.md#row-7-baby-picture-mesoscale-to-atomistic) compresses the chain; the [VII.3 rate handshake](../part07-defects/03-polycrystal-and-fem-handoff.md#scale-boundary-handshake-ddd-strain-rate-to-quasi-static-fem) is the downstream consumer this loop feeds into Handshake 4a. Do not conflate Taylor hardening fit with mobility pedigree — \(\rho\) explains the curve bend; \(M(\tau,T)\) explains segment velocity. Proceed to [row 8](../preface.md#skill-navigation-row-8) when `mobility.yaml` cites an MD folder with EAM and core structure before any temperature-specific drag calibration.

### Row 8 closing loop (\(T_w\) pedigree reunion) {#row-8-closing-loop}

This subsection is the **downstream half** of [memory sheet row 8](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface descent continuity hinges row 8](../preface.md#descent-continuity-hinges), and the [preface row 8 skill checkpoint](../preface.md#skill-navigation-row-8). The [prologue row 8 preview](../prologue/00-many-scales.md#prologue-preview-row-8) and [prologue row 8 closing stitch](../prologue/00-many-scales.md#row-8-closing-stitch) are the **upstream halves** — return there when MD mobility or OpenDiS drag folders cite 300 K after Act II warmed the wire. Row 8 opens the temperature pedigree loop that [row 9](../preface.md#skill-navigation-row-9) continues at the electronic scale: row 8 sets converged wall temperature; row 9 audits \(\alpha(T_w)\) and \(\tau_{\text{ph}}(T_w)\) before [row 10](../preface.md#skill-navigation-row-10) composes foundation exports into Handshakes 1–4b.

**Row 8 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([row 8](../prologue/00-many-scales.md#prologue-preview-row-8)) | [Preface row 8](../preface.md#skill-navigation-row-8) | Workflow exam ([row 8 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | Sketch: V.4 Picard loop → `cht_export.yaml` | Step 1 — Handshake 2 | [`parse_cht.sh`](../../scripts/parse_cht.sh) → `cht_export.yaml`; converged \(T_w \approx 379\,\text{K}\), \(\Delta T = T_w - T_\infty\) |
| 2 | [VIII.0 descent hinge](../part08-md/00-opening.md#descent-hinge-cores-mobility-and-tw-pedigree) names \(T_w\) contract | Step 2 — NVT shear at \(T_w\) | `mobility_cu_screw_{T_w}K.yaml` beside `cht_export.yaml` — [VII.2 Lab act](../part07-defects/02-dislocation-dynamics.md#lab-act-calibrate-screw-mobility-from-md-shear-act-iv--mobility-prelude) |
| 3 | [Preview Act II row](#reunion-preview-act-ii) (Handshake 2) | Step 3 — WHAM reweight | [`parse_wham.sh`](../../scripts/parse_wham.sh) at `--target-t` from `cht_export.yaml` → `wham_export.yaml` |
| 4 | [Memory sheet rows 8–9 baby picture](../appendix/memory-sheet.md#rows-8-9-baby-picture-tw-temperature-pedigree) | Step 4 — OpenDiS pedigree | OpenDiS input cites `M(\tau, T_w)`, not 300 K default; cross-slip counts at \(T_w\) archived beside WHAM export |

When MD mobility folders cite 300 K after CHT converged, start at [V.4's Picard loop](../part05-fvm/04-navier-stokes-cfd.md#lab-act-extension-two-domain-picard-loop-with-a-1d-fem-solid) — not at Part VIII — and walk forward through the [VIII.0 descent hinge](../part08-md/00-opening.md#descent-hinge-cores-mobility-and-tw-pedigree) before opening [row 9](../preface.md#skill-navigation-row-9). The [memory sheet rows 8–9 baby picture](../appendix/memory-sheet.md#rows-8-9-baby-picture-tw-temperature-pedigree) compresses the chain; the [Act II expanded reunion paragraph](#reunion-expanded-act-ii) is the downstream half this loop expands. Do not conflate handbook 300 K drag with Joule-heated \(T_w\) — phonon softening shifts Act IV hardening before Part IX audits the phonon curve. Proceed to [row 9](../preface.md#skill-navigation-row-9) when `cht_export.yaml` exists with an explicit \(T_w\) column beside every finer-rung export.

### Row 9 closing loop (phonon audit reunion) {#row-9-closing-loop}

This subsection is the **downstream half** of [memory sheet row 9](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface descent continuity hinges row 9](../preface.md#descent-continuity-hinges), and the [preface row 9 skill checkpoint](../preface.md#skill-navigation-row-9). The [prologue row 9 preview](../prologue/00-many-scales.md#prologue-preview-row-9) and [prologue row 9 closing stitch](../prologue/00-many-scales.md#row-9-closing-stitch) are the **upstream halves** — return there when EAM matches bulk moduli but `alpha_export.yaml` lacks \(\alpha(T_w)\) beside SCF logs. Row 9 closes the phonon audit loop that [row 8](../preface.md#skill-navigation-row-8) opened at \(T_w\) pedigree: the [prologue row 8 closing stitch](../prologue/00-many-scales.md#row-8-closing-stitch) and [row 8 closing loop](#row-8-closing-loop) are the upstream temperature halves; row 8 sets converged wall temperature; row 9 audits \(\alpha(T_w)\) and \(\tau_{\text{ph}}(T_w)\) at the electronic scale before [row 10](../preface.md#skill-navigation-row-10) composes foundation exports into Handshakes 1–4b.

**Row 9 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([row 9](../prologue/00-many-scales.md#prologue-preview-row-9)) | [Preface row 9](../preface.md#skill-navigation-row-9) | Workflow exam ([row 9 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | One sentence: "SCF audits moduli; phonon audit audits thermal exports at the same \(T_w\)" | Step 1 — Row 8 complete | `cht_export.yaml` with converged `T_wall_K` from [`parse_cht.sh`](../../scripts/parse_cht.sh) |
| 2 | [IX.0 thermal phonon audit](../part09-dft/00-opening.md#thermal-phonon-audit-at-tw) lists three quantities at risk | Step 2 — SCF audit | `foundation_export.yaml` via [`parse_dft_workflow.sh`](../../scripts/parse_dft_workflow.sh) on `cu.foundation/` |
| 3 | [Preview Act III row](#reunion-preview-act-iii) (Handshake 3 \(\alpha\)) and [preview Act IV row](#reunion-preview-act-iv) (Handshake 4a \(\tau_{\text{ph}}\) drag) | Step 3 — \(\alpha(T_w)\) | [`parse_alpha.sh`](../../scripts/parse_alpha.sh) with `--target-t` from `cht_export.yaml` → `alpha_export.yaml` |
| 4 | [Sensitivity derivation](../epilogue/multiscale.md#worked-example-sensitivity-ranks) (Handshakes 3 and 4a columns) | Step 4 — \(\tau_{\text{ph}}(T_w)\) | [`parse_lifetime.sh`](../../scripts/parse_lifetime.sh) at converged \(T_w\) beside `mobility_cu_screw_{T_w}K.yaml` |

When EAM fits look credible but the foundation folder lacks an explicit **`T_w` column**, start at the [IX.0 electronic audit hinge](../part09-dft/00-opening.md#electronic-audit-hinge-descent-pedigree-and-tw-phonon) — not at the epilogue coupling hinge — and walk forward through the [thermal phonon audit table](../part09-dft/00-opening.md#thermal-phonon-audit-at-tw) before opening [row 10](../preface.md#skill-navigation-row-10). The [memory sheet rows 8–9 baby picture](../appendix/memory-sheet.md#rows-8-9-baby-picture-tw-temperature-pedigree) compresses the chain; the [epilogue opening hinge from Part IX](#opening-hinge-ix3-to-epilogue) is the downstream half this loop expands. Do not conflate \(\alpha(300\,\text{K})\) handbook comparison with \(\alpha(T_w)\) production export — SCF audits moduli; the phonon audit audits thermal eigenstrain at the same \(T_w\) Act II converged. Proceed to [row 10](../preface.md#skill-navigation-row-10) when foundation exports need handshake composition, or to [row 13](../preface.md#skill-navigation-row-13) for the Handshake 2 → 3 chain once rows 8–9 are complete.

### Row 10 closing loop (coupling hinge reunion) {#row-10-closing-loop}

This subsection is the **downstream half** of [memory sheet row 10](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface coupling hinge row](../preface.md#epilogue-continuity-hinges), and the [preface row 10 skill checkpoint](../preface.md#skill-navigation-row-10). The [prologue row 10 preview](../prologue/00-many-scales.md#prologue-preview-row-10) and [prologue row 10 closing stitch](../prologue/00-many-scales.md#row-10-closing-stitch) are the **upstream halves** — return there when Part IX feels complete but foundation exports live in separate folders with no handshake map. Row 10 closes the composition loop that rows 8–9 opened at \(T_w\) pedigree: row 8 sets converged wall temperature; row 9 audits \(\alpha(T_w)\) and \(\tau_{\text{ph}}(T_w)\); row 10 maps each IX.3 export to its epilogue handshake and names the **4a/4b split** on the same `hardening.yaml`.

**Row 10 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([row 10](../prologue/00-many-scales.md#prologue-preview-row-10)) | [Preface row 10](../preface.md#skill-navigation-row-10) | Workflow exam ([row 10 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | One sentence: "IX.3 archives pedigree; epilogue composes Handshakes 1–4b — 4a is bulk hardening, 4b is notch localization" | Step 1 — Rows 8–9 complete | `cht_export.yaml`, `alpha_export.yaml`, and SCF logs share the same \(T_w\) column |
| 2 | [IX.3 epilogue pedigree table](../part09-dft/03-dft-workflows.md#ix3-epilogue-pedigree-table) maps artifacts to Handshakes 1–4b | Step 2 — Pedigree table | Completed pedigree table sketch: moduli → CHT → \(\alpha\) → rate → GSF/notch |
| 3 | [Preview Act IV row](#reunion-preview-act-iv) (4a) vs [preview Act V row](#reunion-preview-act-v) (4b) | Step 3 — 4a/4b split | One sentence: "4a for Act IV knee; 4b only when Act V notch activates" |
| 4 | [Coupling hinge paragraph](#opening-hinge-ix3-to-epilogue) reunites foundation → handshakes | Step 4 — Coupling hinge | Annotated workflow sketch linking foundation folder → handshake sections |

When foundation folders exist but Handshakes 4a and 4b feel undifferentiated, start at [IX.3's Bridge to the epilogue](../part09-dft/03-dft-workflows.md#bridge-to-the-epilogue) — not at individual handshake sections — and walk forward through the [IX.3 epilogue pedigree table](../part09-dft/03-dft-workflows.md#ix3-epilogue-pedigree-table) before opening rows 13–16. The [memory sheet row 10](../appendix/memory-sheet.md#continuity-hinges-master-map) compresses the composition chain; the [coupling hinge paragraph](#opening-hinge-ix3-to-epilogue) is the upstream half this loop expands. Do not conflate foundation archiving (row 10) with orchestrated export ([row 16](../preface.md#skill-navigation-row-16)) — row 10 names **what composes**; row 16 proves **dependency order** in `multiscale_export.yaml`. Proceed to [row 11](../preface.md#skill-navigation-row-11) when workflow order is unclear, or to [row 13](../preface.md#skill-navigation-row-13) for individual handshake chains once the composition map is complete.
