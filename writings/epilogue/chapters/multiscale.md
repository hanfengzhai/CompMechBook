...
| Row 0 — Act I mounting (prologue → Part I) | Sketch \(\mathbf{K}\mathbf{u}=\mathbf{f}\) with fixed DOFs; name boundary tags that export to every later mesh | **Step 1:** nine-rung ladder sketch · **Step 2:** four-questions table for FEM and MD · **Step 3:** zero-load mounting model · **Step 4:** rigid-body removal annotated — [preface row 0](../preface.md#skill-navigation-row-0); [prologue Act I preview](../prologue/00-many-scales.md#prologue-preview-act-i); [prologue row 0 closing stitch](../prologue/00-many-scales.md#row-0-closing-stitch); [I.1 three-node assembly](../part01-linear-algebra/01-vectors-matrices.md#lab-act-three-nodes-one-load-cell-reading-act-i--mounting); [memory sheet row 0](../appendix/memory-sheet.md#continuity-hinges-master-map); [row 0 closing loop](#row-0-closing-loop) |
| Row 1 — finite → infinite (I.4 → II) | Explain mesh refinement limit; recite I.4 plot spine; name the operator \(\mathbf{K}_N\) approximates | **Step 1:** [I.4 plot spine](../part01-linear-algebra/04-toward-infinity.md#plot-spine-one-line) recitation · **Step 2:** two refinement steps with same profile · **Step 3:** [I.4 Bridge](../part01-linear-algebra/04-toward-infinity.md#bridge-to-part-ii) summary · **Step 4:** Part II opening skill row — [Part I skill table](../part01-linear-algebra/00-opening.md#what-you-should-be-able-to-do-after-part-i); [prologue row 1 preview](../prologue/00-many-scales.md#prologue-preview-row-1); [prologue row 1 closing stitch](../prologue/00-many-scales.md#row-1-closing-stitch); [memory sheet row 1](../appendix/memory-sheet.md#continuity-hinges-master-map); [row 1 closing loop](#row-1-closing-loop) |
| Row 2 — analysis → PDEs (II.5 → III) | State why weak forms replace strong forms at grips and corners; map a load functional to a test function | **Step 1:** [II.5 Bridge](../part02-functional-analysis/05-spectral-theorem.md#bridge-to-part-iii) summary · **Step 2:** weak Poisson sketch on wire domain · **Step 3:** [Part III variational ladder](../part03-pdes/00-opening.md#the-variational-ladder-me-412-schematic-14) row · **Step 4:** Part III opening skill row — [Part II skill table](../part02-functional-analysis/00-opening.md#what-you-should-be-able-to-do-after-part-ii); [prologue row 2 preview](../prologue/00-many-scales.md#prologue-preview-row-2); [prologue row 2 closing stitch](../prologue/00-many-scales.md#row-2-closing-stitch); [memory sheet row 2](../appendix/memory-sheet.md#continuity-hinges-master-map); [row 2 closing loop](#row-2-closing-loop) |
| Row 3 — well-posedness → assembly (III.4 → IV) | Map bilinear form \(a(u,v)\) to element stiffness; run patch test on one element | **Step 1:** [III.4 Bridge](../part03-pdes/04-energy-methods.md#bridge-to-part-iv) summary · **Step 2:** Lax–Milgram hypotheses on wire BVP · **Step 3:** local-to-global assembly sketch · **Step 4:** Part IV opening skill row — [Part III skill table](../part03-pdes/00-opening.md#what-you-should-be-able-to-do-after-part-iii); [prologue row 3 preview](../prologue/00-many-scales.md#prologue-preview-row-3); [prologue row 3 closing stitch](../prologue/00-many-scales.md#row-3-closing-stitch); [memory sheet row 3](../appendix/memory-sheet.md#continuity-hinges-master-map); [row 3 closing loop](#row-3-closing-loop) |
| Row 4 — discretization fork → continuum (IV.5 / V.4 → VI) | Map one FEM energy rung and one FVM flux rung to the same balance law; name Door A vs Door B | **Step 1:** [IV.5 two doors](../part04-fem/05-convergence.md#bridge-two-doors-from-here) choice annotated · **Step 2:** face flux row beside \(\mathbf{K}\mathbf{U}=\mathbf{F}\) row · **Step 3:** [V.4 CHT](../part05-fvm/04-navier-stokes-cfd.md#lab-act-extension-two-domain-picard-loop-with-a-1d-fem-solid) coupling sketch · **Step 4:** [twin ladders](../part06-continuum/00-opening.md#the-twin-ladders-reunite-galerkin-and-conservation) preview — [Part IV](../part04-fem/00-opening.md#what-you-should-be-able-to-do-after-part-iv) and [Part V](../part05-fvm/00-opening.md#what-you-should-be-able-to-do-after-part-v) skill tables; [prologue row 4 preview](../prologue/00-many-scales.md#prologue-preview-row-4); [prologue row 4 closing stitch](../prologue/00-many-scales.md#row-4-closing-stitch); [memory sheet row 4](../appendix/memory-sheet.md#continuity-hinges-master-map); [row 4 closing loop](#row-4-closing-loop) |
| Row 5 — mathematical midpoint (Part VI opening) | Map Galerkin and conservation twins to Cauchy stress; recite VI.0 plot spine; name ascent hinges 1–4 | **Step 1:** [VI.0 plot spine](../part06-continuum/00-opening.md#plot-spine-one-line) recitation · **Step 2:** completed [twin ladders](../part06-continuum/00-opening.md#the-twin-ladders-reunite-galerkin-and-conservation) table row · **Step 3:** ascent hinge chain annotated · **Step 4:** midpoint paragraph — [preface row 5](../preface.md#skill-navigation-row-5); [prologue row 5 preview](../prologue/00-many-scales.md#prologue-preview-row-5); [prologue row 5 closing stitch](../prologue/00-many-scales.md#row-5-closing-stitch); [VI.0 midpoint](../part06-continuum/00-opening.md#midpoint-ascent-complete-descent-ahead); [memory sheet row 5](../appendix/memory-sheet.md#continuity-hinges-master-map); [row 5 closing loop](#row-5-closing-loop) |
| Row 6 — ascent ends at the knee (VI.4 intermission) | Run return-mapping audit; name three descent signals; archive `hardening.yaml` with Part VII pointer | **Step 1:** [VI.4 plot spine](../part06-continuum/04-nonlinear-plasticity-preview.md#plot-spine-one-line) recitation · **Step 2:** [return-mapping Lab act](../part06-continuum/04-nonlinear-plasticity-preview.md#lab-act-return-mapping-on-the-load-cell-knee-act-iv-hardening) table · **Step 3:** three descent signals annotated on load trace · **Step 4:** `hardening.yaml` beside FEM deck — [preface row 6](../preface.md#skill-navigation-row-6); [prologue row 6 preview](../prologue/00-many-scales.md#prologue-preview-row-6); [prologue row 6 closing stitch](../prologue/00-many-scales.md#row-6-closing-stitch); [VI.4 intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins); [memory sheet row 6](../appendix/memory-sheet.md#continuity-hinges-master-map); [row 6 closing loop](#row-6-closing-loop) |
| Row 7 — mesoscale → atomistic (VII.3 → VIII) | Archive EAM RVE and NVT trajectory before OpenDiS `mobility.yaml` cites Part VIII on trust | [VII.3 Bridge](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-to-part-viii) → [VIII.1 EAM Lab act](../part08-md/01-potentials-phase-space.md#lab-act-eam-lattice-constant-from-energy-minimization-act-v--notch-prelude) → `MD_NVT_shear_PartVIII/`; [preface row 7](../preface.md#skill-navigation-row-7); [prologue row 7 preview](../prologue/00-many-scales.md#prologue-preview-row-7); [prologue row 7 closing stitch](../prologue/00-many-scales.md#row-7-closing-stitch); [VIII.1 opening hinge](../part08-md/01-potentials-phase-space.md#opening-hinge-vii3-to-viii1); [memory sheet row 7](../appendix/memory-sheet.md#continuity-hinges-master-map); [row 7 closing loop](#row-7-closing-loop) |
...
This subsection is the **downstream half** of [memory sheet row 0](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface opening continuity hinge](../preface.md#opening-continuity-hinge), and the [preface row 0 skill checkpoint](../preface.md#skill-navigation-row-0). The [prologue Act I preview](../prologue/00-many-scales.md#prologue-preview-act-i) and [prologue row 0 closing stitch](../prologue/00-many-scales.md#row-0-closing-stitch) are the **upstream halves** — return there when the nine-scale ladder feels like a menu before a single matrix is assembled. Row 0 closes the prologue → Part I grammar loop before [row 1](#row-1-closing-loop) sends nodal values toward fields: row 0 names **where** the story becomes finite-dimensional; row 1 names **when** those dimensions become infinite.

**Row 0 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([Act I](../prologue/00-many-scales.md#prologue-preview-act-i)) | [Preface row 0](../preface.md#skill-navigation-row-0) | Workflow exam ([row 0 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | Nine-rung ladder sketch | Step 1 — Ladder sketch | One-row ladder: algebra → … → DFT |
| 2 | Four questions table for two scales | Step 2 — Four questions | Completed FEM and MD rows on same wire |
...
| 4 | [Part I opening hinge](../part01-linear-algebra/00-opening.md#opening-hinge-prologue-to-part-i) — BC discipline | Step 4 — BC discipline | Annotated sketch: fixed nodes, removed translation mode |

When DFT, MD, and FEM feel like separate courses before Part I.1 runs, start at the [prologue Bridge](../prologue/00-many-scales.md#bridge-to-part-i) — not at Part IX — and walk forward through [I.1's three-node assembly](../part01-linear-algebra/01-vectors-matrices.md#lab-act-three-nodes-one-load-cell-reading-act-i--mounting) until \(\mathbf{K}\mathbf{u}=\mathbf{f}\) is on paper. The [epilogue Act I reunion paragraph](#lab-act-reunion-six-acts-one-afternoon) is the workflow-time mirror when mounting discipline must export to every later handshake. Do not conflate zero-load assembly with Act III's ramp or Handshake 1's DFT moduli — row 0 is grammar only. Proceed to [row 1](../prologue/00-many-scales.md#row-1-closing-stitch) when \(\mathbf{K}\mathbf{u}=\mathbf{f}\) is solid but mesh refinement still feels unrelated to PDEs.

### Row 1 closing loop (finite → infinite reunion) {#row-1-closing-loop}

This subsection is the **downstream half** of [memory sheet row 1](../appendix/memory-sheet.md#continuity-hinges-master-map) and the [preface ascent continuity hinges](../preface.md#ascent-continuity-hinges) row 1. The [prologue row 1 preview](../prologue/00-many-scales.md#prologue-preview-row-1) and [prologue row 1 closing stitch](../prologue/00-many-scales.md#row-1-closing-stitch) are the **upstream halves** — return there when \(\mathbf{K}\mathbf{u}=\mathbf{f}\) feels unrelated to Poisson or heat equations on the wire. Row 1 closes the I.4 → Part II loop before [row 2](#row-2-closing-loop) hands completeness to weak forms: row 1 names **when** vectors become fields; row 2 names **why** those fields need weak formulations.

**Row 1 three-way audit (prologue preview ↔ part skill table ↔ workflow exam).**

| Step | Prologue preview ([row 1](../prologue/00-many-scales.md#prologue-preview-row-1)) | [Part I skill table](../part01-linear-algebra/00-opening.md#what-you-should-be-able-to-do-after-part-i) | Workflow exam ([row 1 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | Halve \(h\) → same profile sketch | I.4 limit-object skill | [I.4 plot spine](../part01-linear-algebra/04-toward-infinity.md#plot-spine-one-line) recited aloud |
| 2 | [I.4 Bridge](../part01-linear-algebra/04-toward-infinity.md#bridge-to-part-ii) summary | Part I completion row | Two refinement steps documented |
| 3 | Part II opening named | I.4 → II hinge | Bridge paragraph in notes |
| 4 | Operator language preview | Part II opening skill row | Part II skill table row complete |

When nodal arrays feel like bookkeeping separate from physics, start at the [I.4 Bridge](../part01-linear-algebra/04-toward-infinity.md#bridge-to-part-ii) — not at a new matrix chapter — and recite the [I.4 plot spine one line](../part01-linear-algebra/04-toward-infinity.md#plot-spine-one-line) before opening Part II. Row 20's first gate audit applies here when row 17's straight read stalls. Proceed to [row 2](../prologue/00-many-scales.md#row-2-closing-stitch) when fields live in \(H^1\) but weak Poisson still feels abstract.

### Row 2 closing loop (analysis → PDEs reunion) {#row-2-closing-loop}

This subsection is the **downstream half** of [memory sheet row 2](../appendix/memory-sheet.md#continuity-hinges-master-map) and the [preface ascent continuity hinges](../preface.md#ascent-continuity-hinges) row 2. The [prologue row 2 preview](../prologue/00-many-scales.md#prologue-preview-row-2) and [prologue row 2 closing stitch](../prologue/00-many-scales.md#row-2-closing-stitch) are the **upstream halves** — return there when Sobolev norms feel abstract before weak forms on the wire. Row 2 closes the II.5 → Part III loop before [row 3](#row-3-closing-loop) turns well-posedness into assembly: row 2 names **why** test functions exist; row 3 names **how** they become sparse matrices.

**Row 2 three-way audit (prologue preview ↔ part skill table ↔ workflow exam).**

| Step | Prologue preview ([row 2](../prologue/00-many-scales.md#prologue-preview-row-2)) | [Part II skill table](../part02-functional-analysis/00-opening.md#what-you-should-be-able-to-do-after-part-ii) | Workflow exam ([row 2 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | Loads as functionals sentence | Part II completion row | [II.5 Bridge](../part02-functional-analysis/05-spectral-theorem.md#bridge-to-part-iii) summary |
| 2 | [Part III variational ladder](../part03-pdes/00-opening.md#the-variational-ladder-me-412-schematic-14) named | Weak-form skill row | Weak Poisson sketch on wire domain |
| 3 | Integration-by-parts hinge | Riesz / dual-space row | Test function carries concentrated load |
| 4 | Part III opening preview | Part III opening skill row | Part III skill table row complete |

When corners and grips break strong-form smoothness, start at the [II.5 Bridge](../part02-functional-analysis/05-spectral-theorem.md#bridge-to-part-iii) — not at another norm proof — and read the [Part III variational ladder](../part03-pdes/00-opening.md#the-variational-ladder-me-412-schematic-14) beside the wire geometry. Proceed to [row 3](../prologue/00-many-scales.md#row-3-closing-stitch) when the weak form is clear but Galerkin assembly still feels like separate linear algebra.

### Row 3 closing loop (well-posedness → assembly reunion) {#row-3-closing-loop}

This subsection is the **downstream half** of [memory sheet row 3](../appendix/memory-sheet.md#continuity-hinges-master-map) and the [preface ascent continuity hinges](../preface.md#ascent-continuity-hinges) row 3. The [prologue row 3 preview](../prologue/00-many-scales.md#prologue-preview-row-3) and [prologue row 3 closing stitch](../prologue/00-many-scales.md#row-3-closing-stitch) are the **upstream halves** — return there when energy minimization and matrix assembly seem like separate tricks. Row 3 closes the III.4 → Part IV loop before [row 4](#row-4-closing-loop) forks into FEM and FVM: row 3 names **how** Lax–Milgram becomes \(\mathbf{K}\); row 4 names **why** two discretizations reunite on stress.

**Row 3 three-way audit (prologue preview ↔ part skill table ↔ workflow exam).**

| Step | Prologue preview ([row 3](../prologue/00-many-scales.md#prologue-preview-row-3)) | [Part III skill table](../part03-pdes/00-opening.md#what-you-should-be-able-to-do-after-part-iii) | Workflow exam ([row 3 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | Bilinear form → element matrices sketch | Part III completion row | [III.4 Bridge](../part03-pdes/04-energy-methods.md#bridge-to-part-iv) summary |
| 2 | Lax–Milgram on wire BVP | Coercivity skill row | Hypotheses listed for wire equilibrium |
| 3 | [Part IV Galerkin ladder](../part04-fem/00-opening.md#the-galerkin-ladder-me-412-schematic-14-continued) named | Rayleigh–Ritz row | Local-to-global assembly sketch |
| 4 | Part IV opening preview | Part IV opening skill row | Part IV skill table row started |

When Dirichlet's principle and `K = assemble()` feel unrelated, start at the [III.4 Bridge](../part03-pdes/04-energy-methods.md#bridge-to-part-iv) — not at element shape functions alone — and verify the bilinear form in Part III matches the form Part IV integrates. Proceed to [row 4](../prologue/00-many-scales.md#row-4-closing-stitch) when Galerkin is understood but Riemann fluxes still feel like a different wire.

### Row 4 closing loop (discretization fork reunion) {#row-4-closing-loop}

This subsection is the **downstream half** of [memory sheet row 4](../appendix/memory-sheet.md#continuity-hinges-master-map) and the [preface ascent continuity hinges](../preface.md#ascent-continuity-hinges) row 4. The [prologue row 4 preview](../prologue/00-many-scales.md#prologue-preview-row-4) and [prologue row 4 closing stitch](../prologue/00-many-scales.md#row-4-closing-stitch) are the **upstream halves** — return there when FEM and FVM feel like unrelated courses on the same copper cylinder. Row 4 closes the IV.5 / V.4 → Part VI fork before [row 5](#row-5-closing-loop) reunites the twins at Cauchy stress: row 4 names **two doors**; row 5 names **one continuum vocabulary**.

**Row 4 three-way audit (prologue preview ↔ part skill tables ↔ workflow exam).**

| Step | Prologue preview ([row 4](../prologue/00-many-scales.md#prologue-preview-row-4)) | [Part IV](../part04-fem/00-opening.md#what-you-should-be-able-to-do-after-part-iv) / [Part V](../part05-fvm/00-opening.md#what-you-should-be-able-to-do-after-part-v) skill tables | Workflow exam ([row 4 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | Door A + Door B sketch | Part IV and V completion rows | [IV.5 two doors](../part04-fem/05-convergence.md#bridge-two-doors-from-here) annotated |
| 2 | Flux row beside stiffness row | FVM flux skill + FEM assembly skill | Twin row: energy vs conservation |
| 3 | [V.4 CHT](../part05-fvm/04-navier-stokes-cfd.md#lab-act-extension-two-domain-picard-loop-with-a-1d-fem-solid) coupling | CHT Lab act row | Picard coupling sketch |
| 4 | [Twin ladders preview](../part06-continuum/00-opening.md#the-twin-ladders-reunite-galerkin-and-conservation) | Part VI opening preview | Twin ladders table row started |

When \(\mathbf{K}\mathbf{U}=\mathbf{F}\) and face flux balances feel unrelated, start at [IV.5's two doors](../part04-fem/05-convergence.md#bridge-two-doors-from-here) — or [V.4's Bridge](../part05-fvm/04-navier-stokes-cfd.md#bridge-to-part-vi) if you read fluids-first — and walk forward to the [twin ladders reunion](../part06-continuum/00-opening.md#the-twin-ladders-reunite-galerkin-and-conservation). The [continuity hinge row 4](../appendix/sources.md#continuity-hinges-index-when-the-plot-stutters) in the sources appendix marks this fork explicitly. Proceed to [row 5](../preface.md#skill-navigation-row-5) when both discretizations map to balance laws but Cauchy stress vocabulary is still missing.

### Row 5 closing loop (mathematical midpoint reunion) {#row-5-closing-loop}

This subsection is the **downstream half** of [memory sheet row 5](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface continuity hinges row](../preface.md#continuity-hinges-ascent-descent), and the [preface row 5 skill checkpoint](../preface.md#skill-navigation-row-5). The [prologue row 5 preview](../prologue/00-many-scales.md#prologue-preview-row-5) and [prologue row 5 closing stitch](../prologue/00-many-scales.md#row-5-closing-stitch) are the **upstream halves** — return there when Parts I–V feel like separate courses but the copper wire on the bench is still one cylinder. Row 5 closes the ascent reunion loop before [row 6](#row-6-closing-loop) admits phenomenology cannot explain cold-drawn strength: row 5 names **where** Galerkin and conservation meet; row 6 names **why** smooth fields must yield to dislocation pedigree.

**Row 5 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([row 5](../prologue/00-many-scales.md#prologue-preview-row-5)) | [Preface row 5](../preface.md#skill-navigation-row-5) | Workflow exam ([row 5 row](#what-you-should-be-able-to-do-after-the-book) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | Sketch: Galerkin ladder + conservation ladder → twin reunion | Step 1 — Plot spine recitation | [VI.0 plot spine one line](../part06-continuum/00-opening.md#plot-spine-one-line) recited aloud |
| 2 | [VI.0 midpoint](../part06-continuum/00-opening.md#midpoint-ascent-complete-descent-ahead) — ascent complete | Step 2 — Twin ladder audit | Completed row from twin ladders table |
| 3 | [Preface ascent hinges](../preface.md#ascent-continuity-hinges) — four turns named | Step 3 — Ascent hinge chain | Annotated ladder with I.4→II through IV.5/V.4→VI |
| 4 | [VI.0 plot spine](../part06-continuum/00-opening.md#plot-spine-one-line) — reunion before descent | Step 4 — Midpoint statement | Paragraph linking Parts I–VI to Acts I–III |

When Part IV's \(\mathbf{K}\mathbf{U}=\mathbf{F}\) and Part V's face flux balances feel unrelated, start at [Part VI's twin ladders reunion](../part06-continuum/00-opening.md#the-twin-ladders-reunite-galerkin-and-conservation) — not at a new discretization chapter — and walk backward through the [preface ascent continuity hinges](../preface.md#ascent-continuity-hinges) until each hinge names the same wire. The [continuity hinge row 4](../appendix/sources.md#continuity-hinges-index-when-the-plot-stutters) in the sources appendix marks the IV/V → VI reunion explicitly. Do not conflate completing Part V with completing the ascent — Part VI names Cauchy stress and virtual work before [VI.4's intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) opens the descent. Proceed to [row 6](../preface.md#skill-navigation-row-6) when the return-mapping loop fits the load cell knee but forest density \(\rho\) is still absent from `hardening.yaml`.

### Row 6 closing loop (ascent ends at the knee reunion) {#row-6-closing-loop}

This subsection is the **downstream half** of [memory sheet row 6](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface continuity hinges row](../preface.md#continuity-hinges-ascent-descent), and the [preface row 6 skill checkpoint](../preface.md#skill-navigation-row-6). The [prologue row 6 preview](../prologue/00-many-scales.md#prologue-preview-row-6) and [prologue row 6 closing stitch](../prologue/00-many-scales.md#row-6-closing-stitch) are the **upstream halves** — return there when the return-mapping loop fits \(H\) and \(\sigma_{y0}\) but `hardening.yaml` lists fitted scalars without a Part VII forest-density pointer. Row 6 closes the VI.4 intermission loop before [row 7](../preface.md#skill-navigation-row-7) grounds mobility on atoms: row 6 names **why** the curve bent; row 7 names **where** line cores get atomic structure.
...
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | Sketch: return-mapping → three descent signals → VI.4 Bridge | Step 1 — Plot spine recitation | [VI.4 plot spine one line](../part06-continuum/04-nonlinear-plasticity-preview.md#plot-spine-one-line) recited aloud |
| 2 | [VI.4 intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) — phenomenology hands off | Step 2 — Return-mapping audit | Completed return-mapping table from Lab act |
| 3 | [Act IV reunion paragraph](#lab-act-reunion-six-acts-one-afternoon) — hardening knee | Step 3 — Three descent signals | Annotated load trace: history / mesh / core geometry |
| 4 | [VI.4 Bridge to Part VII](../part06-continuum/04-nonlinear-plasticity-preview.md#bridge-to-part-vii) — forest replaces \(H\) fit | Step 4 — Bridge handoff | `hardening.yaml` with Part VII pointer beside FEM deck |

When cold-drawn wire needs \(\sigma_{y0} = 250\,\text{MPa}\) while annealed wire fits \(\sigma_{y0} = 70\,\text{MPa}\) on the same mesh, start at the [VI.4 intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) — not at another \(H(T,\dot\varepsilon)\) fit — and walk forward through the [return-mapping Lab act](../part06-continuum/04-nonlinear-plasticity-preview.md#lab-act-return-mapping-on-the-load-cell-knee-act-iv-hardening) before opening Part VII. The [preface continuity hinges](../preface.md#continuity-hinges-ascent-descent) table names the same stitch in narrative time; row 20's [VI.4 plot spine](../part06-continuum/04-nonlinear-plasticity-preview.md#plot-spine-one-line) is the straight-read recitation when row 17 stalls at the second mandatory gate. Do not conflate converged elastic FEM with converged plasticity physics — halving \(h\) and seeing unchanged post-yield slope is signal 2 to descend. Proceed to [row 7](../preface.md#skill-navigation-row-7) when `hardening.yaml` points to Part VII but OpenDiS mobility still cites literature constants without atomic boxes.

### Row 7 closing loop (mesoscale → atomistic reunion) {#row-7-closing-loop}

This subsection is the **downstream half** of [memory sheet row 7](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface mesoscale → atomistic row](../preface.md#descent-continuity-hinges), and the [preface row 7 skill checkpoint](../preface.md#skill-navigation-row-7). The [prologue row 7 preview](../prologue/00-many-scales.md#prologue-preview-row-7) and [prologue row 7 closing stitch](../prologue/00-many-scales.md#row-7-closing-stitch) are the **upstream halves** — return there when OpenDiS `mobility.yaml` cites `MD_NVT_shear_PartVIII` but no screw-core RVE or NVT trajectory exists on disk. Row 7 closes the VII.3 → Part VIII atomic-basis loop before [row 8](../preface.md#skill-navigation-row-8) audits \(T_w\) pedigree: row 7 grounds mobility on atoms; row 8 grounds those trajectories at converged wall temperature; [row 9](../preface.md#skill-navigation-row-9) audits phonons at the electronic scale.
...
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | Sketch: VII.3 Bridge → EAM RVE → trajectory folder on disk | Step 1 — VII.3 Bridge audit | Completed scale-boundary handshake row: mobility, \(\gamma_{\text{sf}}\), Peierls → file paths |
| 2 | [VIII.1 opening hinge](../part08-md/01-potentials-phase-space.md#opening-hinge-vii3-to-viii1) — cores become atoms | Step 2 — VIII.1 EAM RVE | `cu_eam_a0.txt`, `gsf_cu111.dat` beside EAM potential |
| 3 | [VIII.2 opening hinge (7b)](../part08-md/02-ensembles-integrators.md#opening-hinge-viii1-to-viii2) — 0 K is not the wire | Step 3 — VIII.2 NVT shear | `MD_NVT_shear_PartVIII/` trajectory folder exists |
| 4 | [Act IV reunion paragraph](#lab-act-reunion-six-acts-one-afternoon) — mobility pedigree | Step 4 — VIII.3 handoff (7c) | `mobility.yaml` cites existing Part VIII folder with README at arrow |

When Peierls stress or \(\gamma_{\text{sf}}\) feel like fitted constants after Part VII, start at [VII.3's Bridge](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-to-part-viii) — not at OpenDiS input decks — and walk forward through the [VIII.1 opening hinge](../part08-md/01-potentials-phase-space.md#opening-hinge-vii3-to-viii1) before trusting Handshake 4a drag. Sub-stitches **7b** and **7c** extend the audit through [VIII.2](../part08-md/02-ensembles-integrators.md#opening-hinge-viii1-to-viii2) and [VIII.3](../part08-md/03-ab-initio-and-coarse-graining.md#opening-hinge-viii2-to-viii3). Do not conflate Taylor hardening fit with atomic core structure — forest statistics need vibrating nuclei before [row 8](../preface.md#skill-navigation-row-8) inherits \(T_w\) from CHT. Proceed to row 8 when atomic boxes exist but mobility folders still cite 300 K defaults.

### Row 8 closing loop (temperature pedigree reunion) {#row-8-closing-loop}

This subsection is the **downstream half** of [memory sheet row 8](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface temperature pedigree row](../preface.md#descent-continuity-hinges), and the [preface row 8 skill checkpoint](../preface.md#skill-navigation-row-8). The [prologue row 8 preview](../prologue/00-many-scales.md#prologue-preview-row-8) and [prologue row 8 closing stitch](../prologue/00-many-scales.md#row-8-closing-stitch) are the **upstream halves** — return there when Act II warmed the wire but MD mobility, WHAM replica ladders, or OpenDiS drag folders still cite 300 K by default. Row 8 closes the V.4 CHT → MD/DDD temperature loop that Handshake 2 opened in Act II: row 8 sets \(T_w\); [row 9](../preface.md#skill-navigation-row-9) audits \(\alpha(T_w)\) and \(\tau_{\text{ph}}(T_w)\) at the electronic scale before [row 10](../preface.md#skill-navigation-row-10) maps foundation exports to epilogue handshakes.
...
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | Sketch: V.4 Picard loop → `cht_export.yaml` → NVT shear at \(T_w\) | Step 1 — Handshake 2 | `cht_export.yaml` via [`parse_cht.sh`](../../scripts/parse_cht.sh); converged \(T_w \approx 379\,\text{K}\) |
| 2 | [VIII.0 descent hinge](../part08-md/00-opening.md#descent-hinge-cores-mobility-and-tw-pedigree) states the temperature contract | Step 2 — NVT shear at \(T_w\) | `mobility_cu_screw_{T_w}K.yaml` beside `cht_export.yaml` |
| 3 | [Preview Act II row](#reunion-preview-act-ii) — Handshake 2 CHT | Step 3 — WHAM reweight | `wham_export.yaml` via [`parse_wham.sh`](../../scripts/parse_wham.sh) at `--target-t` from `cht_export.yaml` |
| 4 | [Act II reunion paragraph](#lab-act-reunion-six-acts-one-afternoon) — \(\Delta T\) feeds Act III | Step 4 — OpenDiS pedigree | OpenDiS input cites `mobility_cu_screw_{T_w}K.yaml`; cross-slip counts at \(T_w\) archived beside WHAM export |

When MD mobility or OpenDiS drag folders cite 300 K after Act II warmed the wire to \(T_w \approx 379\,\text{K}\), start at [V.4's Picard loop](../part05-fvm/04-navier-stokes-cfd.md#lab-act-extension-two-domain-picard-loop-with-a-1d-fem-solid) — not at any NVT shear folder — and walk forward through the [VIII.0 descent hinge](../part08-md/00-opening.md#descent-hinge-cores-mobility-and-tw-pedigree) before trusting Handshake 4a drag or phonon softening in Act IV. The [memory sheet rows 8–9 baby picture](../appendix/memory-sheet.md#rows-8-9-baby-picture-tw-temperature-pedigree) draws the chain; the [Act II expanded reunion paragraph](#reunion-expanded-act-ii) states the same stitch in workflow time. Do not conflate handbook 300 K drag with Joule-heated \(T_w\) — phonon softening shifts Act IV hardening before Part IX audits the phonon curve. Proceed to [row 9](../preface.md#skill-navigation-row-9) when phonon exports need DFT audit at the same \(T_w\), or to [row 13](../preface.md#skill-navigation-row-13) for the Handshake 2 → 3 chain once \(T_w\) is verified in every finer rung.

### Row 9 closing loop (phonon audit reunion) {#row-9-closing-loop}

This subsection is the **downstream half** of [memory sheet row 9](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface atomistic → electronic audit row](../preface.md#descent-continuity-hinges), and the [preface row 9 skill checkpoint](../preface.md#skill-navigation-row-9). The [prologue row 9 preview](../prologue/00-many-scales.md#prologue-preview-row-9) and [prologue row 9 closing stitch](../prologue/00-many-scales.md#row-9-closing-stitch) are the **upstream halves** — return there when EAM fits look credible but the foundation folder lacks an explicit **`T_w` column** beside SCF logs. Row 9 closes the MD → DFT phonon audit loop that [row 8](../prologue/00-many-scales.md#row-8-closing-stitch) opened at the temperature layer: row 8 sets \(T_w\); row 9 audits \(\alpha(T_w)\) and \(\tau_{\text{ph}}(T_w)\) at the electronic scale before [row 10](../preface.md#skill-navigation-row-10) maps foundation exports to epilogue handshakes.
...
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | One sentence: "SCF audits moduli; phonon audit audits thermal exports at the same \(T_w\)" | Step 1 — Row 8 complete | `cht_export.yaml` with converged \(T_w\) from [`parse_cht.sh`](../../scripts/parse_cht.sh) |
| 2 | [IX.0 thermal phonon audit](../part09-dft/00-opening.md#thermal-phonon-audit-at-tw) lists three quantities at risk | Step 2 — SCF audit | `foundation_export.yaml` via [`parse_dft_workflow.sh`](../../scripts/parse_dft_workflow.sh) |
| 3 | [Preview Act III row](#reunion-preview-act-iii) — Handshake 3 \(\alpha\) | Step 3 — \(\alpha(T_w)\) | [`parse_alpha.sh`](../../scripts/parse_alpha.sh) → `alpha_export.yaml` with explicit \(T_w\) column |
| 4 | [Preview Act IV row](#reunion-preview-act-iv) — Handshake 4a \(\tau_{\text{ph}}\) drag | Step 4 — \(\tau_{\text{ph}}(T_w)\) | [`parse_lifetime.sh`](../../scripts/parse_lifetime.sh) at converged \(T_w\) beside `mobility_cu_screw_{T_w}K.yaml` |

When EAM matches bulk moduli but `alpha_export.yaml` lacks \(\alpha(T_w)\) beside SCF logs, start at the [IX.0 electronic audit hinge](../part09-dft/00-opening.md#electronic-audit-hinge-descent-pedigree-and-tw-phonon) — not at the epilogue Handshake 3 section — and walk forward through the [thermal phonon audit table](../part09-dft/00-opening.md#thermal-phonon-audit-at-tw) before trusting fixed-grip stress or rate sensitivity \(m\). The [memory sheet rows 8–9 baby picture](../appendix/memory-sheet.md#rows-8-9-baby-picture-tw-temperature-pedigree) draws the chain; the [Act III expanded reunion paragraph](#reunion-expanded-act-iii) and [Act IV expanded reunion paragraph](#reunion-expanded-act-iv) state the same stitch in workflow time. Do not conflate \(\alpha(300\,\text{K})\) handbook comparison with \(\alpha(T_w)\) production export — SCF audits bulk stiffness; quasiharmonic phonons audit thermal eigenstrain at the same \(T_w\) Act II converged. Proceed to [row 10](../preface.md#skill-navigation-row-10) when foundation exports need epilogue composition, or to [row 13](../preface.md#skill-navigation-row-13) for the Handshake 2 → 3 chain once phonon audits are verified.

### Row 10 closing loop (coupling hinge reunion) {#row-10-closing-loop}

This subsection is the **downstream half** of [memory sheet row 10](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface coupling hinge row](../preface.md#epilogue-continuity-hinges), and the [preface row 10 skill checkpoint](../preface.md#skill-navigation-row-10). The [prologue row 10 preview](../prologue/00-many-scales.md#prologue-preview-row-10) and [prologue row 10 closing stitch](../prologue/00-many-scales.md#row-10-closing-stitch) are the **upstream halves** — return there when foundation folders exist but Handshakes 4a and 4b feel like one undifferentiated export on the same `hardening.yaml`. Row 10 closes the IX.3 → epilogue composition loop that [rows 8–9](../preface.md#skill-navigation-row-8) opened at the temperature layer: row 8 sets \(T_w\); row 9 audits phonon exports at the electronic scale; row 10 maps each foundation artifact to its epilogue handshake before [rows 13–16](../preface.md#skill-navigation-row-13) run individual parsers.
...
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------|
| 1 | One sentence: "IX.3 archives pedigree; epilogue composes Handshakes 1–4b" | Step 1 — Rows 8–9 complete | Pedigree row from [row 9](../preface.md#skill-navigation-row-9) with shared \(T_w\) column |
| 2 | [IX.3 epilogue pedigree table](../part09-dft/03-dft-workflows.md#ix3-epilogue-pedigree-table) maps exports to handshakes | Step 2 — Pedigree table | Completed pedigree table sketch: 1 (moduli), 2 (CHT), 3 (\(\alpha\)), 4a (rate), 4b (GSF/notch) |
| 3 | "4a is bulk hardening, 4b is notch localization" — [preview Act IV row](#reunion-preview-act-iv) and [preview Act V row](#reunion-preview-act-v) | Step 3 — 4a/4b split | One sentence: "4a for Act IV knee; 4b only when Act V notch activates" |
| 4 | [Coupling hinge paragraph](#opening-hinge-ix3-to-epilogue) reunites IX.3 Bridge with epilogue Handshakes 1–3 | Step 4 — Coupling hinge | Annotated workflow sketch linking foundation folder → handshake sections |

When foundation exports live in separate directories with no README at the arrows, start at [IX.3's Bridge to the epilogue](../part09-dft/03-dft-workflows.md#bridge-to-the-epilogue) — not at individual handshake parsers — and walk forward through the [IX.3 epilogue pedigree table](../part09-dft/03-dft-workflows.md#ix3-epilogue-pedigree-table) before opening [Handshakes 4a and 4b](#handshake-4--rate-dependent-hardening-and-notch-localization-part-vii--vi--viii). The [preview Act IV row](#reunion-preview-act-iv) and [preview Act V row](#reunion-preview-act-v) reunite the split in workflow time. Do not conflate foundation archiving (row 10) with orchestrated export ([row 16](../preface.md#skill-navigation-row-16)) — row 10 names **what composes**; row 16 proves **dependency order** in `multiscale_export.yaml`. Proceed to [row 11](../preface.md#skill-navigation-row-11) when workflow order is unclear, or to [row 13](../preface.md#skill-navigation-row-13) for the Handshake 2 → 3 chain once the 4a/4b split is documented.
