...
|------------------------|---------------|-------------------|------------------|
| [All — orchestrated chain](#script-audit-trail-orchestrated-chain) | [`orch`: OUT](../appendix/memory-sheet.md#subgraph-node-orch-out) | **All — orchestrated chain** | `multiscale_export.yaml` |
| [1 — DFT → FEM](#script-audit-trail-h1-dft-fem) | [`orch`: H1](../appendix/memory-sheet.md#subgraph-node-orch-h1); [`act6`: DFT](../appendix/memory-sheet.md#subgraph-node-act6-dft) | **1 — DFT → continuum** | `foundation_export.yaml` |
| [1 — elastic only](#script-audit-trail-h1-elastic) | [`act6`: DFT](../appendix/memory-sheet.md#subgraph-node-act6-dft) | **1 — DFT → continuum** (partial) | `cu.elastic/` strain logs |
| [2 — Joule ↔ CHT](#script-audit-trail-h2-cht) | [`orch`: H2](../appendix/memory-sheet.md#subgraph-node-orch-h2) | **2 — Joule → CHT** | `cht_export.yaml` |
| [3 — Thermal → FEM](#script-audit-trail-h3-alpha) | [`orch`: H3](../appendix/memory-sheet.md#subgraph-node-orch-h3); [`act6`: DFT (phonon)](../appendix/memory-sheet.md#subgraph-node-act6-dft) | **3 — thermal → mechanical** | `alpha_cu_300K.dat`, `alpha_export.yaml` |
| [4 — GSF → DDD](#script-audit-trail-gsf) | [`act6`: DFT (GSF)](../appendix/memory-sheet.md#subgraph-node-act6-dft) | **4b — notch localization** (GSF input) | `gsf_export.yaml` |
| [4a — DDD → FEM rate](#script-audit-trail-h4a-rate) | [`orch`: H4a](../appendix/memory-sheet.md#subgraph-node-orch-h4a); [`act6`: DDD](../appendix/memory-sheet.md#subgraph-node-act6-ddd) | **4a — rate hardening** | `rate_export.yaml` |
| [4b — FE² at notch](#script-audit-trail-h4b-fe2) | [`orch`: H4b](../appendix/memory-sheet.md#subgraph-node-orch-h4b) | **4b — notch localization** | `fe2_export.yaml` |
| [MD — phonon lifetime](#script-audit-trail-md-lifetime) | [`orch`: H4a support](../appendix/memory-sheet.md#subgraph-node-orch-h4a); [`act6`: MD](../appendix/memory-sheet.md#subgraph-node-act6-md) | **4a — rate hardening** (drag at \(T_w\)) | `lifetime_export.yaml` |
| [MD — phonon DOS](#script-audit-trail-md-vacf) | [`act6`: MD](../appendix/memory-sheet.md#subgraph-node-act6-md) | Foundation checklist (phonon cross-check) | `vacf_export.yaml` |
| [4 — replica MD](#script-audit-trail-md-wham) | [`act6`: MD](../appendix/memory-sheet.md#subgraph-node-act6-md) | [Rows 8–9](../preface.md#skill-navigation-row-8) \(T_w\) pedigree | `wham_export.yaml` |
