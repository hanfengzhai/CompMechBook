...
| Script audit trail row | Subgraph node | IX.3 pedigree row | Minimal artifact |
|------------------------|---------------|-------------------|------------------|
| [All — orchestrated chain](#script-audit-trail-orchestrated-chain) | [`orch`: OUT](../appendix/memory-sheet.md#subgraph-node-orch-out) | **All — orchestrated chain** | `multiscale_export.yaml` ↔ [prologue preview step 3](../prologue/00-many-scales.md#row-16-preview-step-3) · [epilogue minimal artifact step 3](#act-vi-foundation-minimal-artifact-step-3) |
| [1 — DFT → FEM](#script-audit-trail-h1-dft-fem) | [`orch`: H1](../appendix/memory-sheet.md#subgraph-node-orch-h1); [`act6`: DFT](../appendix/memory-sheet.md#subgraph-node-act6-dft) | **1 — DFT → continuum** | `foundation_export.yaml` ↔ [prologue preview step 2](../prologue/00-many-scales.md#row-16-preview-step-2) · [epilogue minimal artifact step 2](#act-vi-foundation-minimal-artifact-step-2) |
| [1 — elastic only](#script-audit-trail-h1-elastic) | [`act6`: DFT](../appendix/memory-sheet.md#subgraph-node-act6-dft) | **1 — DFT → continuum** (partial) | `cu.elastic/` strain logs ↔ [prologue preview step 2](../prologue/00-many-scales.md#row-16-preview-step-2) · [epilogue minimal artifact step 2](#act-vi-foundation-minimal-artifact-step-2) |
| [2 — Joule ↔ CHT](#script-audit-trail-h2-cht) | [`orch`: H2](../appendix/memory-sheet.md#subgraph-node-orch-h2) | **2 — Joule → CHT** | `cht_export.yaml` ↔ [prologue preview step 1](../prologue/00-many-scales.md#row-16-preview-step-1) · [step 4](../prologue/00-many-scales.md#row-16-preview-step-4) (\(\Delta T\) pedigree) |
| [3 — Thermal → FEM](#script-audit-trail-h3-alpha) | [`orch`: H3](../appendix/memory-sheet.md#subgraph-node-orch-h3); [`act6`: DFT (phonon)](../appendix/memory-sheet.md#subgraph-node-act6-dft) | **3 — thermal → mechanical** | `alpha_cu_300K.dat`, `alpha_export.yaml` ↔ [prologue preview step 1](../prologue/00-many-scales.md#row-16-preview-step-1) · [step 4](../prologue/00-many-scales.md#row-16-preview-step-4) |
| [4 — GSF → DDD](#script-audit-trail-gsf) | [`act6`: DFT (GSF)](../appendix/memory-sheet.md#subgraph-node-act6-dft) | **4b — notch localization** (GSF input) | `gsf_export.yaml` ↔ [prologue preview step 2](../prologue/00-many-scales.md#row-16-preview-step-2) (foundation folder) |
...
| [4b — FE² at notch](#script-audit-trail-h4b-fe2) | [`orch`: H4b](../appendix/memory-sheet.md#subgraph-node-orch-h4b) | **4b — notch localization** | `fe2_export.yaml` ↔ [prologue preview step 1](../prologue/00-many-scales.md#row-16-preview-step-1) |
| [MD — phonon lifetime](#script-audit-trail-md-lifetime) | [`orch`: H4a support](../appendix/memory-sheet.md#subgraph-node-orch-h4a); [`act6`: MD](../appendix/memory-sheet.md#subgraph-node-act6-md) | **4a — rate hardening** (drag at \(T_w\)) | `lifetime_export.yaml` ↔ [prologue preview step 4](../prologue/00-many-scales.md#row-16-preview-step-4) · [epilogue minimal artifact step 4](#act-vi-foundation-minimal-artifact-step-4) |
| [MD — phonon DOS](#script-audit-trail-md-vacf) | [`act6`: MD](../appendix/memory-sheet.md#subgraph-node-act6-md) | Foundation checklist (phonon cross-check) | `vacf_export.yaml` ↔ [prologue preview step 2](../prologue/00-many-scales.md#row-16-preview-step-2) (foundation folder) |
| [4 — replica MD](#script-audit-trail-md-wham) | [`act6`: MD](../appendix/memory-sheet.md#subgraph-node-act6-md) | [Rows 8–9](../preface.md#skill-navigation-row-8) \(T_w\) pedigree | `wham_export.yaml` ↔ [prologue preview step 4](../prologue/00-many-scales.md#row-16-preview-step-4) (\(T_w\) at converged wall temperature) |

The [memory sheet subgraph node audit](../appendix/memory-sheet.md#subgraph-node-audit-table) and [IX.3 pedigree ↔ parser step mapping](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) are the upstream mirrors of this row-level table — return there when subgraph labels or parser names need the [preface row 16](../preface.md#skill-navigation-row-16) step column.
...
The [preface row 16 skill checkpoint](../preface.md#skill-navigation-row-16) lists four competence steps before orchestration; the [preface Step audit ↔ workflow exam paragraph](../preface.md#skill-navigation-row-16) maps those steps one-to-one to the rows below; the [prologue row 16 closing stitch](../prologue/00-many-scales.md#row-16-closing-stitch) names the same divergence in narrative time — return there when all four rows pass and the round-trip from preview to step audit is complete. This table is the **workflow exam mirror** — audit each step against the Act VI foundation row above before archiving `multiscale_export.yaml`:
