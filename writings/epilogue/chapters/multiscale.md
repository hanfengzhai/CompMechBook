...
The [preface row 16 skill checkpoint](../preface.md#skill-navigation-row-16) lists four competence steps before orchestration; this table is the **workflow exam mirror** — audit each step against the Act VI foundation row above before archiving `multiscale_export.yaml`:
...
Return to the [preface row 16 When-to-pause paragraph](../preface.md#skill-navigation-row-16) when any step fails — the [IX.3 Bridge closing](../part09-dft/03-dft-workflows.md#bridge-to-the-epilogue-closing) and [Act VI reunion paragraph](#lab-act-reunion-six-acts-one-afternoon) are the narrative-time mirrors of this audit table.
