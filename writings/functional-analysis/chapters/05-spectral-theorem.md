...
## Writings canonical landing (II.4 → II.5) {#writings-canonical-landing-ii4-to-ii5}

You should arrive here from [II.4](04-operators-duality.md) after [row 65](../preface.md#skill-navigation-row-65) closed II.3 → II.4 on a new specimen, or from the unified book on a first read after [II.4 Bridge](04-operators-duality.md#bridge) and [II.4 → II.5 Writings hinge](04-operators-duality.md#writings-canonical-hinge-ii4-to-ii5) — not at the spectral theorem cold. The [`writings/functional-analysis`](../../writings/functional-analysis/chapters/SUMMARY.md) fifth numbered chapter repeats the ME 412 template: **Scene** asks why the tapped wire sings in modes, the body develops self-adjoint compact operators, Rayleigh–Ritz bounds, and modal heat/wave expansions, **Lab act** compares mesh eigenvalues to the analytical bar spectrum, **Bridge** hands off to weak PDEs in Part III. When row 65 verified distributed-load weak\* convergence but II.4 operator prose and this chapter's eigenvalue theorem still feel like separate homework, read [row 66](../appendix/sources.md#row65-ii4-ii5-spectral-reunion-index-row-66) and recite [II.4 plot spine](04-operators-duality.md#plot-spine-one-line) aloud before [Scene: the wire sings](#scene-the-wire-sings).
