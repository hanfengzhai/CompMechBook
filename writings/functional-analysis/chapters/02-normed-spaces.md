...
## Writings canonical landing (II.1 → II.2) {#writings-canonical-landing-ii1-to-ii2}

You should arrive here from [II.1](01-motivation.md) after [row 62](../preface.md#skill-navigation-row-62) closed II.0 → II.1 on a new specimen, or from the unified book on a first read after [II.1 Bridge](01-motivation.md#bridge) and [II.1 → II.2 Writings hinge](01-motivation.md#writings-canonical-hinge-ii1-to-ii2) — not at metric axioms cold. The [`writings/functional-analysis`](../../writings/functional-analysis/chapters/SUMMARY.md) second numbered chapter repeats the ME 412 template: **Scene** asks which norm measures convergence on the heated wire, the body develops \(L^p\), Banach completeness, and \(H^1\) preview, **Lab act** compares \(L^2\) and energy seminorm on a hat function, **Bridge** hands off to Hilbert geometry in II.3. When row 62 verified the bar-refinement plot but II.1 pipeline and this chapter's metric definitions still feel like separate homework, read [row 63](../appendix/sources.md#row62-ii1-ii2-normed-spaces-reunion-index-row-63) and recite [II.1 plot spine](01-motivation.md#plot-spine-one-line) aloud before [Scene: how wrong is "wrong enough"?](#scene-how-wrong-is-wrong-enough).
