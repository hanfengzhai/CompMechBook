...
| **Galerkin → transport discretization** | [IV.5 intermission](part04-fem/05-convergence.md#intermission-galerkin-complete-conservation-begins) · [IV.5 Bridge](part04-fem/05-convergence.md#bridge-two-doors-from-here) | Céa's lemma certifies the solid mesh; conservation on cells balances fluxes in the air (Door A) or Cauchy stress names the converged field (Door B) |
