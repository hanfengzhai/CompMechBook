...
Read the [VII.2 opening hinge](part07-defects/02-dislocation-dynamics.md#opening-hinge-vii1-to-vii2) when defect taxonomy feels like metallurgy notes rather than OpenDiS input — lines must move, not just be named. Read the [mesoscale hinge](part07-defects/03-polycrystal-and-fem-handoff.md#bridge-to-part-viii) when mobility or \(\gamma_{\text{sf}}\) feel like fitted constants — Peierls stress and core width hide in atomic trajectories, not Taylor hardening alone. Read the [VIII.3 opening hinge](part08-md/03-ab-initio-and-coarse-graining.md#opening-hinge-viii2-to-viii3) when NVT/NPT certificates pass but export folders lack EAM-fit audits. Read the [atomistic hinge](part08-md/03-ab-initio-and-coarse-graining.md#bridge-to-part-ix) or [Part IX opening hinge](part09-dft/00-opening.md#opening-hinge-part-viii-to-ix) when EAM matches bulk moduli but no one cites the DFT input deck. Read the [coupling hinge](part09-dft/03-dft-workflows.md#bridge-to-the-epilogue) when exports exist in separate folders but no workflow connects them — the epilogue's multiscale afternoon is where pedigree becomes handshake.
