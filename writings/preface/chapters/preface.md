...
|------|-------------------------------------------------------------------------------------------------------------|-------------------------|--------------------------------------------------------------------------------------------------------|
| 1 | Upstream [rows 8–9](../preface.md#skill-navigation-row-8) and [13–15](../preface.md#skill-navigation-row-13) named before Part I | Step 1 — individual handshakes understood | Rows 8–9, 13–15 completed in workflow exam table |
...
| 4 | [IX.3 epilogue pedigree table](../part09-dft/03-dft-workflows.md#ix3-epilogue-pedigree-table) + [subgraph node audit](../appendix/memory-sheet.md#act-vi-subgraph-node-audit) | Step 4 — `delta_T_from_handshake_2`, `target_T_K` audit | `./scripts/test-fixtures.sh`; [script audit trail](../epilogue/multiscale.md#script-audit-trail-parse-scripts-handshakes) closing paragraph |
