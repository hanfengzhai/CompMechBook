...
Row 5 is the **ascent reunion contract** — Galerkin energy (Part IV) and conservation flux (Part V) split Schematic 14 into twin discretization dialects on the same copper wire; Part VI reunites them on Cauchy stress and virtual work before descent begins at [VI.4](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins).
