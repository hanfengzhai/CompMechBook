...
| 5 | Ascent | [V.4 intermission → VI](../part05-fvm/04-navier-stokes-cfd.md#intermission-discretization-complete-continuum-begins) · [VI.1 opening hinge](../part06-continuum/01-kinematics.md#continuum-opening-hinge-discretization-to-kinematics) | FEM and FVM feel like unrelated courses; \(\mathbf{F}\) replaces nodal \(\mathbf{U}\) |
