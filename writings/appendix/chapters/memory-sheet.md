...
| Subgraph node | IX.3 pedigree row | Minimal artifact | Script audit trail row ↔ IX.3 parser mapping |
|---------------|-------------------|------------------|---------------------------------------------|
| `act6`: DFT {#subgraph-node-act6-dft} | Foundation checklist rows 1–6 | `cu.scf.in`, `cu.elastic/`, `cu.gsf/` | [1 — DFT → FEM](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem); [1 — elastic only](../epilogue/multiscale.md#script-audit-trail-h1-elastic); [GSF](../epilogue/multiscale.md#script-audit-trail-gsf) ↔ [IX.3 row 1](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) |
| `act6`: MD {#subgraph-node-act6-md} | *(Part VIII EAM fit on DFT exports)* | EAM potential with DFT pedigree | [MD — phonon DOS](../epilogue/multiscale.md#script-audit-trail-md-vacf); [MD — phonon lifetime](../epilogue/multiscale.md#script-audit-trail-md-lifetime); [replica MD](../epilogue/multiscale.md#script-audit-trail-md-wham) ↔ [IX.3 row 4a support](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) |
| `act6`: DDD {#subgraph-node-act6-ddd} | *(Part VII mobility from MD)* | `mobility_cu_screw_{T_w}K.yaml` | [4a — DDD → FEM rate](../epilogue/multiscale.md#script-audit-trail-h4a-rate) ↔ [IX.3 row 4a](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) |
| `act6`: FEM {#subgraph-node-act6-fem} | Pedigree row **1 — DFT → continuum** | Voigt \(E\), \(\nu\) in input deck | [1 — DFT → FEM](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) (upstream) ↔ [IX.3 row 1](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) |
| `orch`: H1 {#subgraph-node-orch-h1} | Pedigree row **1 — DFT → continuum** | `foundation_export.yaml` | [1 — DFT → FEM](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) ↔ [IX.3 row 1](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [prologue preview step 2](../prologue/00-many-scales.md#row-16-preview-step-2) |
| `orch`: H2 {#subgraph-node-orch-h2} | Pedigree row **2 — Joule → CHT** | `cht_export.yaml` | [2 — Joule ↔ CHT](../epilogue/multiscale.md#script-audit-trail-h2-cht) ↔ [IX.3 row 2](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [prologue preview steps 1, 4](../prologue/00-many-scales.md#row-16-preview-step-1) |
| `orch`: H3 {#subgraph-node-orch-h3} | Pedigree row **3 — thermal → mechanical** | `alpha_cu_300K.dat` | [3 — Thermal → FEM](../epilogue/multiscale.md#script-audit-trail-h3-alpha) ↔ [IX.3 row 3](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [prologue preview steps 1, 4](../prologue/00-many-scales.md#row-16-preview-step-1) |
| `orch`: H4a {#subgraph-node-orch-h4a} | Pedigree row **4a — rate hardening** | `rate_export.yaml` | [4a — DDD → FEM rate](../epilogue/multiscale.md#script-audit-trail-h4a-rate); [MD — phonon lifetime](../epilogue/multiscale.md#script-audit-trail-md-lifetime) ↔ [IX.3 row 4a](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [prologue preview steps 1, 4](../prologue/00-many-scales.md#row-16-preview-step-1) |
| `orch`: H4b {#subgraph-node-orch-h4b} | Pedigree row **4b — notch localization** | `fe2_export.yaml` | [4b — FE² at notch](../epilogue/multiscale.md#script-audit-trail-h4b-fe2) ↔ [IX.3 row 4b](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [prologue preview step 1](../prologue/00-many-scales.md#row-16-preview-step-1) |
| `orch`: OUT {#subgraph-node-orch-out} | Pedigree row **All — orchestrated chain** | `multiscale_export.yaml` | [All — orchestrated chain](../epilogue/multiscale.md#script-audit-trail-orchestrated-chain) ↔ [IX.3 row All](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [prologue preview step 3](../prologue/00-many-scales.md#row-16-preview-step-3) · [epilogue Act VI foundation minimal artifact](../epilogue/multiscale.md#act-vi-foundation-minimal-artifact) |

The [IX.3 pedigree ↔ parser step mapping](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) adds [preface row 16](../preface.md#skill-navigation-row-16) step columns and the **Script audit trail row ↔ subgraph node audit** three-way round-trip to this node audit; the [epilogue script audit trail row-level audit](../epilogue/multiscale.md#script-audit-trail-row-level-audit) is the downstream mirror when subgraph labels need parser round-trips — return there when this table's **Script audit trail row** column feels abstract without input artifacts; the [epilogue Act VI foundation minimal artifact](../epilogue/multiscale.md#act-vi-foundation-minimal-artifact) is the workflow-exam mirror when prologue preview steps 1–4 need the per-handshake inline anchors.
