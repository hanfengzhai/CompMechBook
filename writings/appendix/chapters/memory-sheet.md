...
| Subgraph node | IX.3 pedigree row | Minimal artifact | Script audit trail row |
|---------------|-------------------|------------------|------------------------|
| `act6`: DFT {#subgraph-node-act6-dft} | Foundation checklist rows 1–6 | `cu.scf.in`, `cu.elastic/`, `cu.gsf/` | [1 — DFT → FEM](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem); [1 — elastic only](../epilogue/multiscale.md#script-audit-trail-h1-elastic); [GSF](../epilogue/multiscale.md#script-audit-trail-gsf) |
| `act6`: MD {#subgraph-node-act6-md} | *(Part VIII EAM fit on DFT exports)* | EAM potential with DFT pedigree | [MD — phonon DOS](../epilogue/multiscale.md#script-audit-trail-md-vacf); [MD — phonon lifetime](../epilogue/multiscale.md#script-audit-trail-md-lifetime); [replica MD](../epilogue/multiscale.md#script-audit-trail-md-wham) |
| `act6`: DDD {#subgraph-node-act6-ddd} | *(Part VII mobility from MD)* | `mobility_cu_screw_{T_w}K.yaml` | [4a — DDD → FEM rate](../epilogue/multiscale.md#script-audit-trail-h4a-rate) |
| `act6`: FEM {#subgraph-node-act6-fem} | Pedigree row **1 — DFT → continuum** | Voigt \(E\), \(\nu\) in input deck | [1 — DFT → FEM](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) (upstream) |
| `orch`: H1 {#subgraph-node-orch-h1} | Pedigree row **1 — DFT → continuum** | `foundation_export.yaml` | [1 — DFT → FEM](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) |
| `orch`: H2 {#subgraph-node-orch-h2} | Pedigree row **2 — Joule → CHT** | `cht_export.yaml` | [2 — Joule ↔ CHT](../epilogue/multiscale.md#script-audit-trail-h2-cht) |
| `orch`: H3 {#subgraph-node-orch-h3} | Pedigree row **3 — thermal → mechanical** | `alpha_cu_300K.dat` | [3 — Thermal → FEM](../epilogue/multiscale.md#script-audit-trail-h3-alpha) |
| `orch`: H4a {#subgraph-node-orch-h4a} | Pedigree row **4a — rate hardening** | `rate_export.yaml` | [4a — DDD → FEM rate](../epilogue/multiscale.md#script-audit-trail-h4a-rate); [MD — phonon lifetime](../epilogue/multiscale.md#script-audit-trail-md-lifetime) |
| `orch`: H4b {#subgraph-node-orch-h4b} | Pedigree row **4b — notch localization** | `fe2_export.yaml` | [4b — FE² at notch](../epilogue/multiscale.md#script-audit-trail-h4b-fe2) |
| `orch`: OUT {#subgraph-node-orch-out} | Pedigree row **All — orchestrated chain** | `multiscale_export.yaml` | [All — orchestrated chain](../epilogue/multiscale.md#script-audit-trail-orchestrated-chain) |

The [IX.3 pedigree ↔ parser step mapping](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) adds [preface row 16](../preface.md#skill-navigation-row-16) step columns to this node audit; the [epilogue script audit trail row-level audit](../epilogue/multiscale.md#script-audit-trail-row-level-audit) is the downstream mirror when subgraph labels need parser round-trips — return there when this table's **Script audit trail row** column feels abstract without input artifacts.
