...
| 32 | Meta | [Intermission → descent reunion index](sources.md#intermission-descent-reunion-index-row-32) · [preface row 32 skill checkpoint](../preface.md#skill-navigation-row-32) · [prologue row 32 preview](../prologue/00-many-scales.md#prologue-preview-row-32) · [prologue row 32 closing stitch](../prologue/00-many-scales.md#row-32-closing-stitch) · [epilogue row 32 closing loop](../epilogue/multiscale.md#row-32-closing-loop) | Rows 17–31 all read correctly but \(J_2\) phenomenology and dislocation forest still feel like separate subjects — read VI.4 intermission → return-mapping Lab act → three descent signals → VII.0 Scene and name why \(H\) is a placeholder for \(\rho\); [row 32 baby picture](#row-32-baby-picture-intermission-descent-reunion) |
| 33 | Meta | [Forest → Handshake 4a reunion index](sources.md#forest-handshake-4a-reunion-index-row-33) · [preface row 33 skill checkpoint](../preface.md#skill-navigation-row-33) · [prologue row 33 preview](../prologue/00-many-scales.md#prologue-preview-row-33) · [prologue row 33 closing stitch](../prologue/00-many-scales.md#row-33-closing-stitch) · [epilogue row 33 closing loop](../epilogue/multiscale.md#row-33-closing-loop) | Rows 17–32 all read correctly but OpenDiS mobility pedigree and lab-rate extrapolation still feel like separate subjects — read VII.2 forest → mobility at \(T_w\) → multi-rate DDD → VII.3 rate handshake → Handshake 4a and name why \(\tau_{\text{flow}} \neq \tau_{\text{lab}}\); [row 33 baby picture](#row-33-baby-picture-forest-handshake-4a-reunion) |
| 34 | Meta | [Polycrystal handoff → Handshake 4b reunion index](sources.md#polycrystal-handshake-4b-reunion-index-row-34) · [preface row 34 skill checkpoint](../preface.md#skill-navigation-row-34) · [prologue row 34 preview](../prologue/00-many-scales.md#prologue-preview-row-34) · [prologue row 34 closing stitch](../prologue/00-many-scales.md#row-34-closing-stitch) · [epilogue row 34 closing loop](../epilogue/multiscale.md#row-34-closing-loop) | Rows 17–33 all read correctly but bulk crystal plasticity (VII.3 Steps 1–3) and notch localization (FE² / Handshake 4b) still feel like separate subjects — read OpenDiS → DAMASK → polycrystal FEM → Step 4 FE² → Handshake 4b and name why bulk adequacy \(\neq\) notch adequacy; [row 34 baby picture](#row-34-baby-picture-polycrystal-handshake-4b-reunion) |
| 35 | Meta | [VII.3 → VIII descent handoff reunion index](sources.md#vii3-viii-descent-handoff-reunion-index-row-35) · [preface row 35 skill checkpoint](../preface.md#skill-navigation-row-35) · [prologue row 35 preview](../prologue/00-many-scales.md#prologue-preview-row-35) · [prologue row 35 closing stitch](../prologue/00-many-scales.md#row-35-closing-stitch) · [epilogue row 35 closing loop](../epilogue/multiscale.md#row-35-closing-loop) | Rows 17–34 all read correctly but mesoscale export discipline (VII.3 Bridge) and atomistic descent (Part VIII) still feel like separate subjects — read VII.3 Bridge → VIII.0 descent hinge → VIII.1 opening hinge → EAM Lab act and name why `mobility.yaml` must cite an atomic box; [row 35 baby picture](#row-35-baby-picture-vii3-viii-descent-handoff-reunion) |
| 36 | Meta | [Potentials → ensembles reunion index](sources.md#potentials-ensembles-reunion-index-row-36) · [preface row 36 skill checkpoint](../preface.md#skill-navigation-row-36) · [prologue row 36 preview](../prologue/00-many-scales.md#prologue-preview-row-36) · [prologue row 36 closing stitch](../prologue/00-many-scales.md#row-36-closing-stitch) · [epilogue row 36 closing loop](../epilogue/multiscale.md#row-36-closing-loop) | Rows 17–35 all read correctly but 0 K EAM minimization and NVT/NPT trajectories still feel like separate subjects — read VIII.1 Bridge → VIII.2 opening hinge; [row 36 baby picture](#row-36-baby-picture-potentials-ensembles-reunion) |
| 37 | Meta | [Ensembles → coarse-graining reunion index](sources.md#ensembles-coarse-graining-reunion-index-row-37) · [preface row 37 skill checkpoint](../preface.md#skill-navigation-row-37) · [prologue row 37 preview](../prologue/00-many-scales.md#prologue-preview-row-37) · [prologue row 37 closing stitch](../prologue/00-many-scales.md#row-37-closing-stitch) · [epilogue row 37 closing loop](../epilogue/multiscale.md#row-37-closing-loop) | Rows 17–36 all read correctly but NVT/NPT trajectories and coarse-grained handoff tables still feel like separate subjects — read VIII.2 Bridge → VIII.3 opening hinge → pedigree checklist; [row 37 baby picture](#row-37-baby-picture-ensembles-coarse-graining-reunion) |
...
### Row 32 baby picture (intermission → descent reunion) {#row-32-baby-picture-intermission-descent-reunion}

**Row 32 baby picture:** when Scene, plot spine one-liners, Lab act moves, Scene visuals, Bridge hinges, concept map audits, schematic anchors, Story so far recaps, Closing the arc symbol bridges, Scale-boundary handshakes, thermoelastic assembly, CHT outer-loop reunion, and twin-ladder → virtual work reunion all read correctly but **\(J_2\) phenomenology and dislocation forest still feel like separate subjects**, open the [intermission → descent reunion index](sources.md#intermission-descent-reunion-index-row-32) — read the chain aloud: [VI.4 intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) → [return-mapping Lab act](../part06-continuum/04-nonlinear-plasticity-preview.md#lab-act-return-mapping-on-the-load-cell-knee-act-iv-hardening) → [three descent signals](../part06-continuum/04-nonlinear-plasticity-preview.md#three-signals-to-descend-from-part-vi-to-part-vii) → [VII.0 Scene](../part07-defects/00-opening.md#scene). Row 31 is energy on the load cell; row 32 is **why the knee bent — forest density \(\rho\), not fitted \(H\) alone**. The [preface row 32 skill checkpoint](../preface.md#skill-navigation-row-32) closes the competence loop; the [prologue row 32 closing stitch](../prologue/00-many-scales.md#row-32-closing-stitch) and [epilogue row 32 closing loop](../epilogue/multiscale.md#row-32-closing-loop) reunite the three-way audit.

```mermaid
flowchart LR
  subgraph vi4["Row 31 — ascent complete"]
    VW[VI.3 virtual work]
    RM[VI.4 return-mapping]
    J2[J2 H and sigma_y0]
  end
  subgraph gate["Midpoint gate row 20"]
    INT[VI.4 intermission]
    SIG[three descent signals]
  end
  subgraph vii["Part VII — descent begins"]
    SCN[VII.0 Scene forest]
    DDD[VII.2 OpenDiS rho]
    TAU[tau gamma export]
  end
  VW --> RM --> J2 --> INT --> SIG --> SCN --> DDD --> TAU
  J2 -.->|placeholder| DDD
```

When row 32 feels disconnected from row 31, read them as **layered meta-stitches**: row 31 when assembly and energy never closed on the load cell; row 32 when the knee is computable but **\(H\) still reads as a fundamental constant rather than a homogenized summary of \(\rho\)** — skip [VI.4's intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) and Part VII feels like a topic change after continuum mechanics.

### Row 33 baby picture (forest → Handshake 4a reunion) {#row-33-baby-picture-forest-handshake-4a-reunion}

**Row 33 baby picture:** when Scene, plot spine one-liners, Lab act moves, Scene visuals, Bridge hinges, concept map audits, schematic anchors, Story so far recaps, Closing the arc symbol bridges, Scale-boundary handshakes, thermoelastic assembly, CHT outer-loop reunion, twin-ladder → virtual work reunion, and intermission → descent reunion all read correctly but **OpenDiS forest exports and lab-rate hardening still feel like separate subjects**, open the [forest → Handshake 4a reunion index](sources.md#forest-handshake-4a-reunion-index-row-33) — read the chain aloud: [VII.2 forest Lab act](../part07-defects/02-dislocation-dynamics.md#lab-act-read-the-hardening-bend-from-forest-density-act-iv) → [mobility at \(T_w\)](../part07-defects/02-dislocation-dynamics.md#lab-act-calibrate-screw-mobility-from-md-shear-act-iv--mobility-prelude) → multi-rate DDD → [VII.3 rate handshake](../part07-defects/03-polycrystal-and-fem-handoff.md#scale-boundary-handshake-ddd-strain-rate-to-quasi-static-fem) → [Handshake 4a](../epilogue/multiscale.md#4a--ddd-strain-rate-to-quasi-static-load-cell-act-iv--hardening). Row 32 is why the knee bent; row 33 is **how lines moved at the right temperature and strain rate before \(\tau(\gamma)\) crossed the scale boundary**. The [preface row 33 skill checkpoint](../preface.md#skill-navigation-row-33) closes the competence loop; the [prologue row 33 closing stitch](../prologue/00-many-scales.md#row-33-closing-stitch) and [epilogue row 33 closing loop](../epilogue/multiscale.md#row-33-closing-loop) reunite the three-way audit.

```mermaid
flowchart LR
  subgraph vii2["Row 32 — forest explains knee"]
    RHO[rho gamma from OpenDiS]
    TAY[Taylor tau sqrt rho]
  end
  subgraph mob["Row 33 — mobility pedigree"]
    TW[T_w from cht_export.yaml]
    MD[M tau T_w from VIII shear]
    YAML[mobility_cu_screw_TwK.yaml]
  end
  subgraph rate["Row 33 — rate reunion"]
    DDD[OpenDiS at 3 strain rates]
    PARSE[parse_rate.sh]
    TAUlab[tau_lab at grip speed]
  end
  subgraph h4a["Handshake 4a"]
    FEM[crystal plasticity deck]
    LC[load cell yield]
  end
  RHO --> TAY --> DDD
  TW --> MD --> YAML --> DDD
  DDD --> PARSE --> TAUlab --> FEM --> LC
  TAY -.->|not sufficient alone| PARSE
```

When row 33 feels disconnected from row 32, read them as **layered meta-stitches**: row 32 when \(\rho\) explains the knee but OpenDiS never ran; row 33 when OpenDiS ran but **300 K mobility defaults or direct DDD-rate import** still shift yield before polycrystal homogenization — skip [VII.2's mobility Lab act](../part07-defects/02-dislocation-dynamics.md#lab-act-calibrate-screw-mobility-from-md-shear-act-iv--mobility-prelude) and [row 14](../preface.md#skill-navigation-row-14) feels like a new course after Part VII.2.

### Row 34 baby picture (polycrystal handoff → Handshake 4b reunion) {#row-34-baby-picture-polycrystal-handshake-4b-reunion}

**Row 34 baby picture:** when Scene, plot spine one-liners, Lab act moves, Scene visuals, Bridge hinges, concept map audits, schematic anchors, Story so far recaps, Closing the arc symbol bridges, Scale-boundary handshakes, thermoelastic assembly, CHT outer-loop reunion, twin-ladder → virtual work reunion, intermission → descent reunion, and forest → Handshake 4a reunion all read correctly but **bulk crystal plasticity and notch localization still feel like separate subjects**, open the [polycrystal handoff → Handshake 4b reunion index](sources.md#polycrystal-handshake-4b-reunion-index-row-34) — read the chain aloud: [VII.3 Steps 1–3 handoff](../part07-defects/03-polycrystal-and-fem-handoff.md#lab-act-archive-the-opendis--damask--fem-handoff-act-ivv) → [Step 4 FE²](../part07-defects/03-polycrystal-and-fem-handoff.md#step-4--when-offline-calibration-fails-fe-at-the-notch) → [`parse_fe2.sh`](../../scripts/parse_fe2.sh) → [Handshake 4b](../epilogue/multiscale.md#4b--when-continuum-fails-at-the-notch-md-subdomain-act-v--notch). Row 33 is why bulk yield is credible; row 34 is **why homogenization stops at the notch root and DDD must embed at selected Gauss points**. The [preface row 34 skill checkpoint](../preface.md#skill-navigation-row-34) closes the competence loop; the [prologue row 34 closing stitch](../prologue/00-many-scales.md#row-34-closing-stitch) and [epilogue row 34 closing loop](../epilogue/multiscale.md#row-34-closing-loop) reunite the three-way audit.

```mermaid
flowchart LR
  subgraph bulk["Row 33 — bulk hardening"]
    RATE[rate_export.yaml]
    DAMASK[damask.yaml from DDD]
    POLY[polycrystal FEM bulk match]
  end
  subgraph notch["Row 34 — notch localization"]
    CP[crystal plasticity at root]
    FE2[FE² DDD-active Gauss pts]
    PARSE[parse_fe2.sh]
  end
  subgraph h4b["Handshake 4b"]
    UPLIFT[10.7% root stress uplift]
    ACT5[Act V notch audit]
  end
  RATE --> DAMASK --> POLY --> CP
  CP -->|under-predicts 10-15%| FE2
  FE2 --> PARSE --> UPLIFT --> ACT5
  POLY -.->|sufficient in bulk| CP
```

When row 34 feels disconnected from row 33, read them as **layered meta-stitches**: row 33 when bulk \(\tau_{\text{lab}}\) is missing or wrong; row 34 when bulk matches the load cell but **Steps 1–3 pass without Step 4 FE² audit at the notch** — skip [VII.3 Step 4](../part07-defects/03-polycrystal-and-fem-handoff.md#step-4--when-offline-calibration-fails-fe-at-the-notch) and [row 15](../preface.md#skill-navigation-row-15) feels like epilogue-only material after Part VII.3.

### Row 35 baby picture (VII.3 → VIII descent handoff reunion) {#row-35-baby-picture-vii3-viii-descent-handoff-reunion}

**Row 35 baby picture:** when Scene, plot spine one-liners, Lab act moves, Scene visuals, Bridge hinges, concept map audits, schematic anchors, Story so far recaps, Closing the arc symbol bridges, Scale-boundary handshakes, thermoelastic assembly, CHT outer-loop reunion, twin-ladder → virtual work reunion, intermission → descent reunion, forest → Handshake 4a reunion, and polycrystal handoff → Handshake 4b reunion all read correctly but **mesoscale export discipline and atomistic descent still feel like separate subjects**, open the [VII.3 → VIII descent handoff reunion index](sources.md#vii3-viii-descent-handoff-reunion-index-row-35) — read the chain aloud: [VII.3 Bridge](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-to-part-viii) export table → [VIII.0 descent hinge](../part08-md/00-opening.md#descent-hinge-cores-mobility-and-tw-pedigree) → [VIII.1 opening hinge](../part08-md/01-potentials-phase-space.md#opening-hinge-vii3-to-viii1) → [VIII.1 EAM Lab act](../part08-md/01-potentials-phase-space.md#lab-act-eam-lattice-constant-from-energy-minimization-act-v--notch-prelude). Row 34 is bulk ↔ notch localization; row 35 is **mesoscale parameters ↔ atomic foundation** when the Bridge named the ink but coordinates and EAM forces have not yet replaced line cutoffs. The [preface row 35 skill checkpoint](../preface.md#skill-navigation-row-35) closes the competence loop; [row 8](../preface.md#skill-navigation-row-8) is the workflow-time mirror when MD mobility at \(T_w\) must be archived.

```mermaid
flowchart LR
  subgraph meso["Row 34 — mesoscale archive"]
    HANDOFF[opendis.restart + mobility.yaml]
    BRIDGE[VII.3 Bridge export table]
  end
  subgraph atom["Row 35 — atomistic foundation"]
    HINGE[VIII.0 descent hinge at T_w]
    OPEN[VIII.1 opening hinge]
    EAM[EAM Lab act: a0, E_coh]
  end
  subgraph ddd["OpenDiS consumer"]
    B[b = a0/sqrt 2]
    M[M tau T_w from MD]
  end
  HANDOFF --> BRIDGE --> HINGE --> OPEN --> EAM
  EAM --> B
  EAM --> M
  BRIDGE -.->|ink named| OPEN
```

When row 35 feels disconnected from row 34, read them as **layered meta-stitches**: row 34 when bulk and notch mesoscale workflows are incomplete; row 35 when the handoff bundle is archived but **`mobility.yaml` cites Part VIII without `cu_eam_a0.txt` or NVT shear at \(T_w\)** — skip [VIII.1 EAM Lab act](../part08-md/01-potentials-phase-space.md#lab-act-eam-lattice-constant-from-energy-minimization-act-v--notch-prelude) and [row 8](../preface.md#skill-navigation-row-8) feels like a new course after Part VII.3.

### Row 36 baby picture (potentials → ensembles reunion) {#row-36-baby-picture-potentials-ensembles-reunion}

**Row 36 baby picture:** when Scene, plot spine one-liners, Lab act moves, Scene visuals, Bridge hinges, concept map audits, schematic anchors, Story so far recaps, Closing the arc symbol bridges, Scale-boundary handshakes, thermoelastic assembly, CHT outer-loop reunion, twin-ladder → virtual work reunion, intermission → descent reunion, forest → Handshake 4a reunion, polycrystal handoff → Handshake 4b reunion, and VII.3 → VIII descent handoff reunion all read correctly but **0 K EAM minimization and NVT/NPT dynamics still feel like separate subjects**, open the [potentials → ensembles reunion index](sources.md#potentials-ensembles-reunion-index-row-36) — read the chain aloud: [VIII.1 EAM Lab act](../part08-md/01-potentials-phase-space.md#lab-act-eam-lattice-constant-from-energy-minimization-act-v--notch-prelude) → [VIII.1 Bridge](../part08-md/01-potentials-phase-space.md#bridge) → [VIII.2 opening hinge](../part08-md/02-ensembles-integrators.md#opening-hinge-viii1-to-viii2) → [VIII.2 NPT Lab act](../part08-md/02-ensembles-integrators.md#lab-act-npt-tension-on-a-copper-nanowire-segment) → `MD_NVT_shear_PartVIII` at \(T_w\) from [`fixtures/cht_export.yaml`](../../fixtures/cht_export.yaml).
...
flowchart LR
  ...
  V -.->|same potential| NPT
```

When row 36 feels disconnected from row 35, read them as **layered meta-stitches**: row 35 when the atomic box is missing; row 36 when **`cu_eam_a0.txt` exists but LAMMPS has not integrated at \(T_w = 311.48\,\text{K}\)** — skip [VIII.1 Bridge](../part08-md/01-potentials-phase-space.md#bridge) and [row 8](../preface.md#skill-navigation-row-8) feels like a new course after VIII.1.

### Row 37 baby picture (ensembles → coarse-graining reunion) {#row-37-baby-picture-ensembles-coarse-graining-reunion}

**Row 37 baby picture:** when Scene, plot spine one-liners, Lab act moves, Scene visuals, Bridge hinges, concept map audits, schematic anchors, Story so far recaps, Closing the arc symbol bridges, Scale-boundary handshakes, thermoelastic assembly, CHT outer-loop reunion, twin-ladder → virtual work reunion, intermission → descent reunion, forest → Handshake 4a reunion, polycrystal handoff → Handshake 4b reunion, VII.3 → VIII descent handoff reunion, and potentials → ensembles reunion all read correctly but **NVT/NPT trajectories and coarse-grained handoff tables still feel like separate subjects**, open the [ensembles → coarse-graining reunion index](sources.md#ensembles-coarse-graining-reunion-index-row-37) — read the chain aloud: [VIII.2 NPT Lab act](../part08-md/02-ensembles-integrators.md#lab-act-npt-tension-on-a-copper-nanowire-segment) → `mobility_cu_screw_311K.yaml` → [VIII.2 Bridge](../part08-md/02-ensembles-integrators.md#bridge) → [VIII.3 opening hinge](../part08-md/03-ab-initio-and-coarse-graining.md#opening-hinge-viii2-to-viii3) → [pedigree checklist](../part08-md/03-ab-initio-and-coarse-graining.md#pedigree-checklist-before-the-epilogue) → [EAM-fit audit Lab act](../part08-md/03-ab-initio-and-coarse-graining.md#lab-act-eam-fit-audit-before-the-notch-md-run-act-v--notch).

```mermaid
flowchart LR
  subgraph dynamic["VIII.2 — audited trajectories"]
    NPT["NPT moduli at T_w"]
    SHEAR["mobility_cu_screw_311K.yaml"]
    PHON["cu.phonon/ VACF peaks"]
  end
  subgraph compress["VIII.3 — coarse-graining"]
    BRIDGE["VIII.2 Bridge handshake table"]
    HINGE["opening hinge: exports with consumers"]
    PED["pedigree checklist"]
    EAM["EAM-fit audit Lab act"]
  end
  NPT --> BRIDGE
  SHEAR --> BRIDGE
  PHON --> BRIDGE
  BRIDGE --> HINGE --> PED --> EAM
  PED -.->|DFT audit gate| IX["Part IX pw.x"]
```

When row 37 feels disconnected from row 36, read them as **layered meta-stitches**: row 36 when dynamics has not run at \(T_w\); row 37 when **`mobility_cu_screw_311K.yaml` exists but no pedigree checklist names DFT audit gates** — skip [VIII.2 Bridge](../part08-md/02-ensembles-integrators.md#bridge) and [row 9](../preface.md#skill-navigation-row-9) feels like a new course after VIII.2.
