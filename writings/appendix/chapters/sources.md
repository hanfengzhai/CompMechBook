...
| Step | Read | Export | Wire-scale consumer | Subgraph node ([baby picture](memory-sheet.md#subgraph-node-audit-table)) | IX.3 pedigree row ↔ [three-way audit](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) ↔ [preface row 16 step](../preface.md#skill-navigation-row-16) |
|------|------|--------|---------------------|-------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1 {#sources-pedigree-step-1} | [IX.3](../part09-dft/03-dft-workflows.md) | \(C_{ij}\), \(\gamma_{\text{sf}}\), cohesive energy | Elastic constants, partial separation in DDD | [`act6`: DFT](memory-sheet.md#subgraph-node-act6-dft) | **1 — DFT → continuum** ↔ [IX.3 parser mapping row 1](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [preface step 2](../preface.md#row-16-step-2) · [epilogue pedigree row](../part09-dft/03-dft-workflows.md#ix3-epilogue-pedigree-table) · [script audit trail H1](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) · [row-level audit](../epilogue/multiscale.md#script-audit-trail-row-level-audit) |
| 2 {#sources-pedigree-step-2} | [VIII.3](../part08-md/03-ab-initio-and-coarse-graining.md) | EAM table, phonon check | Production MD and mobility fitting | [`act6`: MD](memory-sheet.md#subgraph-node-act6-md) | Foundation checklist ↔ [IX.3 foundation checklist](../part09-dft/03-dft-workflows.md#ix3-foundation-checklist) · [`act6`: MD](../appendix/memory-sheet.md#subgraph-node-act6-md) · [preface step 2](../preface.md#row-16-step-2) (foundation folder) |
| 3 {#sources-pedigree-step-3} | [VIII.2](../part08-md/02-ensembles-integrators.md) | \(M(\tau, T)\) from constrained shear | OpenDiS mobility law | [`act6`: DDD](memory-sheet.md#subgraph-node-act6-ddd) | **4a — rate hardening** (mobility input) ↔ [IX.3 parser mapping row 4a](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [`act6`: DDD](../appendix/memory-sheet.md#subgraph-node-act6-ddd) · [MD lifetime row](../epilogue/multiscale.md#script-audit-trail-md-lifetime) · [preface step 4](../preface.md#row-16-step-4) |
| 4 {#sources-pedigree-step-4} | [VII.2](../part07-defects/02-dislocation-dynamics.md) | \(\tau(\gamma)\), \(\rho(\gamma)\), Taylor \(\alpha\) | Crystal plasticity / Voce hardening | [`act6`: DDD](memory-sheet.md#subgraph-node-act6-ddd) → [`orch`: H4a](memory-sheet.md#subgraph-node-orch-h4a) | **4a — rate hardening** ↔ [IX.3 parser mapping row 4a](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [epilogue pedigree row](../part09-dft/03-dft-workflows.md#ix3-epilogue-pedigree-table) · [script audit trail 4a](../epilogue/multiscale.md#script-audit-trail-h4a-rate) · [preface step 1](../preface.md#row-16-step-1) · [preface row 14](../preface.md#skill-navigation-row-14) |
| 5 {#sources-pedigree-step-5} | [IV.4](../part04-fem/04-poisson-to-elasticity.md) | \(\mathbf{K}\) with documented \(E\), \(\nu\) | Load-cell linear regime in Act III | [`act6`: FEM](memory-sheet.md#subgraph-node-act6-fem); [`orch`: H1](memory-sheet.md#subgraph-node-orch-h1) | **1 — DFT → continuum** ↔ [IX.3 parser mapping row 1](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [`orch`: H1](../appendix/memory-sheet.md#subgraph-node-orch-h1) · [preface step 2](../preface.md#row-16-step-2) |
| 6 {#sources-pedigree-step-6} | [Epilogue](../epilogue/multiscale.md#lab-act-reunion-six-acts-one-afternoon) + [`parse_multiscale_workflow.sh`](../../scripts/parse_multiscale_workflow.sh) | `multiscale_export.yaml` linking Handshakes 1–4b | Orchestrated pedigree beside Act VI folder | [`orch`: OUT](memory-sheet.md#subgraph-node-orch-out); [script audit trail row-level audit](../epilogue/multiscale.md#script-audit-trail-row-level-audit) | **All — orchestrated chain** ↔ [IX.3 parser mapping row All](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [preface step 3](../preface.md#row-16-step-3) · [epilogue minimal artifact step 3](../epilogue/multiscale.md#act-vi-foundation-minimal-artifact-step-3) |

Each arrow needs a convergence log and a unit check — the epilogue's [four-handshake sensitivity table](../epilogue/multiscale.md#sensitivity-which-handshake-matters-most) ranks which exports dominate for a given question. **Mathematical order** teaches why the ladder exists; **pedigree order** fills the input deck before the grips close; **orchestration** (row 16) links individual exports in dependency order so Handshake 2's \(\Delta T\) feeds Handshake 3 and phonon lifetime at converged \(T_w\) feeds Handshake 4a drag. The [memory sheet subgraph node audit](memory-sheet.md#subgraph-node-audit-table) and [Act VI baby picture closing paragraph](memory-sheet.md#act-vi-baby-picture-closing) draw the foundation → orchestration diagram when this six-step table feels like isolated chapter links — return to the **IX.3 pedigree row ↔ three-way audit ↔ preface row 16 step** column above when a step number needs the [IX.3 epilogue pedigree table](../part09-dft/03-dft-workflows.md#ix3-epilogue-pedigree-table) → [IX.3 pedigree ↔ parser step mapping](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) → [script audit trail row-level audit](../epilogue/multiscale.md#script-audit-trail-row-level-audit) → [memory sheet subgraph node audit](memory-sheet.md#subgraph-node-audit-table) round-trip; the [preface row 16 step audit](../preface.md#skill-navigation-row-16) (Skill ↔ Pass criterion) and [epilogue Act VI workflow exam step audit](../epilogue/multiscale.md#act-vi-workflow-exam-step-audit) audit orchestration after the pedigree path is complete; the [IX.3 Bridge closing](../part09-dft/03-dft-workflows.md#bridge-to-the-epilogue-closing) and [epilogue Act VI reunion paragraph](../epilogue/multiscale.md#lab-act-reunion-six-acts-one-afternoon) reunite mathematical order with laboratory time when both clocks diverge.
