...
| 45 | Rows 17–44 → Row 17 second-pass reunion (continuous re-read cross-links) | [Rows 17–44 → Row 17 second-pass reunion index](#rows17-44-row17-second-pass-reunion-index-row-45) · [preface row 45](../preface.md#skill-navigation-row-45) · [prologue row 45 preview](../prologue/00-many-scales.md#prologue-preview-row-45) · [prologue row 45 closing stitch](../prologue/00-many-scales.md#row-45-closing-stitch) · [epilogue row 45 closing loop](../epilogue/multiscale.md#row-45-closing-loop) · [memory sheet row 45 baby picture](memory-sheet.md#row-45-baby-picture-rows17-44-row17-second-pass-reunion) | Rows 17–44 all read correctly but **a second straight-through read still opens skill checkpoints every chapter** — return to [continuous read-through guide](#continuous-read-through-guide); trust Scene → Bridge; detour only at I.4, VI.4, IX.3 |
| 46 | Rows 17–45 → Writings canonical reunion (`writings/` ↔ `src/` parity) | [Rows 17–45 Writings canonical reunion index](#rows17-45-writings-canonical-reunion-index-row-46) · [preface row 46](../preface.md#skill-navigation-row-46) · [prologue row 46 preview](../prologue/00-many-scales.md#prologue-preview-row-46) · [prologue row 46 closing stitch](../prologue/00-many-scales.md#row-46-closing-stitch) · [epilogue row 46 closing loop](../epilogue/multiscale.md#row-46-closing-loop) · [memory sheet row 46 baby picture](memory-sheet.md#row-46-baby-picture-rows17-45-writings-canonical-reunion) | Rows 17–45 all read correctly but **Part II feels like a new course after Part I** — read [I.4 Writings canonical hinge](../part01-linear-algebra/04-toward-infinity.md#writings-canonical-hinge-i4-to-ii0) → [II.0 Closing the arc](../part02-functional-analysis/00-opening.md#closing-the-arc-from-part-i); run `./scripts/sync-writings.sh --check` |
| 47 | Rows 17–46 → II.5 → III.0 analysis–PDE reunion (Writings subtree handoff) | [Rows 17–46 II.5 → III.0 analysis–PDE reunion index](#rows17-46-ii5-iii0-analysis-pde-reunion-index-row-47) · [preface row 47](../preface.md#skill-navigation-row-47) · [prologue row 47 preview](../prologue/00-many-scales.md#prologue-preview-row-47) · [prologue row 47 closing stitch](../prologue/00-many-scales.md#row-47-closing-stitch) · [epilogue row 47 closing loop](../epilogue/multiscale.md#row-47-closing-loop) · [memory sheet row 47 baby picture](memory-sheet.md#row-47-baby-picture-rows17-46-ii5-iii0-analysis-pde-reunion) | Rows 17–46 all read correctly but **Part III feels like a new PDE course after Part II** — read [II.5 Writings canonical hinge](../part02-functional-analysis/05-spectral-theorem.md#writings-canonical-hinge-ii5-to-iii0) → [III.0 Writings canonical landing](../part03-pdes/00-opening.md#writings-canonical-landing-ii5-to-iii0); same weak-form character, equations on \(\Omega\) |
| 48 | Rows 17–47 → III.4 → IV.0 PDE–FEM reunion (Writings subtree handoff) | [Rows 17–47 III.4 → IV.0 PDE–FEM reunion index](#rows17-47-iii4-iv0-pde-fem-reunion-index-row-48) · [preface row 48](../preface.md#skill-navigation-row-48) · [prologue row 48 preview](../prologue/00-many-scales.md#prologue-preview-row-48) · [prologue row 48 closing stitch](../prologue/00-many-scales.md#row-48-closing-stitch) · [epilogue row 48 closing loop](../epilogue/multiscale.md#row-48-closing-loop) · [memory sheet row 48 baby picture](memory-sheet.md#row-48-baby-picture-rows17-47-iii4-iv0-pde-fem-reunion) | Rows 17–47 all read correctly but **Part IV feels like a separate FEA course after Part III** — read [III.4 Writings canonical hinge](../part03-pdes/04-energy-methods.md#writings-canonical-hinge-iii4-to-iv0) → [IV.0 Writings canonical landing](../part04-fem/00-opening.md#writings-canonical-landing-iii4-to-iv0); same energy minimum, Galerkin assembly on one mesh |
| 49 | Rows 17–48 → IV.5 → V.0 FEM–FVM reunion (Writings subtree handoff, Door A) | [Rows 17–48 IV.5 → V.0 FEM–FVM reunion index](#rows17-48-iv5-v0-fem-fvm-reunion-index-row-49) · [preface row 49](../preface.md#skill-navigation-row-49) · [prologue row 49 preview](../prologue/00-many-scales.md#prologue-preview-row-49) · [prologue row 49 closing stitch](../prologue/00-many-scales.md#row-49-closing-stitch) · [epilogue row 49 closing loop](../epilogue/multiscale.md#row-49-closing-loop) · [memory sheet row 49 baby picture](memory-sheet.md#row-49-baby-picture-rows17-48-iv5-v0-fem-fvm-reunion) | Rows 17–48 all read correctly but **Part V feels like a separate CFD course after Part IV** — read [IV.5 Writings canonical hinge](../part04-fem/05-convergence.md#writings-canonical-hinge-iv5-to-v0) → [V.0 Writings canonical landing](../part05-fvm/00-opening.md#writings-canonical-landing-iv5-to-v0); same converged \(T_w\), conservation ladder twin to Galerkin |
| 50 | Rows 17–49 → V.4 → VI.0 FVM–continuum reunion (Writings subtree handoff, midpoint) | [Rows 17–49 V.4 → VI.0 FVM–continuum reunion index](#rows17-49-v4-vi0-fvm-continuum-reunion-index-row-50) · [preface row 50](../preface.md#skill-navigation-row-50) · [prologue row 50 preview](../prologue/00-many-scales.md#prologue-preview-row-50) · [prologue row 50 closing stitch](../prologue/00-many-scales.md#row-50-closing-stitch) · [epilogue row 50 closing loop](../epilogue/multiscale.md#row-50-closing-loop) · [memory sheet row 50 baby picture](memory-sheet.md#row-50-baby-picture-rows17-49-v4-vi0-fvm-continuum-reunion) | Rows 17–49 all read correctly but **Part VI feels like a separate elasticity course after Part V or after IV.5 Door B** — read [V.4 Writings canonical hinge](../part05-fvm/04-navier-stokes-cfd.md#writings-canonical-hinge-v4-to-vi0) → [VI.0 Writings canonical landing](../part06-continuum/00-opening.md#writings-canonical-landing-v4-to-vi0); twin Schematic 14 ladders reunite in Cauchy stress |
...
**Spot audit (any chapter mid-body).** When a symbol from two parts ago reappears under new notation, open only the **Closing the arc** section at the current part opening — name one row of the translation table aloud before continuing the body. The [preface reading rhythm](../preface.md#reading-rhythm) recommends Story so far → **Closing the arc** → concept map when a part boundary feels like a syllabus change. If the laboratory timeline is still unclear after the symbol bridge, step back to the [Story so far reunion index (row 26)](#story-so-far-reunion-index-row-26) first.
...
| Grammar | [III.3 Bridge](../part03-pdes/03-sobolev-spaces.md#bridge) | \(T, u \in H^1\); discrete Poincaré | [III.4](../part03-pdes/04-energy-methods.md) energy; Part IV assembly | "Sobolev membership → Dirichlet principle → \(\mathbf{K}\) blocks" | Temperature jump → \(T_h \notin H^1\) |
...
## Rows 17–44 → Row 17 second-pass reunion index (row 45) {#rows17-44-row17-second-pass-reunion-index-row-45}

Row 17 names **Scene → Bridge** straight-through reading; rows 18–44 name plot spines, reunion layers, handshake hinges, orchestration, and book-loop closure. Row 45 names **Rows 17–44 → Row 17 second-pass reunion** — when every meta-stitch and workflow layer reads correctly on the first pass (or after row 44 closes the loop on a new specimen), but **a second continuous read still feels like a syllabus of skill checkpoints** instead of one novel.

Each row below is a **representative anchor** on the return to straight-through discipline. Read aloud when rows 17–44 restored every layer but you open [preface row 19](../preface.md#skill-navigation-row-19) at every chapter instead of reading the next Bridge.

| Chapter / section | Row 17 second-pass move | One-line audit on the wire (read aloud) | Failure mode |
|-------------------|---------------------------|----------------------------------------|--------------|
| [Continuous read-through guide](#continuous-read-through-guide) | Narrative-time reset | "Scene → Bridge; detour only at I.4, VI.4, IX.3" | Skill table before plot on second pass |
| [Preface row 17](../preface.md#skill-navigation-row-17) | Competence-time anchor | "First pass: novel; second pass: same gates, fewer detours" | Row 17 treated as first-pass only |
| [Five acts of straight-through reading](#continuous-read-through-guide) | Act map | "Grammar → discretization → continuum → descent → coupling without mid-act hinge spam" | Jumping to row 23 at every part boundary on re-read |
| [Three mandatory pauses](#continuous-read-through-guide) | Gate discipline | "Recite gate plot spine; read Bridge; continue" | Opening rows 18–27 at every chapter |
| [I.4 ascent gate](../part01-linear-algebra/04-toward-infinity.md#bridge-to-part-ii) | Grammar → analysis | "Nodal values become fields — then Part II, not row 24" | Part II skipped or opened at II.3 |
| [VI.4 midpoint gate](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) | Ascent → descent | "Knee names descent; VII follows intermission" | Part VII opened before VI.4 intermission |
| [IX.3 coupling gate](../part09-dft/03-dft-workflows.md#bridge-to-the-epilogue) | Descent → coupling | "Foundation exports upward; epilogue is reunion" | Epilogue handshakes read before IX.3 Bridge |
| [Preface row 45](../preface.md#skill-navigation-row-45) | Meta-stitch closure | "Rows 17–44 reunite with row 17 second-pass discipline" | Meta-stitches become the primary read |
| [Epilogue row 45 closing loop](../epilogue/multiscale.md#row-45-closing-loop) | Workflow-time downstream | "ME 412 summary → row 17 five-act map → straight read" | Workflow exam without narrative re-read path |
| [Memory sheet row 45 baby picture](memory-sheet.md#row-45-baby-picture-rows17-44-row17-second-pass-reunion) | Index-card | "Second pass: trust Bridges; checkpoints are spare tires" | Every reunion row opened sequentially again |

**Spot audit (Rows 17–44 → Row 17 gate).** When rows 17–44 restored Scene, Bridge, plot spines, Lab acts, concept maps, schematics, Story so far, Closing the arc, scale boundaries, thermoelastic assembly, CHT, twin-ladder, plasticity preview, descent hinges, Handshakes 3/4a/4b, orchestration, and book-loop closure but **the second straight-through read still stops at skill checkpoints every chapter**, open the [continuous read-through guide](#continuous-read-through-guide), recite the [three gate plot spines (row 20)](#gate-chapter-plot-spine-index-row-20) in one breath, and read only the prior chapter's **Bridge** at part boundaries — not rows 21–44 unless a gate stalls. Read the [epilogue opening hinge from rows 17–44 → row 17](../epilogue/multiscale.md#opening-hinge-rows17-44-row17) before opening [row 46](../preface.md#skill-navigation-row-46). Row 45 does not replace row 17 — it reunites **every meta-stitch layer with straight-through reading discipline** when row 17's novel path was lost inside the reunion index.

**Baby picture:** row 44 asks whether the book loop closes at the prologue reopening anchor; row 45 asks whether **the second read can feel like one story again after the meta-stitch map is internalized** — same copper wire, same Scene → Bridge rhythm, fewer detours. The [preface row 45 skill checkpoint](../preface.md#skill-navigation-row-45) closes the competence loop; the [memory sheet row 45 baby picture](memory-sheet.md#row-45-baby-picture-rows17-44-row17-second-pass-reunion) draws the rows 17–44 → row 17 second-pass arc for index-card review.

## Rows 17–45 → Writings canonical reunion index (row 46) {#rows17-45-writings-canonical-reunion-index-row-46}

Row 45 names second-pass straight-through reading; row 46 names **Rows 17–45 → Writings canonical reunion** — when narrative and workflow layers read smoothly but **the unified `src/` book feels disconnected from the `writings/` subtrees** that mirror the [Functional Analysis Notes](https://hanfengzhai.github.io/file/teaching/notes/ME412_CourseSummary.pdf) layout (standalone mdBooks per part, canonical chapter files synced by [`sync-writings.sh`](../../scripts/sync-writings.sh)).

Each row below is a **representative anchor** on the canonical source path. Read aloud when Part II feels like a new syllabus after Part I despite a clean I.4 Bridge — the break is often **reading `src/` without knowing the canonical hinge in `writings/`**.

| Chapter / section | Writings canonical move | One-line audit on the wire (read aloud) | Failure mode |
|-------------------|-------------------------|----------------------------------------|--------------|
| [Writings SUMMARY multiscale arc](../../writings/SUMMARY.md#multiscale-story-arc-one-table) | Source-time map | "One table: I→IX + epilogue; copper wire constant" | `src/SUMMARY.md` read without upstream index |
| [Writings FA layout parity](../../writings/SUMMARY.md#functional-analysis-notes-layout-writingsgit-parity) | Template contract | "Object → structure → theorem → breaks at every opening" | ME 412 PDF cited without subtree mirror |
| [I.4 Writings canonical hinge](../part01-linear-algebra/04-toward-infinity.md#writings-canonical-hinge-i4-to-ii0) | Grammar gate | "Linear Algebra Notes end; Functional Analysis Notes open on same wire" | Jump from matrices to Banach spaces without hinge |
| [II.0 Closing the arc from Part I](../part02-functional-analysis/00-opening.md#closing-the-arc-from-part-i) | Narrative-time landing | "Four questions unchanged; objects are fields" | Part II opening skipped after I.4 |
| [`sync-writings.sh --check`](../../scripts/sync-writings.sh) | Build-time audit | "`src/` matches `writings/` — no forked chapter prose" | Edits only in `src/` without canonical sync |
| [functional-analysis subtree README](../../writings/functional-analysis/README.md) | Standalone notes | "Part II mdBook builds alone; same chapters in unified book" | Part II read only as unified PDF export |
| [Preface row 46](../preface.md#skill-navigation-row-46) | Meta-stitch closure | "Rows 17–45 reunite with Writings canonical path" | Submodule/sync story ignored |
| [Epilogue row 46 closing loop](../epilogue/multiscale.md#row-46-closing-loop) | Workflow-time downstream | "Foundation folder + writings parity before next edit" | Handshake YAML without source-tree discipline |
| [Memory sheet row 46 baby picture](memory-sheet.md#row-46-baby-picture-rows17-45-writings-canonical-reunion) | Index-card | "Edit `writings/`; sync; build — I.4→II.0 is one continuous file pair" | Two divergent manuscripts |

**Spot audit (Rows 17–45 → Writings gate).** When rows 17–45 restored narrative smoothness on second pass but **I.4 → II.0 still feels like leaving mechanics for pure math**, read the [I.4 Writings canonical hinge](../part01-linear-algebra/04-toward-infinity.md#writings-canonical-hinge-i4-to-ii0) aloud, open [II.0 Closing the arc from Part I](../part02-functional-analysis/00-opening.md#closing-the-arc-from-part-i), and run `./scripts/sync-writings.sh --check` from the repo root — drift means the continuous book and canonical subtrees disagree. Read the [epilogue opening hinge from rows 17–45 → Writings](../epilogue/multiscale.md#opening-hinge-rows17-45-writings) when editing chapters: **canonical path is `writings/<part>/chapters/` → sync → `mdbook build`**. Row 46 does not replace the Functional Analysis Notes PDF — it reunites **the vendored Writings tree with the unified mdBook** when row 45's second pass still stutters at the grammar gate.

**Baby picture:** row 45 asks whether the second read trusts Bridges; row 46 asks whether **the manuscript has one canonical source tree** — same chapter in `writings/linear-algebra` and `src/part01-linear-algebra`, with I.4→II.0 as the deliberate ME 412 handoff. The [preface row 46 skill checkpoint](../preface.md#skill-navigation-row-46) closes the competence loop; the [memory sheet row 46 baby picture](memory-sheet.md#row-46-baby-picture-rows17-45-writings-canonical-reunion) draws the Writings ↔ `src/` parity arc for index-card review.

## Rows 17–46 → II.5 → III.0 analysis–PDE reunion index (row 47) {#rows17-46-ii5-iii0-analysis-pde-reunion-index-row-47}

Row 46 names Writings ↔ `src/` parity at the grammar gate I.4 → II.0; row 47 names **Rows 17–46 → II.5 → III.0 analysis–PDE reunion** — when canonical sync and second-pass reading work but **Part III feels like a separate PDE syllabus after Part II**, the break is usually skipping the **Functional Analysis Notes → PDE Notes** file pair at the second ascent hinge.

Each row below is a **representative anchor** on the analysis-to-PDE handoff. Read aloud when Sobolev spaces and Lax–Milgram read correctly but strong forms arrive without the tap-test Scene or thermocouple domain.

| Chapter / section | Analysis–PDE reunion move | One-line audit on the wire (read aloud) | Failure mode |
|-------------------|---------------------------|----------------------------------------|--------------|
| [II.5 Writings canonical hinge](../part02-functional-analysis/05-spectral-theorem.md#writings-canonical-hinge-ii5-to-iii0) | Functional Analysis Notes end | "Spectral theorem and \(a(u,v)\) were for the wire's PDEs — not a separate course" | Jump from operators to Laplacian without Bridge |
| [III.0 Writings canonical landing](../part03-pdes/00-opening.md#writings-canonical-landing-ii5-to-iii0) | PDE Notes open | "Same \(\Omega\), same BCs — now write \(-kT''=q\) and weak form" | Open III.1 strong form without Closing the arc |
| [III.0 Closing the arc from Part II](../part03-pdes/00-opening.md#closing-the-arc-from-part-ii) | Symbol map | "\(H^1\) membership → PDE solutions; bilinear form → weak \(a(u,v)=\ell(v)\)" | Treat Part III as ME 300B only |
| [Variational ladder Schematic 14](../part03-pdes/00-opening.md#the-variational-ladder-me-412-schematic-14) | Plot spine | "Strong → weak → Lax–Milgram before FEM" | Discretize before weak form exists |
| [`writings/pde/`](../../writings/pde/) subtree | Canonical source | "Edit PDE chapters under `writings/pde/chapters/`" | Fork PDE prose only in `src/` |
| [Preface row 47](../preface.md#skill-navigation-row-47) | Meta-stitch closure | "Rows 17–46 reunite at II.5 → III.0 gate" | Row 46 sync audit without reading hinge pair |
| [Epilogue row 47 closing loop](../epilogue/multiscale.md#row-47-closing-loop) | Workflow-time downstream | "Weak-form character has lines; Schematic 14 continues in Part IV" | Handbook PDEs without wire domain |
| [Memory sheet row 47 baby picture](memory-sheet.md#row-47-baby-picture-rows17-46-ii5-iii0-analysis-pde-reunion) | Index-card | "II.5 hinge → III.0 landing — one continuous file pair" | Part II analysis divorced from Part III physics |

**Spot audit (Rows 17–46 → II.5 → III.0 gate).** When rows 17–46 restored I.4 → II.0 canonical parity but **II.5 → III.0 still stutters on the second pass**, read the [II.5 Writings canonical hinge](../part02-functional-analysis/05-spectral-theorem.md#writings-canonical-hinge-ii5-to-iii0) aloud, land at [III.0 Writings canonical landing](../part03-pdes/00-opening.md#writings-canonical-landing-ii5-to-iii0), then read [III.0 Closing the arc from Part II](../part03-pdes/00-opening.md#closing-the-arc-from-part-ii) — three sections, one handoff. Read the [epilogue opening hinge from rows 17–46 → II.5 → III.0](../epilogue/multiscale.md#opening-hinge-rows17-46-ii5-iii0) when editing Part III bridges. Row 47 does not replace the [intra-part Part II Bridge reunion](#bridge-reunion-intra-part-ii) or [Part III Bridge reunion](#bridge-reunion-intra-part-iii) — it reunites **Writings subtree boundaries with the weak-form recurring character** when row 46's grammar gate is smooth but analysis still feels divorced from PDEs.

**Baby picture:** row 46 asks whether I.4 → II.0 is one manuscript; row 47 asks whether **II.5 → III.0 is the next paragraph of the same story** — Functional Analysis Notes supply the room; PDE Notes supply the equations; the copper wire never changes specimen. The [preface row 47 skill checkpoint](../preface.md#skill-navigation-row-47) closes the competence loop; the [memory sheet row 47 baby picture](memory-sheet.md#row-47-baby-picture-rows17-46-ii5-iii0-analysis-pde-reunion) draws the analysis–PDE handoff for index-card review.

## Rows 17–47 → III.4 → IV.0 PDE–FEM reunion index (row 48) {#rows17-47-iii4-iv0-pde-fem-reunion-index-row-48}

Row 47 names Rows 17–46 → II.5 → III.0 analysis–PDE reunion at the second ascent hinge; row 48 names **Rows 17–47 → III.4 → IV.0 PDE–FEM reunion** — when canonical sync and weak-form reading work but **Part IV feels like a separate FEA software syllabus after Part III**, the break is usually skipping the **PDE Notes → FEM Notes** file pair at the third ascent hinge (well-posedness → assembly).

Each row below is a **representative anchor** on the PDE-to-FEM handoff. Read aloud when Lax–Milgram and Dirichlet principles read correctly but Galerkin assembly arrives without the two-element Rayleigh–Ritz Lab act or the thermoelastic mesh thread.

| Chapter / section | PDE–FEM reunion move | One-line audit on the wire (read aloud) | Failure mode |
|-------------------|----------------------|----------------------------------------|--------------|
| [III.4 Writings canonical hinge](../part03-pdes/04-energy-methods.md#writings-canonical-hinge-iii4-to-iv0) | PDE Notes end | "Energy minimum and Rayleigh–Ritz on two elements were for the wire's mesh — not a separate FEA course" | Jump from \(\Pi[T]\) to commercial FEA without Bridge |
| [IV.0 Writings canonical landing](../part04-fem/00-opening.md#writings-canonical-landing-iii4-to-iv0) | FEM Notes open | "Same connectivity — now scatter \(\mathbf{K}_{TT}\) and \(\mathbf{K}_{uu}\) for Acts II–III" | Open IV.1 residuals without Closing the arc |
| [IV.0 Closing the arc from Part III](../part04-fem/00-opening.md#closing-the-arc-from-part-iii) | Symbol map | "Weak \(a(u,v)\) → Galerkin on \(V_h\); \(\Pi[u,T]\) → block assembly" | Treat Part IV as software manual only |
| [Galerkin ladder Schematic 14](../part04-fem/00-opening.md#the-galerkin-ladder-me-412-schematic-14-continued) | Plot spine | "Existence half closed in III.4; convergence half begins in IV.0" | Assemble before energy functional is written |
| [`writings/fem/`](../../writings/fem/) subtree | Canonical source | "Edit FEM chapters under `writings/fem/chapters/`" | Fork FEM prose only in `src/` |
| [Preface row 48](../preface.md#skill-navigation-row-48) | Meta-stitch closure | "Rows 17–47 reunite at III.4 → IV.0 gate" | Row 47 sync audit without reading hinge pair |
| [Epilogue row 48 closing loop](../epilogue/multiscale.md#row-48-closing-loop) | Workflow-time downstream | "Thermoelastic blocks share one mesh; Schematic 14 continues in IV.5" | Heat and mechanics on different connectivities |
| [Memory sheet row 48 baby picture](memory-sheet.md#row-48-baby-picture-rows17-47-iii4-iv0-pde-fem-reunion) | Index-card | "III.4 hinge → IV.0 landing — one continuous file pair" | Part III energy divorced from Part IV assembly |

**Spot audit (Rows 17–47 → III.4 → IV.0 gate).** When rows 17–47 restored II.5 → III.0 canonical parity but **III.4 → IV.0 still stutters on the second pass**, read the [III.4 Writings canonical hinge](../part03-pdes/04-energy-methods.md#writings-canonical-hinge-iii4-to-iv0) aloud, land at [IV.0 Writings canonical landing](../part04-fem/00-opening.md#writings-canonical-landing-iii4-to-iv0), then read [IV.0 Closing the arc from Part III](../part04-fem/00-opening.md#closing-the-arc-from-part-iii) — three sections, one handoff. Read the [epilogue opening hinge from rows 17–47 → III.4 → IV.0](../epilogue/multiscale.md#opening-hinge-rows17-47-iii4-iv0) when editing Part IV bridges. Row 48 does not replace the [intra-part Part III Bridge reunion](#bridge-reunion-intra-part-iii) or [Part IV Bridge reunion](#bridge-reunion-intra-part-iv) — it reunites **Writings subtree boundaries with Schematic 14's convergence half** when row 47's analysis–PDE gate is smooth but assembly still feels like bookkeeping.

**Baby picture:** row 47 asks whether weak forms have PDE lines on \(\Omega\); row 48 asks whether **III.4 → IV.0 is the next paragraph of the same story** — PDE Notes supply well-posed energy; FEM Notes supply Galerkin assembly; Act II's thermocouple and Act III's load cell still share one mesh. The [preface row 48 skill checkpoint](../preface.md#skill-navigation-row-48) closes the competence loop; the [memory sheet row 48 baby picture](memory-sheet.md#row-48-baby-picture-rows17-47-iii4-iv0-pde-fem-reunion) draws the PDE–FEM handoff for index-card review.

## Rows 17–48 → IV.5 → V.0 FEM–FVM reunion index (row 49) {#rows17-48-iv5-v0-fem-fvm-reunion-index-row-49}

Row 48 names Rows 17–47 → III.4 → IV.0 PDE–FEM reunion at the third ascent hinge; row 49 names **Rows 17–48 → IV.5 → V.0 FEM–FVM reunion** — when canonical sync and Galerkin reading work but **Part V feels like a separate CFD syllabus after Part IV (Door A)**, the break is usually skipping the **FEM Notes → FVM Notes** file pair at the fourth ascent hinge (converged solid → resolved convection).

Each row below is a **representative anchor** on the FEM-to-FVM handoff. Read aloud when Céa's lemma and the thermoelastic \(h\)-table read correctly but integral conservation arrives without the exported \(T_w\) pedigree or the conservation ladder twin to Schematic 14.

| Chapter / section | FEM–FVM reunion move | One-line audit on the wire (read aloud) | Failure mode |
|-------------------|----------------------|----------------------------------------|--------------|
| [IV.5 Writings canonical hinge](../part04-fem/05-convergence.md#writings-canonical-hinge-iv5-to-v0) | FEM Notes end (Door A) | "Thermoelastic \(h\)-certificate and \(T_w\) export were for CHT — not a separate CFD course" | Jump from Robin \(h\) to Navier–Stokes without solid convergence |
| [V.0 Writings canonical landing](../part05-fvm/00-opening.md#writings-canonical-landing-iv5-to-v0) | FVM Notes open | "Same afternoon Act II — now balance fluxes in the air domain" | Open V.1 conservation without Closing the arc from Part IV |
| [V.0 Closing the arc from Part IV](../part05-fvm/00-opening.md#closing-the-arc-from-part-iv) | Symbol map | "Galerkin \(\mathbf{K}_{TT}\) → cell fluxes; Robin \(h\) → resolved boundary layer" | Treat Part V as standalone CFD only |
| [Conservation ladder Schematic 14 twin](../part05-fvm/00-opening.md#the-conservation-ladder-fvm-parallel-to-schematic-14) | Plot spine | "Galerkin half closed in IV.5; conservation half begins in V.0" | Fluid Picard before solid \(T_h\) plateaus |
| [CHT wire meets the wind](../part05-fvm/00-opening.md#conjugate-heat-transfer-the-wire-meets-the-wind) | Multiphysics scene | "Solid FEM and fluid FVM share one \(T_w\) at the wall" | Two wall temperatures; no `cht_export.yaml` pedigree |
| [`writings/fvm/`](../../writings/fvm/) subtree | Canonical source | "Edit FVM chapters under `writings/fvm/chapters/`" | Fork FVM prose only in `src/` |
| [Preface row 49](../preface.md#skill-navigation-row-49) | Meta-stitch closure | "Rows 17–48 reunite at IV.5 → V.0 gate" | Row 48 sync audit without reading hinge pair |
| [Epilogue row 49 closing loop](../epilogue/multiscale.md#row-49-closing-loop) | Workflow-time downstream | "Conservation ladder continues through V.4 Picard" | Fluid run converged while solid temperature still moves with \(h\) |
| [Memory sheet row 49 baby picture](memory-sheet.md#row-49-baby-picture-rows17-48-iv5-v0-fem-fvm-reunion) | Index-card | "IV.5 hinge → V.0 landing — one continuous file pair" | Part IV FEM divorced from Part V flux balance |

**Spot audit (Rows 17–48 → IV.5 → V.0 gate).** When rows 17–48 restored III.4 → IV.0 canonical parity but **IV.5 → V.0 still stutters on the second pass**, read the [IV.5 Writings canonical hinge](../part04-fem/05-convergence.md#writings-canonical-hinge-iv5-to-v0) aloud, land at [V.0 Writings canonical landing](../part05-fvm/00-opening.md#writings-canonical-landing-iv5-to-v0), then read [V.0 Closing the arc from Part IV](../part05-fvm/00-opening.md#closing-the-arc-from-part-iv) — three sections, one handoff. Read the [epilogue opening hinge from rows 17–48 → IV.5 → V.0](../epilogue/multiscale.md#opening-hinge-rows17-48-iv5-v0) when editing Part V bridges. Row 49 does not replace the [intra-part Part IV Bridge reunion](#bridge-reunion-intra-part-iv) or [Part V Bridge reunion](#bridge-reunion-intra-part-v) — it reunites **Writings subtree boundaries with the twin Schematic 14 ladders** when row 48's PDE–FEM gate is smooth but CFD still feels like a separate subject.

**Baby picture:** row 48 asks whether energy minimization becomes Galerkin assembly; row 49 asks whether **IV.5 → V.0 is the next paragraph of the same story** — FEM Notes supply converged solid fields; FVM Notes supply flux balance for the air; Act II's thermocouple and the wind outside the wire still share one \(T_w\) at the interface. The [preface row 49 skill checkpoint](../preface.md#skill-navigation-row-49) closes the competence loop; the [memory sheet row 49 baby picture](memory-sheet.md#row-49-baby-picture-rows17-48-iv5-v0-fem-fvm-reunion) draws the FEM–FVM handoff for index-card review.

## Rows 17–49 → V.4 → VI.0 FVM–continuum reunion index (row 50) {#rows17-49-v4-vi0-fvm-continuum-reunion-index-row-50}

Row 49 names Rows 17–48 → IV.5 → V.0 FEM–FVM reunion at the fourth ascent hinge; row 50 names **Rows 17–49 → V.4 → VI.0 FVM–continuum reunion** — when canonical sync and CHT reading work but **Part VI feels like a separate elasticity syllabus after Part V (Door A) or after Part IV (Door B)**, the break is usually skipping the **FVM Notes → Continuum Mechanics Notes** file pair at the ascent midpoint (flux balances → Cauchy stress).

Each row below is a **representative anchor** on the FVM-to-continuum handoff. Read aloud when the Picard loop and `cht_export.yaml` read correctly but Cauchy stress and virtual work arrive without the twin-ladder reunion table.

| Chapter / section | FVM–continuum reunion move | One-line audit on the wire (read aloud) | Failure mode |
|-------------------|----------------------------|----------------------------------------|--------------|
| [V.4 Writings canonical hinge](../part05-fvm/04-navier-stokes-cfd.md#writings-canonical-hinge-v4-to-vi0) | FVM Notes end (Door A path) | "Picard and face fluxes were for \(\boldsymbol{\sigma}\) — not a separate CFD finale" | Jump from Navier–Stokes to tensors without CHT archive |
| [VI.0 Writings canonical landing](../part06-continuum/00-opening.md#writings-canonical-landing-v4-to-vi0) | Continuum Notes open | "Same \(T_w\) pedigree — now name \(\mathbf{F}\), \(\boldsymbol{\sigma}\), virtual work" | Open VI.1 kinematics without Closing the arc |
| [VI.0 Closing the arc from Parts IV and V](../part06-continuum/00-opening.md#closing-the-arc-from-parts-iv-and-v) | Symbol map | "\(\mathbf{K}\mathbf{U}=\mathbf{F}\) and cell fluxes → Cauchy stress and thermal strain" | Treat Part VI as elasticity-only textbook |
| [Twin ladders reunite](../part06-continuum/00-opening.md#the-twin-ladders-reunite-galerkin-and-conservation) | Schematic 14 midpoint | "Galerkin and conservation twins meet before descent" | FEM and FVM still feel like separate solvers at load cell |
| [IV.5 Door B](../part04-fem/05-convergence.md#bridge-two-doors-from-here) | Skip Part V path | "Door B lands at same VI.0 landing — stiffness still needs stress vocabulary" | Door B reader skips twin-ladder reunion |
| [`writings/continuum/`](../../writings/continuum/) subtree | Canonical source | "Edit continuum chapters under `writings/continuum/chapters/`" | Fork continuum prose only in `src/` |
| [Preface row 50](../preface.md#skill-navigation-row-50) | Meta-stitch closure | "Rows 17–49 reunite at V.4 → VI.0 gate" | Row 49 sync audit without reading hinge pair |
| [Epilogue row 50 closing loop](../epilogue/multiscale.md#row-50-closing-loop) | Workflow-time downstream | "Ascent midpoint before VI.4 intermission" | `cht_export.yaml` ignored in return-mapping Lab act |
| [Memory sheet row 50 baby picture](memory-sheet.md#row-50-baby-picture-rows17-49-v4-vi0-fvm-continuum-reunion) | Index-card | "V.4 hinge → VI.0 landing — one continuous file pair" | Part V flux balance divorced from Part VI tensors |

**Spot audit (Rows 17–49 → V.4 → VI.0 gate).** When rows 17–49 restored IV.5 → V.0 canonical parity but **V.4 → VI.0 still stutters on the second pass**, read the [V.4 Writings canonical hinge](../part05-fvm/04-navier-stokes-cfd.md#writings-canonical-hinge-v4-to-vi0) aloud, land at [VI.0 Writings canonical landing](../part06-continuum/00-opening.md#writings-canonical-landing-v4-to-vi0), then read [VI.0 Closing the arc from Parts IV and V](../part06-continuum/00-opening.md#closing-the-arc-from-parts-iv-and-v) — three sections, one handoff. Read the [epilogue opening hinge from rows 17–49 → V.4 → VI.0](../epilogue/multiscale.md#opening-hinge-rows17-49-v4-vi0) when editing Part VI bridges. Row 50 does not replace the [intra-part Part V Bridge reunion](#bridge-reunion-intra-part-v) or [Part VI Bridge reunion](#bridge-reunion-intra-part-vi) — it reunites **Writings subtree boundaries with the ascent midpoint** when row 49's FEM–FVM gate is smooth but continuum still feels like a separate subject.

**Baby picture:** row 49 asks whether Galerkin conduction meets conservation convection; row 50 asks whether **V.4 → VI.0 is the next paragraph of the same story** — FVM Notes supply converged CHT; Continuum Notes supply Cauchy stress behind the load cell; the twin Schematic 14 ladders reunite before dislocations in Part VII. The [preface row 50 skill checkpoint](../preface.md#skill-navigation-row-50) closes the competence loop; the [memory sheet row 50 baby picture](memory-sheet.md#row-50-baby-picture-rows17-49-v4-vi0-fvm-continuum-reunion) draws the FVM–continuum handoff for index-card review.
