...
**Default path:** start at [continuity hinges index](chapters/sources.md#continuity-hinges-index-when-the-plot-stutters) row **17** (Scene → Bridge rhythm), then row **23** ([Bridge reunion](chapters/sources.md#bridge-reunion-index-row-23)) for part boundaries, or [intra-part descent bridges](chapters/sources.md#bridge-reunion-intra-part-viii-ix) when Part VIII–IX chapter turns feel mechanical.
