...
| Row 16 preview (Act VI foundation) {#row-16-preview-skill} ↔ [preface row 16 Skill](../preface.md#skill-navigation-row-16) · [workflow exam Skill column](../epilogue/multiscale.md#act-vi-workflow-exam-step-audit) | Explain why individual handshake exports need an orchestrated pedigree file before the epilogue reunites them ↔ [preface Skill: orchestrate Handshakes 1–4b in dependency order](../preface.md#skill-navigation-row-16) · [workflow exam Pass criterion column](../epilogue/multiscale.md#act-vi-workflow-exam-step-audit) | Four-step sketch in the [row 16 preview step table](#row-16-preview-steps) below — [preface row 16 skill checkpoint](../preface.md#skill-navigation-row-16); [preface epilogue hinges Act VI row](../preface.md#epilogue-continuity-hinges); [reading compass row 16](#reading-compass-two-clocks-on-one-wire); [Part IX coupling ladder](../part09-dft/00-opening.md#the-coupling-ladder-me-412-reunion); [IX.3 Bridge to epilogue](../part09-dft/03-dft-workflows.md#bridge-to-the-epilogue); [script audit trail row-level audit](../epilogue/multiscale.md#script-audit-trail-row-level-audit); epilogue [workflow exam Act VI row](../epilogue/multiscale.md#what-you-should-be-able-to-do-after-the-book) (return here when that row closes the competence loop) |
...
**Row 16 Skill three-way audit.** {#row-16-skill-three-way-audit} The [preview Skill row above](#row-16-preview-skill) ↔ [preface row 16 Skill column](../preface.md#skill-navigation-row-16) ↔ [workflow exam Skill / Pass criterion columns](../epilogue/multiscale.md#act-vi-workflow-exam-step-audit) are bidirectional mirrors — narrative-time preview (before Part I), competence-time preface checkpoint (mid-read), and workflow-exam pass/fail (after the epilogue). Return to the preview Skill row when the preface or workflow exam Skill columns feel abstract without the four-step sketch; return to the preface when the workflow exam Pass criterion column and preview Skill diverge on the same afternoon.
