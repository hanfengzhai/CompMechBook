...
| **Discretization fork → continuum** | [IV.5](part04-fem/05-convergence.md#bridge-two-doors-from-here) / [V.4 intermission](part05-fvm/04-navier-stokes-cfd.md#intermission-discretization-complete-continuum-begins) / [V.4 Bridge](part05-fvm/04-navier-stokes-cfd.md#bridge-to-part-vi) | FEM (Door B) and FVM (Door A) converge on Cauchy stress; two languages, one tensor vocabulary in Part VI |
