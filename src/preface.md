...
| **Discretization fork → continuum** | [V.4 intermission](part05-fvm/04-navier-stokes-cfd.md#intermission-discretization-complete-continuum-begins) · [V.4 Bridge](part05-fvm/04-navier-stokes-cfd.md#bridge-to-part-vi) | FEM (Door A) and FVM (Door B) converge on Cauchy stress; two languages, one tensor vocabulary in Part VI |
