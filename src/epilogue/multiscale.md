...
| <span id="row-18-workflow-exam"></span>Row 18 — part-opening plot spine | Recite plot spine one line at every part opening; narrate nine part roles in one breath when part boundaries feel like separate courses | **Step 1:** read [I.0–III.0 plot spines](../part01-linear-algebra/00-opening.md#plot-spine-one-line) aloud — grammar (3) · **Step 2:** read [IV.0–VI.0 plot spines](../part04-fem/00-opening.md#plot-spine-one-line) at [IV.5 fork](../part04-fem/05-convergence.md#bridge-two-doors-from-here) — discretize (3) · **Step 3:** read [VII.0–IX.0 plot spines](../part07-defects/00-opening.md#plot-spine-one-line) before epilogue — descend (3) · **Step 4:** [part-opening plot spine index](../appendix/sources.md#part-opening-plot-spine-index-row-18) full recitation without opening code — [preface row 18 three-way audit](../preface.md#skill-navigation-row-18); [prologue row 18 preview](../prologue/00-many-scales.md#prologue-preview-row-18); [prologue row 18 closing stitch](../prologue/00-many-scales.md#row-18-closing-stitch); [memory sheet row 18 baby picture](../appendix/memory-sheet.md#row-18-baby-picture-part-opening-plot-spine); [row 18 closing loop](#row-18-closing-loop) |
| <span id="row-19-workflow-exam"></span>Row 19 — numbered-chapter plot spine | Recite plot spine one line at any numbered chapter when mid-chapter abstraction stalls; narrate 35 chapter roles in spot-check breaths when chapter bodies lose the wire | **Step 1:** read [I.1–III.4 plot spines](../part01-linear-algebra/01-vectors-matrices.md#plot-spine-one-line) aloud — grammar ascent (8 chapters) · **Step 2:** read [IV.1–V.4 plot spines](../part04-fem/01-weighted-residuals.md#plot-spine-one-line) at [IV.5 fork](../part04-fem/05-convergence.md#bridge-two-doors-from-here) — discretization (9 chapters) · **Step 3:** read [VI.1–IX.3 plot spines](../part06-continuum/01-kinematics.md#plot-spine-one-line) before epilogue — continuum reunion + descent (18 chapters) · **Step 4:** [numbered-chapter plot spine index](../appendix/sources.md#numbered-chapter-plot-spine-index-row-19) spot check — any chapter's role in one breath without opening code — [preface row 19 three-way audit](../preface.md#skill-navigation-row-19); [prologue row 19 preview](../prologue/00-many-scales.md#prologue-preview-row-19); [prologue row 19 closing stitch](../prologue/00-many-scales.md#row-19-closing-stitch); [memory sheet row 19 baby picture](../appendix/memory-sheet.md#row-19-baby-picture-numbered-chapter-plot-spine); [row 19 closing loop](#row-19-closing-loop) |
