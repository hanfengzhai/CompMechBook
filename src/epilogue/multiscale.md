...
| Act II warming (Handshake 2) | Run FEM solid ↔ FVM fluid until wall flux matches Joule source | [`parse_cht.sh`](../scripts/parse_cht.sh) → `cht_export.yaml`; verify against [V.4 Picard loop](../part05-fvm/04-navier-stokes-cfd.md#lab-act-extension-two-domain-picard-loop-with-a-1d-fem-solid), [preface row 13 step 1](../preface.md#skill-navigation-row-13), [sensitivity derivation](#worked-example-sensitivity-ranks) (Handshake 2 paragraph), and [Act II reunion paragraph](#lab-act-reunion-six-acts-one-afternoon) |
| Act III thermal (Handshake 3) | Export \(\alpha\) after CHT; verify fixed-grip stress dominates load cell | [`parse_alpha.sh`](../scripts/parse_alpha.sh) + [sensitivity derivation](#worked-example-sensitivity-ranks) (Handshake 3 paragraph); [preface row 13](../preface.md#skill-navigation-row-13); [Act III reunion paragraph](#lab-act-reunion-six-acts-one-afternoon); [memory sheet row 13](../appendix/memory-sheet.md#continuity-hinges-master-map) |
...
| Act V notch (Handshake 4b) | Compare FE² root stress to crystal plasticity; decide if offline calibration suffices | [`parse_fe2.sh`](../scripts/parse_fe2.sh) on `fe2_notch_comparison.dat` → `fe2_export.yaml`; verify against [FE² worked example](#worked-example-fe-at-the-wire-notch-act-v--notch), [preface row 15](../preface.md#skill-navigation-row-15), [Act V reunion paragraph](#lab-act-reunion-six-acts-one-afternoon), and [sensitivity derivation](#worked-example-sensitivity-ranks) (Handshake 4b column); upstream rate from [preface row 14](../preface.md#skill-navigation-row-14) |
