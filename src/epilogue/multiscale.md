...
| Act VI foundation | Wire IX → VIII → VII → IV in workflow order; complete [rows 8–9](../preface.md#skill-navigation-row-8) (\(T_w\) pedigree) and [rows 13–15](../preface.md#skill-navigation-row-13) before orchestrating | **Step 1:** rows 8–9, 13–15 artifacts · **Step 2:** `foundation_export.yaml` via [`parse_dft_workflow.sh`](../../scripts/parse_dft_workflow.sh) · **Step 3:** [`parse_multiscale_workflow.sh`](../../scripts/parse_multiscale_workflow.sh) → `multiscale_export.yaml` · **Step 4:** audit `delta_T_from_handshake_2` and `target_T_K` with `./scripts/test-fixtures.sh` — [Act VI minimal artifacts](#act-vi-foundation-minimal-artifacts) (step ↔ node reverse audit); [preface row 16 three-way audit](../preface.md#skill-navigation-row-16); [prologue row 16 preview](../prologue/00-many-scales.md#prologue-preview-row-16); [prologue row 16 closing stitch](../prologue/00-many-scales.md#row-16-closing-stitch); [memory sheet per-node anchors](../appendix/memory-sheet.md#act-vi-subgraph-node-audit); [IX.3 epilogue pedigree table](../part09-dft/03-dft-workflows.md#ix3-epilogue-pedigree-table); [script audit trail](#script-audit-trail-parse-scripts-handshakes); [row 16 closing loop](#row-16-closing-loop) |
| <span id="row-17-workflow-exam"></span>Row 17 — continuous read-through | Read Parts I–IX in Scene → Bridge rhythm; pause only at I.4, VI.4, IX.3; defer rows 0–16 until a gate stalls | **Step 1:** [story in one page](../preface.md#the-story-in-one-page) + [prologue ladder](../prologue/00-many-scales.md#a-ladder-not-a-menu) · **Step 2:** read I–III straight; detour at [I.4 Bridge](../part01-linear-algebra/04-toward-infinity.md#bridge-to-part-ii) only if vectors feel unrelated to PDEs · **Step 3:** mandatory [VI.4 intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) before VII · **Step 4:** [IX.3 Bridge](../part09-dft/03-dft-workflows.md#bridge-to-the-epilogue) → epilogue → [memory sheet](../appendix/memory-sheet.md) — [preface row 17 three-way audit](../preface.md#skill-navigation-row-17); [prologue row 17 preview](../prologue/00-many-scales.md#prologue-preview-row-17); [prologue row 17 closing stitch](../prologue/00-many-scales.md#row-17-closing-stitch); [memory sheet row 17 baby picture](../appendix/memory-sheet.md#row-17-baby-picture-continuous-read-through); [continuous read-through guide](../appendix/sources.md#continuous-read-through-guide); [chapter roadmap](../appendix/sources.md#chapter-roadmap-one-continuous-arc); [row 17 closing loop](#row-17-closing-loop) |
| <span id="row-18-workflow-exam"></span>Row 18 — part-opening plot spine | Recite one plot-spine sentence at every part opening when row 17 stalls at a part boundary | **Step 1:** [I.0–III.0 plot spines](../appendix/sources.md#part-opening-plot-spine-index-row-18) (Act I grammar) · **Step 2:** [IV.0–VI.0 plot spines](../appendix/sources.md#part-opening-plot-spine-index-row-18) (Act II discretization) · **Step 3:** [VII.0–IX.0 plot spines](../appendix/sources.md#part-opening-plot-spine-index-row-18) (Act III descent) · **Step 4:** full nine-part recitation from [plot spine index](../appendix/sources.md#part-opening-plot-spine-index-row-18) — [preface row 18 three-way audit](../preface.md#skill-navigation-row-18); [prologue row 18 preview](../prologue/00-many-scales.md#prologue-preview-row-18); [prologue row 18 closing stitch](../prologue/00-many-scales.md#row-18-closing-stitch); [memory sheet row 18 baby picture](../appendix/memory-sheet.md#row-18-baby-picture-part-opening-plot-spine); [row 18 closing loop](#row-18-closing-loop) |
| <span id="row-19-workflow-exam"></span>Row 19 — numbered-chapter plot spine | Read one plot-spine sentence at any numbered chapter when row 18's part one-liners did not restore continuity | **Step 1:** [I.1–III.4 plot spines](../appendix/sources.md#numbered-chapter-plot-spine-index-row-19) (Act I grammar) · **Step 2:** [IV.2–V.4 plot spines](../appendix/sources.md#numbered-chapter-plot-spine-index-row-19) (Act II discretization) · **Step 3:** [VII.2–IX.3 plot spines](../appendix/sources.md#numbered-chapter-plot-spine-index-row-19) (Act III descent) · **Step 4:** spot audit — any chapter's role narrated in one breath from [numbered-chapter plot spine index](../appendix/sources.md#numbered-chapter-plot-spine-index-row-19) — [preface row 19 three-way audit](../preface.md#skill-navigation-row-19); [prologue row 19 preview](../prologue/00-many-scales.md#prologue-preview-row-19); [prologue row 19 closing stitch](../prologue/00-many-scales.md#row-19-closing-stitch); [memory sheet row 19 baby picture](../appendix/memory-sheet.md#row-19-baby-picture-numbered-chapter-plot-spine); [row 19 closing loop](#row-19-closing-loop) |
| <span id="row-20-workflow-exam"></span>Row 20 — gate-chapter plot spine | Recite plot-spine one line at I.4, VI.4, and IX.3 when row 19's chapter one-liners fail at a plot turn | **Step 1:** [I.4 plot spine](../part01-linear-algebra/04-toward-infinity.md#plot-spine-one-line) + [I.4 Bridge](../part01-linear-algebra/04-toward-infinity.md#bridge-to-part-ii) (ascent gate) · **Step 2:** [VI.4 plot spine](../part06-continuum/04-nonlinear-plasticity-preview.md#plot-spine-one-line) + [VI.4 intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) (midpoint gate) · **Step 3:** [IX.3 plot spine](../part09-dft/03-dft-workflows.md#plot-spine-one-line) + [IX.3 Bridge](../part09-dft/03-dft-workflows.md#bridge-to-the-epilogue) (coupling gate) · **Step 4:** full recitation from [gate-chapter plot spine index](../appendix/sources.md#gate-chapter-plot-spine-index-row-20) — [preface row 20 three-way audit](../preface.md#skill-navigation-row-20); [prologue row 20 preview](../prologue/00-many-scales.md#prologue-preview-row-20); [prologue row 20 closing stitch](../prologue/00-many-scales.md#row-20-closing-stitch); [memory sheet row 20 baby picture](../appendix/memory-sheet.md#row-20-baby-picture-gate-chapter-plot-spine); [row 20 closing loop](#row-20-closing-loop) |
| <span id="row-21-workflow-exam"></span>Row 21 — meta-stitch decision ladder | Name which meta-stitch layer to open first when rows 17–20 feel like a syllabus | **Step 1:** row 17 first pass (Scene → Bridge) · **Step 2:** row 18 at part boundary · **Step 3:** row 19 mid-chapter · **Step 4:** row 20 at I.4, VI.4, IX.3 · **Step 5:** rows 0–16 only for missing workflow artifacts — full audit from [meta-stitch decision ladder index](../appendix/sources.md#meta-stitch-decision-ladder-index-row-21) — [preface row 21 three-way audit](../preface.md#skill-navigation-row-21); [prologue row 21 preview](../prologue/00-many-scales.md#prologue-preview-row-21); [prologue row 21 closing stitch](../prologue/00-many-scales.md#row-21-closing-stitch); [memory sheet row 21 baby picture](../appendix/memory-sheet.md#row-21-baby-picture-meta-stitch-decision-ladder); [row 21 closing loop](#row-21-closing-loop) |
| <span id="row-22-workflow-exam"></span>Row 22 — appendix reference mode | Name which appendix to open first when mid-project lookup makes glossary, sources, and memory sheet feel interchangeable | **Step 1:** symbol collision → [glossary](../appendix/glossary.md#symbol-collision-guide) · **Step 2:** plot stall → [sources row 21](../appendix/sources.md#meta-stitch-decision-ladder-index-row-21) · **Step 3:** workflow stall → [memory sheet rows 0–16](../appendix/memory-sheet.md#continuity-hinges-master-map) — full audit from [appendix reference mode index](../appendix/sources.md#appendix-reference-mode-index-row-22) — [preface row 22 three-way audit](../preface.md#skill-navigation-row-22); [prologue row 22 preview](../prologue/00-many-scales.md#prologue-preview-row-22); [prologue row 22 closing stitch](../prologue/00-many-scales.md#row-22-closing-stitch); [memory sheet row 22 baby picture](../appendix/memory-sheet.md#row-22-baby-picture-appendix-reference-mode); [row 22 closing loop](#row-22-closing-loop) |
...
| Step | Prologue preview ([row 17](../prologue/00-many-scales.md#prologue-preview-row-17)) | [Preface row 17](../preface.md#skill-navigation-row-17) | Workflow exam ([Row 17 row](#row-17-workflow-exam) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-------------------------------------------------------------------------------------|
...
| Step | Prologue preview ([row 18](../prologue/00-many-scales.md#prologue-preview-row-18)) | [Preface row 18](../preface.md#skill-navigation-row-18) | Workflow exam ([Row 18 row](#row-18-workflow-exam) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-------------------------------------------------------------------------------------|
...
| Step | Prologue preview ([row 19](../prologue/00-many-scales.md#prologue-preview-row-19)) | [Preface row 19](../preface.md#skill-navigation-row-19) | Workflow exam ([Row 19 row](#row-19-workflow-exam) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-------------------------------------------------------------------------------------|
...
| Step | Prologue preview ([row 20](../prologue/00-many-scales.md#prologue-preview-row-20)) | [Preface row 20](../preface.md#skill-navigation-row-20) | Workflow exam ([Row 20 row](#row-20-workflow-exam) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-------------------------------------------------------------------------------------|
...
When a mandatory gate stalls the straight read, start at the [gate-chapter plot spine index](../appendix/sources.md#gate-chapter-plot-spine-index-row-20) — not at rows 0–16 — and read the [plot spine one line](../part01-linear-algebra/04-toward-infinity.md#plot-spine-one-line) for that gate aloud before the Bridge. The [memory sheet row 20 baby picture](../appendix/memory-sheet.md#row-20-baby-picture-gate-chapter-plot-spine) compresses the three sentences for index-card review. Do not conflate row 20 (what each gate should sound like) with row 19 (chapter interiors) — row 20 names **plot turns**; row 19 names **chapter bodies**. Proceed to [row 21](../preface.md#skill-navigation-row-21) when rows 17–20 themselves feel overwhelming, or to [row 12](../preface.md#skill-navigation-row-12) when the copper story is complete and a new specimen waits in the grips.

### Row 21 closing loop (meta-stitch decision ladder reunion) {#row-21-closing-loop}

This subsection is the **downstream half** of [memory sheet row 21](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface row 21 skill checkpoint](../preface.md#skill-navigation-row-21), and the [meta-stitch decision ladder index](../appendix/sources.md#meta-stitch-decision-ladder-index-row-21). The [prologue row 21 preview](../prologue/00-many-scales.md#prologue-preview-row-21) and [prologue row 21 closing stitch](../prologue/00-many-scales.md#row-21-closing-stitch) are the **upstream halves** — return there when rows 17–20 themselves feel like a syllabus before the plot has a chance to breathe. Row 21 closes the meta-stitch smoothness loop that rows 17–20 opened: same copper wire, five layers from first pass to workflow artifacts.

**Row 21 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([row 21](../prologue/00-many-scales.md#prologue-preview-row-21)) | [Preface row 21](../preface.md#skill-navigation-row-21) | Workflow exam ([Row 21 row](#row-21-workflow-exam) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-------------------------------------------------------------------------------------|
| 1 | Name row 17 as default first pass | Step 1 — first pass | Scene → Bridge rhythm trusted without opening meta-stitches |
| 2 | Name when to descend to row 18 | Step 2 — part boundary | Part one-liner chosen at correct stall point |
| 3 | Name when to descend to row 19 | Step 3 — chapter interior | Chapter one-liner chosen at correct stall point |
| 4 | Name when to descend to row 20 | Step 4 — plot turn | Gate one-liner chosen at I.4, VI.4, or IX.3 |
| 5 | [Meta-stitch decision ladder index](../appendix/sources.md#meta-stitch-decision-ladder-index-row-21) recitation | Step 5 — workflow | Five-layer ladder narrated in one breath |

When rows 17–20 feel overwhelming, start at the [meta-stitch decision ladder index](../appendix/sources.md#meta-stitch-decision-ladder-index-row-21) — not at the full continuity hinges table — and trust row 17 first. The [memory sheet row 21 baby picture](../appendix/memory-sheet.md#row-21-baby-picture-meta-stitch-decision-ladder) compresses the five layers for index-card review. Do not conflate row 21 (which layer to try) with row 17 (how to read) — row 21 names **decisions**; row 17 names **rhythm**. Proceed to [row 22](../preface.md#skill-navigation-row-22) when mid-project lookup makes the three appendices feel interchangeable, or to [row 12](../preface.md#skill-navigation-row-12) when the copper story is complete and a new specimen waits in the grips.

### Row 22 closing loop (appendix reference mode reunion) {#row-22-closing-loop}

This subsection is the **downstream half** of [memory sheet row 22](../appendix/memory-sheet.md#continuity-hinges-master-map), the [preface row 22 skill checkpoint](../preface.md#skill-navigation-row-22), and the [appendix reference mode index](../appendix/sources.md#appendix-reference-mode-index-row-22). The [prologue row 22 preview](../prologue/00-many-scales.md#prologue-preview-row-22) and [prologue row 22 closing stitch](../prologue/00-many-scales.md#row-22-closing-stitch) are the **upstream halves** — return there when mid-project lookup makes all three appendices feel like menus before a single symbol is disambiguated. Row 22 closes the appendix routing loop: glossary for vocabulary, sources row 21 for plot, memory sheet for workflow.

**Row 22 three-way audit (prologue preview ↔ skill checkpoint ↔ workflow exam).**

| Step | Prologue preview ([row 22](../prologue/00-many-scales.md#prologue-preview-row-22)) | [Preface row 22](../preface.md#skill-navigation-row-22) | Workflow exam ([Row 22 row](#row-22-workflow-exam) above) |
|------|----------------------------------------------------------------------------------|---------------------------------------------------------|-------------------------------------------------------------------------------------|
| 1 | Name glossary as first stop for symbol collision | Step 1 — symbol stall | Can disambiguate \(\rho\), \(\alpha\), \(\mathbf{K}\) without opening workflow rows |
| 2 | Name sources row 21 for plot continuity | Step 2 — plot stall | Can route plot stalls through meta-stitch ladder |
| 3 | Name memory sheet for handshake audits | Step 3 — workflow stall | Can open rows 0–16 only when an export is missing |

When mid-project lookup makes glossary, sources, and memory sheet feel interchangeable, start at the [appendix reference mode index](../appendix/sources.md#appendix-reference-mode-index-row-22) — not at the full continuity hinges table. The [glossary reference mode section](../appendix/glossary.md#appendix-reference-mode-row-22) is the upstream entry when symbol collision is the stall. Do not conflate row 22 (which appendix) with row 21 (which meta-stitch layer) — row 22 names **appendix routing**; row 21 names **reading-order decisions**. Proceed to [row 12](../preface.md#skill-navigation-row-12) when the copper story is complete and a new specimen waits in the grips.
