...
| Act V notch (Handshake 4b) | Compare FE² root stress to crystal plasticity; decide if offline calibration suffices | [`parse_fe2.sh`](../scripts/parse_fe2.sh) on `fe2_notch_comparison.dat` → `fe2_export.yaml`; verify against [FE² worked example](#worked-example-fe-at-the-wire-notch-act-v--notch) and [sensitivity derivation](#worked-example-sensitivity-ranks) (Handshake 4b column) |
