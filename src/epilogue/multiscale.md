...
|-----|----------|------------|----------------|
| <span id="reunion-preview-act-i"></span>I — Mounting | Grips close; first \(\mathbf{K}\mathbf{u}=\mathbf{f}\) | I | Boundary conditions export to every mesh — see [expanded reunion table](#lab-act-reunion-six-acts-one-afternoon) |
