...
| Act VI foundation | Wire IX → VIII → VII → IV in workflow order | Pedigree diagram with units at every arrow; [`parse_multiscale_workflow.sh`](../scripts/parse_multiscale_workflow.sh) → `multiscale_export.yaml`; [preface row 16](../preface.md#skill-navigation-row-16) |
