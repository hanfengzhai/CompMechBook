...
**Intermission → descent reunion (row 32).** If rows 17–31 all read correctly but Part VII still feels like a topic change after continuum, read the [intermission → descent reunion index](../appendix/sources.md#intermission-descent-reunion-index-row-32) — the meta stitch when [VI.4's intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) was skipped or the return-mapping Lab act fit \(H\) without naming cold-drawn history. Recite [VI.4's plot spine](../part06-continuum/04-nonlinear-plasticity-preview.md#plot-spine-one-line) aloud, read the [three descent signals](../part06-continuum/04-nonlinear-plasticity-preview.md#three-signals-to-descend-from-part-vi-to-part-vii), then return to the Scene paragraph above. Row 32 does not replace row 31 — it reunites **phenomenological plasticity with mesoscale physics** when virtual work closed the load cell but the knee remains a fitted parameter rather than a forest.
