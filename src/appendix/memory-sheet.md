...
**Subgraph node ↔ IX.3 pedigree row audit.** {#subgraph-node-audit-table} Each node in the `act6` and `orch` subgraphs above maps one-to-one to a row in [IX.3's epilogue pedigree table](../part09-dft/03-dft-workflows.md#ix3-epilogue-pedigree-table) — return there when a subgraph label feels abstract without archive artifacts; return here when the pedigree table feels like isolated rows without workflow order; return to the [epilogue script audit trail row-level audit](../epilogue/multiscale.md#script-audit-trail-row-level-audit) when minimal artifacts need parser names:

| Subgraph node | IX.3 pedigree row | Minimal artifact ↔ [script audit trail row-level audit](../epilogue/multiscale.md#script-audit-trail-row-level-audit) | Script audit trail row ↔ IX.3 parser mapping |
|---------------|-------------------|----------------------------------------------------------------------------------------------------------------------|---------------------------------------------|
| `act6`: DFT {#subgraph-node-act6-dft} | Foundation checklist rows 1–6 | `cu.scf.in`, `cu.elastic/`, `cu.gsf/` ↔ [H1 `foundation_export.yaml`](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) · [H1 elastic `cu.elastic/`](../epilogue/multiscale.md#script-audit-trail-h1-elastic) · [GSF `gsf_export.yaml`](../epilogue/multiscale.md#script-audit-trail-gsf) ↔ [row-level audit H1](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) · [elastic](../epilogue/multiscale.md#script-audit-trail-h1-elastic) · [GSF](../epilogue/multiscale.md#script-audit-trail-gsf) | [1 — DFT → FEM](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem); [1 — elastic only](../epilogue/multiscale.md#script-audit-trail-h1-elastic); [GSF](../epilogue/multiscale.md#script-audit-trail-gsf) ↔ [IX.3 row 1](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) |
| `act6`: MD {#subgraph-node-act6-md} | *(Part VIII EAM fit on DFT exports)* | EAM potential with DFT pedigree ↔ [MD — phonon DOS `vacf_export.yaml`](../epilogue/multiscale.md#script-audit-trail-md-vacf) · [MD — phonon lifetime `lifetime_export.yaml`](../epilogue/multiscale.md#script-audit-trail-md-lifetime) · [replica MD `wham_export.yaml`](../epilogue/multiscale.md#script-audit-trail-md-wham) ↔ [row-level audit VACF](../epilogue/multiscale.md#script-audit-trail-md-vacf) · [lifetime](../epilogue/multiscale.md#script-audit-trail-md-lifetime) · [WHAM](../epilogue/multiscale.md#script-audit-trail-md-wham) | [MD — phonon DOS](../epilogue/multiscale.md#script-audit-trail-md-vacf); [MD — phonon lifetime](../epilogue/multiscale.md#script-audit-trail-md-lifetime); [replica MD](../epilogue/multiscale.md#script-audit-trail-md-wham) ↔ [IX.3 row 4a support](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) |
| `act6`: DDD {#subgraph-node-act6-ddd} | *(Part VII mobility from MD)* | `mobility_cu_screw_{T_w}K.yaml` ↔ [4a `rate_export.yaml`](../epilogue/multiscale.md#script-audit-trail-h4a-rate) ↔ [row-level audit 4a](../epilogue/multiscale.md#script-audit-trail-h4a-rate) | [4a — DDD → FEM rate](../epilogue/multiscale.md#script-audit-trail-h4a-rate) ↔ [IX.3 row 4a](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) |
| `act6`: FEM {#subgraph-node-act6-fem} | Pedigree row **1 — DFT → continuum** | Voigt \(E\), \(\nu\) in input deck ↔ [H1 `foundation_export.yaml`](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) (upstream consumer) ↔ [row-level audit H1](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) | [1 — DFT → FEM](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) (upstream) ↔ [IX.3 row 1](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) |
| `orch`: H1 {#subgraph-node-orch-h1} | Pedigree row **1 — DFT → continuum** | `foundation_export.yaml` ↔ [H1 `foundation_export.yaml`](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) ↔ [row-level audit H1](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) | [1 — DFT → FEM](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) ↔ [IX.3 row 1](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [prologue preview step 2](../prologue/00-many-scales.md#row-16-preview-step-2) |
| `orch`: H2 {#subgraph-node-orch-h2} | Pedigree row **2 — Joule → CHT** | `cht_export.yaml` ↔ [H2 `cht_export.yaml`](../epilogue/multiscale.md#script-audit-trail-h2-cht) ↔ [row-level audit H2](../epilogue/multiscale.md#script-audit-trail-h2-cht) | [2 — Joule ↔ CHT](../epilogue/multiscale.md#script-audit-trail-h2-cht) ↔ [IX.3 row 2](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [prologue preview steps 1, 4](../prologue/00-many-scales.md#row-16-preview-step-1) |
| `orch`: H3 {#subgraph-node-orch-h3} | Pedigree row **3 — thermal → mechanical** | `alpha_cu_300K.dat` ↔ [H3 `alpha_cu_300K.dat`, `alpha_export.yaml`](../epilogue/multiscale.md#script-audit-trail-h3-alpha) ↔ [row-level audit H3](../epilogue/multiscale.md#script-audit-trail-h3-alpha) | [3 — Thermal → FEM](../epilogue/multiscale.md#script-audit-trail-h3-alpha) ↔ [IX.3 row 3](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [prologue preview steps 1, 4](../prologue/00-many-scales.md#row-16-preview-step-1) |
| `orch`: H4a {#subgraph-node-orch-h4a} | Pedigree row **4a — rate hardening** | `rate_export.yaml` ↔ [4a `rate_export.yaml`](../epilogue/multiscale.md#script-audit-trail-h4a-rate) · [MD lifetime `lifetime_export.yaml`](../epilogue/multiscale.md#script-audit-trail-md-lifetime) ↔ [row-level audit 4a](../epilogue/multiscale.md#script-audit-trail-h4a-rate) · [MD lifetime](../epilogue/multiscale.md#script-audit-trail-md-lifetime) | [4a — DDD → FEM rate](../epilogue/multiscale.md#script-audit-trail-h4a-rate); [MD — phonon lifetime](../epilogue/multiscale.md#script-audit-trail-md-lifetime) ↔ [IX.3 row 4a](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [prologue preview steps 1, 4](../prologue/00-many-scales.md#row-16-preview-step-1) |
| `orch`: H4b {#subgraph-node-orch-h4b} | Pedigree row **4b — notch localization** | `fe2_export.yaml` ↔ [4b `fe2_export.yaml`](../epilogue/multiscale.md#script-audit-trail-h4b-fe2) ↔ [row-level audit 4b](../epilogue/multiscale.md#script-audit-trail-h4b-fe2) | [4b — FE² at notch](../epilogue/multiscale.md#script-audit-trail-h4b-fe2) ↔ [IX.3 row 4b](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [prologue preview step 1](../prologue/00-many-scales.md#row-16-preview-step-1) |
| `orch`: OUT {#subgraph-node-orch-out} | Pedigree row **All — orchestrated chain** | `multiscale_export.yaml` ↔ [All `multiscale_export.yaml`](../epilogue/multiscale.md#script-audit-trail-orchestrated-chain) ↔ [row-level audit All](../epilogue/multiscale.md#script-audit-trail-orchestrated-chain) | [All — orchestrated chain](../epilogue/multiscale.md#script-audit-trail-orchestrated-chain) ↔ [IX.3 row All](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) · [prologue preview step 3](../prologue/00-many-scales.md#row-16-preview-step-3) · [epilogue Act VI foundation minimal artifact](../epilogue/multiscale.md#act-vi-foundation-minimal-artifact) |

The [IX.3 pedigree ↔ parser step mapping](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) adds [preface row 16](../preface.md#skill-navigation-row-16) step columns, [sources parameter pedigree path](sources.md#parameter-pedigree-path-act-vi-reading-order) step anchors, and the **Script audit trail row ↔ subgraph node audit** three-way round-trip to this node audit; the [epilogue script audit trail row-level audit](../epilogue/multiscale.md#script-audit-trail-row-level-audit) is the downstream mirror when subgraph labels need parser round-trips — the **Minimal artifact ↔ row-level audit** column above and that table's fourth column are bidirectional per-handshake mirrors; return there when this table's minimal artifacts feel abstract without prologue preview or epilogue minimal-artifact step anchors; return here when the row-level audit's memory sheet links need the subgraph-node archive context; the [epilogue Act VI foundation minimal artifact](../epilogue/multiscale.md#act-vi-foundation-minimal-artifact) is the workflow-exam mirror when prologue preview steps 1–4 need the per-handshake inline anchors.

When ascent grammar (Parts I–III) and descent pedigree (Parts VII–IX) feel like separate books, return here — row 16 is where the ME 412 coupling ladder reunites them in one afternoon. {#act-vi-baby-picture-closing} The `act6` subgraph (DFT → MD → DDD → FEM) is the workflow-time mirror of [IX.3's foundation checklist](../part09-dft/03-dft-workflows.md#ix3-foundation-checklist) — the scale-boundary handshake table names the audit gate on each DFT archive before [`parse_dft_workflow.sh`](../../scripts/parse_dft_workflow.sh) emits `foundation_export.yaml`; return to that anchor when this closing paragraph feels abstract without the six-row audit table; the [IX.3 epilogue pedigree table](../part09-dft/03-dft-workflows.md#ix3-epilogue-pedigree-table) maps each handshake row to archive artifacts; the [IX.3 pedigree ↔ parser step mapping](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) stitches each pedigree row to script audit trail parsers and [preface row 16](../preface.md#skill-navigation-row-16) competence steps — return there when the `act6` and `orch` subgraphs feel disconnected without parser names; the `orch` subgraph (Handshakes 1–4b → `multiscale_export.yaml`) is the downstream half archived by [`parse_multiscale_workflow.sh`](../../scripts/parse_multiscale_workflow.sh). The [sources parameter pedigree path](sources.md#parameter-pedigree-path-act-vi-reading-order) draws the same IX → IV foundation slice with a six-step reading table — return there when this baby picture feels abstract without chapter links; the pedigree path's closing paragraph links back here for the orchestration diagram. The [epilogue script audit trail](../epilogue/multiscale.md#script-audit-trail-parse-scripts-handshakes) **All — orchestrated chain** row names the parser that runs this subgraph in dependency order; its closing paragraph cites `./scripts/test-fixtures.sh` when auditing `delta_T_from_handshake_2` and `target_T_K`. Return to the [preface epilogue continuity hinges](../preface.md#epilogue-continuity-hinges) (Act VI orchestration row), the [preface row 16 When-to-pause opening sentence](../preface.md#skill-navigation-row-16), the [preface row 16 step audit](../preface.md#skill-navigation-row-16) (↔ [epilogue Act VI workflow exam step audit](../epilogue/multiscale.md#act-vi-workflow-exam-step-audit)), the [prologue row 16 closing stitch](../prologue/00-many-scales.md#row-16-closing-stitch), the [prologue row 16 preview](../prologue/00-many-scales.md#what-you-should-be-able-to-do-after-the-prologue), and [prologue reading compass row 16](../prologue/00-many-scales.md#reading-compass-two-clocks-on-one-wire) when the competence loop closes — this baby picture closing paragraph is the narrative stitch; the epilogue hinges table and those rows are the competence-time mirrors named in the script audit trail opening sentence. The [epilogue Act VI foundation table row](../epilogue/multiscale.md#lab-act-reunion-six-acts-one-afternoon), [IX.3 Bridge closing](../part09-dft/03-dft-workflows.md#bridge-to-the-epilogue-closing), and [workflow exam Act VI row](../epilogue/multiscale.md#what-you-should-be-able-to-do-after-the-book) are the workflow-time mirrors — return to this closing paragraph when the workflow exam Act VI row feels like a checklist without the foundation → orchestration diagram; the [one-page copper wire recap](#one-page-copper-wire-recap) Act VI column compresses the same chain for index-card review; the [epilogue sensitivity worksheet closing](../epilogue/multiscale.md#worked-example-sensitivity-ranks) (row 16 orchestration stitch) proves Handshakes 1–4b ran in dependency order after the partial-derivative audit.
...
Read the [prologue](../prologue/00-many-scales.md#the-experiment-as-plot) for the six-act table in narrative form; read the [epilogue Act VI foundation table row](../epilogue/multiscale.md#lab-act-reunion-six-acts-one-afternoon) for the foundation → handshake workflow and the [workflow exam Act VI row](../epilogue/multiscale.md#what-you-should-be-able-to-do-after-the-book) for the competence-time checklist — the same minimal-artifact column the [prologue row 16 preview](../prologue/00-many-scales.md#what-you-should-be-able-to-do-after-the-prologue) named before Part I (return to that preview row when this column closes the competence loop the preview opened). Act VI's upward export is not a single modulus — it is the orchestrated pedigree file linking Handshakes 1–4b; the [Act VI baby picture](#act-vi-baby-picture-me-412-coupling-ladder) draws that chain; the [IX.3 foundation checklist](../part09-dft/03-dft-workflows.md#ix3-foundation-checklist) (scale-boundary handshake table) and [IX.3 epilogue pedigree table](../part09-dft/03-dft-workflows.md#ix3-epilogue-pedigree-table) map each handshake to DFT archive artifacts; the [script audit trail All — orchestrated chain row](../epilogue/multiscale.md#script-audit-trail-orchestrated-chain) is the parser round-trip mirror of that pedigree table; [preface row 16](../preface.md#skill-navigation-row-16) and the [preface epilogue hinges Act VI row](../preface.md#epilogue-continuity-hinges) close the competence loop when individual exports exist but no `multiscale_export.yaml` links them; the [epilogue sensitivity worksheet closing](../epilogue/multiscale.md#worked-example-sensitivity-ranks) (row 16 orchestration stitch) proves Handshakes 1–4b ran in dependency order after the partial-derivative audit — return there when this Act VI column feels abstract without the quantitative audit trail; return here when that closing stitch completes and you need the index-card compression.
