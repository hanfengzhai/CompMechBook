...
| 6 | Midpoint | [VI.4 intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) → [Part VII first descent rung](../part07-defects/00-opening.md#first-descent-rung-vi-midpoint-reunion) | \(J_2\) fits the curve but not its cause; [mesoscale ladder](../part07-defects/00-opening.md#the-mesoscale-ladder-me-412-cross-index) replaces variational placeholders |
...
| 9 | Descent | [VIII.3 intermission](../part08-md/03-ab-initio-and-coarse-graining.md#intermission-atomistics-ends-electronics-begin) → [VIII.3 → IX](../part08-md/03-ab-initio-and-coarse-graining.md#bridge-to-part-ix) | EAM-fit audits pass but no DFT deck is cited; [VIII midpoint reunion](../part09-dft/00-opening.md#third-descent-rung-viii-midpoint-reunion) reunites trajectories with SCF |
| 10 | Descent | [IX.3 intermission](../part09-dft/03-dft-workflows.md#intermission-electronics-ends-coupling-begins) → [IX.3 → epilogue](../part09-dft/03-dft-workflows.md#bridge-to-the-epilogue) | SCF archive complete but no workflow README; [VIII midpoint reunion](../part09-dft/00-opening.md#third-descent-rung-viii-midpoint-reunion) reunites trajectories with SCF; [prologue row 16 preview](../prologue/00-many-scales.md#prologue-row-16-preview-part-ix-reunion); [epilogue ME 412 coupling ladder](../epilogue/multiscale.md#the-coupling-ladder-me-412-cross-index) |
...
| 13 | Closing | [Handshake 2 → 3](../epilogue/multiscale.md#handshake-2--joule-heating--conjugate-heat-transfer-part-iv--v) → [IX.3 \(\alpha\) Lab act](../part09-dft/03-dft-workflows.md#lab-act-quasiharmonic-alpha-handshake-3-pedigree) → [IX.3 Bridge Act III reunion](../part09-dft/03-dft-workflows.md#bridge-act-iii-reunion-handshake-3) → [Handshake 3](../epilogue/multiscale.md#handshake-3--thermal-strain--mechanical-stiffness-part-vi--iv) | CHT converged but load cell still uses handbook \(\alpha\); [preface row 13 skill checkpoint](../preface.md#skill-navigation-row-13); [prologue row 13 preview](../prologue/00-many-scales.md#prologue-row-13-preview); [sensitivity table](../epilogue/multiscale.md#sensitivity-which-handshake-matters-most) ranks Handshake 3 **first for fixed-grip stress**; [sensitivity derivation worksheet](../epilogue/multiscale.md#worked-example-sensitivity-ranks) proves the ranking |
| 14 | Closing | [VII.3 rate handshake](../part07-defects/03-polycrystal-and-fem-handoff.md#scale-boundary-handshake-ddd-strain-rate-to-quasi-static-fem) → [Handshake 4a](../epilogue/multiscale.md#handshake-4--rate-dependent-hardening-and-notch-localization-part-vii--vi--viii) → [VII.3 Bridge Act IV reunion](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-act-iv-reunion-handshake-4a) | DDD exports feed plasticity deck but hardening knee arrives early; [preface row 14 skill checkpoint](../preface.md#skill-navigation-row-14); [`parse_rate.sh`](../scripts/parse_rate.sh) on `ddd_tau_vs_rate.dat`; [sensitivity derivation worksheet](../epilogue/multiscale.md#worked-example-sensitivity-ranks) (Handshake 4a column) — direct import without extrapolation overpredicts flow stress by 5–35% |
| 15 | Closing | [VII.3 Step 4 FE²](../part07-defects/03-polycrystal-and-fem-handoff.md#step-4--when-offline-calibration-fails-fe-at-the-notch) → [Handshake 4b](../epilogue/multiscale.md#4b--when-continuum-fails-at-the-notch-md-subdomain-act-v--notch) → [VII.3 Bridge Act V reunion](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-act-v-reunion-handshake-4b) | Bulk hardening from 4a looks right but notch root under-predicts peak stress; [preface row 15 skill checkpoint](../preface.md#skill-navigation-row-15); [prologue row 15 preview](../prologue/00-many-scales.md#prologue-row-15-preview-handshake-4b); [`parse_fe2.sh`](../scripts/parse_fe2.sh) on `fe2_notch_comparison.dat`; [sensitivity derivation worksheet](../epilogue/multiscale.md#worked-example-sensitivity-ranks) (Handshake 4b column) — scalar \(H\) under-predicts root stress by 10–15%; upstream rate from [row 14](../preface.md#skill-navigation-row-14) |

**Baby picture:** read straight through for the plot; when the symbols change faster than the specimen, jump to the hinge row — it is the narrative stitch the Functional Analysis Notes layout assumes between numbered chapters. Row 13 is the epilogue-only stitch: **Handshake 2 sets \(\Delta T\); Handshake 3 sets \(\alpha\Delta T\)** — conflating them is the most common multiscale pedigree error on the heated wire; the [epilogue Handshake 2 opening paragraph](../epilogue/multiscale.md#handshake-2-opening) and [Act II reunion paragraph](../epilogue/multiscale.md#act-ii-reunion-handshake-2) (Handshake 2) and [Act III reunion paragraph](../epilogue/multiscale.md#act-iii-reunion-handshake-3) (Handshake 3) name the Joule-heating and thermal pre-stress stitches in workflow time, and the [sensitivity derivation worksheet closing](../epilogue/multiscale.md#worked-example-sensitivity-ranks) links back to the [prologue row 13 preview](../prologue/00-many-scales.md#prologue-row-13-preview) when the competence loop closes. Row 14 is the companion stitch for Act IV: **VII.3 sets \(\tau_{\text{flow}}(\dot\varepsilon_{\text{DDD}})\); Handshake 4a sets \(\tau_{\text{lab}}\)** — conflating DDD timestep strain rate with lab grip speed overpredicts yield by the same order as a handbook \(\alpha\) error shifts thermal stress; the [epilogue Handshake 4a opening paragraph](../epilogue/multiscale.md#handshake-4a-opening) and [Act IV reunion paragraph](../epilogue/multiscale.md#act-iv-reunion-handshake-4a) name the same hardening stitch in workflow time; the [VII.3 Bridge Act IV reunion paragraph](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-act-iv-reunion-handshake-4a) is the downstream pedigree mirror in mathematical order; the [prologue row 14 preview](../prologue/00-many-scales.md#prologue-row-14-preview-handshake-4a) is the forward-looking mirror. Row 15 is the Act V stitch: **4a sets bulk \(\tau_{\text{lab}}\); 4b asks whether scalar \(H\) suffices at the notch root** — sequential homogenization can match bulk flow stress while under-predicting localization by 10–15%; run [`parse_fe2.sh`](../scripts/parse_fe2.sh) before trusting the notch-root answer; the [epilogue Handshake 4b opening paragraph](../epilogue/multiscale.md#handshake-4b-opening) and [Act V reunion paragraph](../epilogue/multiscale.md#act-v-reunion-handshake-4b) name the same notch stitch in workflow time; the [VII.3 Bridge Act V reunion paragraph](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-act-v-reunion-handshake-4b) is the downstream pedigree mirror in mathematical order; the [prologue row 15 preview](../prologue/00-many-scales.md#prologue-row-15-preview-handshake-4b) is the forward-looking mirror; the [sensitivity derivation worksheet closing](../epilogue/multiscale.md#worked-example-sensitivity-ranks) links back to the prologue preview when the competence loop closes.
