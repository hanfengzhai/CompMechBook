...
| `act6`: FEM {#subgraph-node-act6-fem} | Pedigree row **1 — DFT → continuum** | Voigt \(E\), \(\nu\) in input deck ↔ [H1 `foundation_export.yaml`](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) (upstream consumer) | [1 — DFT → FEM](../epilogue/multiscale.md#script-audit-trail-h1-dft-fem) (upstream) ↔ [IX.3 row 1](../part09-dft/03-dft-workflows.md#ix3-pedigree-parser-step-mapping) |
