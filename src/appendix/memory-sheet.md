...
| 45 | Meta | [Rows 17–44 → Row 17 second-pass reunion index](sources.md#rows17-44-row17-second-pass-reunion-index-row-45) · [preface row 45 skill checkpoint](../preface.md#skill-navigation-row-45) · [prologue row 45 preview](../prologue/00-many-scales.md#prologue-preview-row-45) · [prologue row 45 closing stitch](../prologue/00-many-scales.md#row-45-closing-stitch) · [epilogue row 45 closing loop](../epilogue/multiscale.md#row-45-closing-loop) | Rows 17–44 all read correctly but a second straight-through read still opens skill checkpoints every chapter — return to [continuous read-through guide](sources.md#continuous-read-through-guide); [row 45 baby picture](#row-45-baby-picture-rows17-44-row17-second-pass-reunion) |
| 46 | Meta | [Rows 17–45 Writings canonical reunion index](sources.md#rows17-45-writings-canonical-reunion-index-row-46) · [preface row 46 skill checkpoint](../preface.md#skill-navigation-row-46) · [prologue row 46 preview](../prologue/00-many-scales.md#prologue-preview-row-46) · [prologue row 46 closing stitch](../prologue/00-many-scales.md#row-46-closing-stitch) · [epilogue row 46 closing loop](../epilogue/multiscale.md#row-46-closing-loop) | Rows 17–45 all read correctly but Part II feels like a new course after Part I — read [I.4 Writings canonical hinge](../part01-linear-algebra/04-toward-infinity.md#writings-canonical-hinge-i4-to-ii0); `./scripts/sync-writings.sh --check`; [row 46 baby picture](#row-46-baby-picture-rows17-45-writings-canonical-reunion) |
| 47 | Meta | [Rows 17–46 II.5 → III.0 reunion index](sources.md#rows17-46-ii5-iii0-analysis-pde-reunion-index-row-47) · [preface row 47 skill checkpoint](../preface.md#skill-navigation-row-47) · [prologue row 47 preview](../prologue/00-many-scales.md#prologue-preview-row-47) · [prologue row 47 closing stitch](../prologue/00-many-scales.md#row-47-closing-stitch) · [epilogue row 47 closing loop](../epilogue/multiscale.md#row-47-closing-loop) | Rows 17–46 all read correctly but Part III feels like a new PDE course after Part II — read [II.5 Writings canonical hinge](../part02-functional-analysis/05-spectral-theorem.md#writings-canonical-hinge-ii5-to-iii0) → [III.0 Writings canonical landing](../part03-pdes/00-opening.md#writings-canonical-landing-ii5-to-iii0); [row 47 baby picture](#row-47-baby-picture-rows17-46-ii5-iii0-analysis-pde-reunion) |
| 48 | Meta | [Rows 17–47 III.4 → IV.0 reunion index](sources.md#rows17-47-iii4-iv0-pde-fem-reunion-index-row-48) · [preface row 48 skill checkpoint](../preface.md#skill-navigation-row-48) · [prologue row 48 preview](../prologue/00-many-scales.md#prologue-preview-row-48) · [prologue row 48 closing stitch](../prologue/00-many-scales.md#row-48-closing-stitch) · [epilogue row 48 closing loop](../epilogue/multiscale.md#row-48-closing-loop) | Rows 17–47 all read correctly but Part IV feels like a separate FEA course after Part III — read [III.4 Writings canonical hinge](../part03-pdes/04-energy-methods.md#writings-canonical-hinge-iii4-to-iv0) → [IV.0 Writings canonical landing](../part04-fem/00-opening.md#writings-canonical-landing-iii4-to-iv0); [row 48 baby picture](#row-48-baby-picture-rows17-47-iii4-iv0-pde-fem-reunion) |
| 49 | Meta | [Rows 17–48 IV.5 → V.0 reunion index](sources.md#rows17-48-iv5-v0-fem-fvm-reunion-index-row-49) · [preface row 49 skill checkpoint](../preface.md#skill-navigation-row-49) · [prologue row 49 preview](../prologue/00-many-scales.md#prologue-preview-row-49) · [prologue row 49 closing stitch](../prologue/00-many-scales.md#row-49-closing-stitch) · [epilogue row 49 closing loop](../epilogue/multiscale.md#row-49-closing-loop) | Rows 17–48 all read correctly but Part V feels like a separate CFD course after Part IV — read [IV.5 Writings canonical hinge](../part04-fem/05-convergence.md#writings-canonical-hinge-iv5-to-v0) → [V.0 Writings canonical landing](../part05-fvm/00-opening.md#writings-canonical-landing-iv5-to-v0); [row 49 baby picture](#row-49-baby-picture-rows17-48-iv5-v0-fem-fvm-reunion) |
| 50 | Meta | [Rows 17–49 V.4 → VI.0 reunion index](sources.md#rows17-49-v4-vi0-fvm-continuum-reunion-index-row-50) · [preface row 50 skill checkpoint](../preface.md#skill-navigation-row-50) · [prologue row 50 preview](../prologue/00-many-scales.md#prologue-preview-row-50) · [prologue row 50 closing stitch](../prologue/00-many-scales.md#row-50-closing-stitch) · [epilogue row 50 closing loop](../epilogue/multiscale.md#row-50-closing-loop) | Rows 17–49 all read correctly but Part VI feels like a separate elasticity course after Part V — read [V.4 Writings canonical hinge](../part05-fvm/04-navier-stokes-cfd.md#writings-canonical-hinge-v4-to-vi0) → [VI.0 Writings canonical landing](../part06-continuum/00-opening.md#writings-canonical-landing-v4-to-vi0); [row 50 baby picture](#row-50-baby-picture-rows17-49-v4-vi0-fvm-continuum-reunion) |
...
**Row 45 baby picture:** when every meta-stitch through row 44 reads correctly but **a second straight-through pass still opens rows 18–44 at every chapter**, recite: "Scene → Bridge; gates at I.4, VI.4, IX.3; reunion rows are spare tires" — then open the [continuous read-through guide](sources.md#continuous-read-through-guide) and the [epilogue opening hinge rows 17–44 → row 17](../epilogue/multiscale.md#opening-hinge-rows17-44-row17).

### Row 46 baby picture (Rows 17–45 → Writings canonical reunion) {#row-46-baby-picture-rows17-45-writings-canonical-reunion}

**Row 46 baby picture:** when second-pass reading works but **I.4 → II.0 feels like two textbooks**, recite: "edit `writings/` → sync → build; same thermocouple, fields not vectors" — read [I.4 Writings canonical hinge](../part01-linear-algebra/04-toward-infinity.md#writings-canonical-hinge-i4-to-ii0) → [II.0 Closing the arc](../part02-functional-analysis/00-opening.md#closing-the-arc-from-part-i); run `./scripts/sync-writings.sh --check`.

### Row 47 baby picture (Rows 17–46 → II.5 → III.0 analysis–PDE reunion) {#row-47-baby-picture-rows17-46-ii5-iii0-analysis-pde-reunion}

**Row 47 baby picture:** when row 46 closed I.4 → II.0 but **II.5 → III.0 feels like analysis homework then a PDE syllabus**, recite: "same wire, weak form gets PDE lines on \(\Omega\)" — read [II.5 Writings canonical hinge](../part02-functional-analysis/05-spectral-theorem.md#writings-canonical-hinge-ii5-to-iii0) → [III.0 Writings canonical landing](../part03-pdes/00-opening.md#writings-canonical-landing-ii5-to-iii0) → [Closing the arc from Part II](../part03-pdes/00-opening.md#closing-the-arc-from-part-ii).

### Row 48 baby picture (Rows 17–47 → III.4 → IV.0 PDE–FEM reunion) {#row-48-baby-picture-rows17-47-iii4-iv0-pde-fem-reunion}

**Row 48 baby picture:** when row 47 closed II.5 → III.0 but **III.4 → IV.0 feels like energy theory then an FEA software manual**, recite: "same mesh, \(\Pi[T]\) scatter becomes \(\mathbf{K}_{TT}\)" — read [III.4 Writings canonical hinge](../part03-pdes/04-energy-methods.md#writings-canonical-hinge-iii4-to-iv0) → [IV.0 Writings canonical landing](../part04-fem/00-opening.md#writings-canonical-landing-iii4-to-iv0) → [Closing the arc from Part III](../part04-fem/00-opening.md#closing-the-arc-from-part-iii).

### Row 49 baby picture (Rows 17–48 → IV.5 → V.0 FEM–FVM reunion) {#row-49-baby-picture-rows17-48-iv5-v0-fem-fvm-reunion}

**Row 49 baby picture:** when row 48 closed III.4 → IV.0 but **IV.5 → V.0 feels like FEA convergence then a standalone CFD syllabus**, recite: "same \(T_w\), Céa certificate before Picard" — read [IV.5 Writings canonical hinge](../part04-fem/05-convergence.md#writings-canonical-hinge-iv5-to-v0) → [V.0 Writings canonical landing](../part05-fvm/00-opening.md#writings-canonical-landing-iv5-to-v0) → [Closing the arc from Part IV](../part05-fvm/00-opening.md#closing-the-arc-from-part-iv) → [conservation ladder twin](../part05-fvm/00-opening.md#the-conservation-ladder-fvm-parallel-to-schematic-14).

### Row 50 baby picture (Rows 17–49 → V.4 → VI.0 FVM–continuum reunion) {#row-50-baby-picture-rows17-49-v4-vi0-fvm-continuum-reunion}

**Row 50 baby picture:** when row 49 closed IV.5 → V.0 but **V.4 → VI.0 feels like CFD flux balance then a standalone elasticity syllabus**, recite: "same `cht_export.yaml`, twin ladders reunite in \(\boldsymbol{\sigma}\)" — read [V.4 Writings canonical hinge](../part05-fvm/04-navier-stokes-cfd.md#writings-canonical-hinge-v4-to-vi0) → [VI.0 Writings canonical landing](../part06-continuum/00-opening.md#writings-canonical-landing-v4-to-vi0) → [Closing the arc from Parts IV and V](../part06-continuum/00-opening.md#closing-the-arc-from-parts-iv-and-v) → [twin ladders reunite](../part06-continuum/00-opening.md#the-twin-ladders-reunite-galerkin-and-conservation).
