...
Row 4 is the **discretization fork contract** — the same weak form from Part III splits into Galerkin assembly (Part IV) and conservation flux balance (Part V); Schematic 14 becomes twin dialects on one copper wire before [row 5](#row-5-baby-picture-twin-ladders-reunion) reunites them on Cauchy stress in Part VI.
