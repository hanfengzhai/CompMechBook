...
| 7 | Descent | [VI.4 intermission](../part06-continuum/04-nonlinear-plasticity-preview.md#intermission-ascent-ends-descent-begins) · [VI.4 Bridge](../part06-continuum/04-nonlinear-plasticity-preview.md#bridge-to-part-vii) · [VII.1 opening hinge](../part07-defects/01-defect-taxonomy.md#defect-taxonomy-opening-hinge-plasticity-to-forest) · [VII.2 opening hinge](../part07-defects/02-dislocation-dynamics.md#ddd-opening-hinge-taxonomy-to-motion) | \(J_2\) fits the curve but not its cause; scalar \(\alpha\) yields to Burgers geometry; static taxonomy yields to Peach–Köhler motion |
