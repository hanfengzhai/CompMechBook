...
| 70 | Meta | [Row 69 → III.2 → III.3 reunion index](sources.md#row69-iii2-iii3-sobolev-reunion-index-row-70) · [preface row 70 skill checkpoint](../preface.md#skill-navigation-row-70) · [prologue row 70 preview](../prologue/00-many-scales.md#prologue-preview-row-70) · [prologue row 70 closing stitch](../prologue/00-many-scales.md#row-70-closing-stitch) · [epilogue row 70 closing loop](../epilogue/multiscale.md#row-70-closing-loop) · [III.2 → III.3 Writings hinge](../part03-pdes/02-weak-form.md#writings-canonical-hinge-iii2-to-iii3) | Row 69 closed but III.2 → III.3 feels like two courses — III.2 Bridge → handshake → III.3 landing → opening hinge → patch-test Lab act; [row 70 baby picture](#row-70-baby-picture-row69-iii2-iii3-sobolev-reunion) |
...
### Row 70 baby picture (Row 69 → III.2 → III.3 Sobolev reunion) {#row-70-baby-picture-row69-iii2-iii3-sobolev-reunion}

**Row 70 baby picture:** when row 69 closed the spring-to-FEM loop but **III.3 opened on Sobolev embeddings before [III.2 Bridge](../part03-pdes/02-weak-form.md#bridge) and the kinks-at-nodes Scene**, or [`writings/pde`](../../writings/pde/chapters/SUMMARY.md) `02-weak-form.md` → `03-sobolev-spaces.md` feels like two mdBooks, open the [Row 69 → III.2 → III.3 reunion index](sources.md#row69-iii2-iii3-sobolev-reunion-index-row-70) — walk **III.2 Bridge handshake → III.3 landing → opening hinge → patch-test Lab act** before energy methods.

When row 70 feels disconnected from row 69, read them as **second vs third chapter inside Part III**: row 69 closes **where virtual work replaces pointwise Laplacians**; row 70 closes **where \(H^1\) membership makes FEM kinks legal** — same wire, the question shifts from "does \(a(u,v)=\ell(v)\) balance?" to "does the broken-line temperature field satisfy \(\|\nabla T_h\|_{L^2} < \infty\)?".
