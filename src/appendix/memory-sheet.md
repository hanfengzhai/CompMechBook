...
When a chapter feels disconnected from the last, pause at the hinge for your reading position — same copper wire, richer vocabulary at each turn. The [preface](../preface.md) splits these into opening, ascent, midpoint, descent, and epilogue tables; this page collects all **seventeen narrative hinges** in reading order.
...
| 5 | Ascent | [V.4 intermission → VI](../part05-fvm/04-navier-stokes-cfd.md#intermission-discretization-complete-continuum-begins) · [VI.1 opening hinge](../part06-continuum/01-kinematics.md#continuum-opening-hinge-discretization-to-kinematics) · [VI.2 opening hinge](../part06-continuum/02-stress-balance.md#balance-opening-hinge-kinematics-to-stress) · [VI.3 opening hinge](../part06-continuum/03-variational-elasticity.md#variational-opening-hinge-balance-to-energy) · [VI.4 opening hinge](../part06-continuum/04-nonlinear-plasticity-preview.md#plasticity-opening-hinge-energy-to-yield) | FEM and FVM feel like unrelated courses; \(\mathbf{F}\) replaces nodal \(\mathbf{U}\); load cell needs Cauchy stress conjugate; \(\mathbf{K}\mathbf{U}=\mathbf{F}\) needs variational source behind assembly; Act IV knee needs J₂ internal variables beyond quadratic \(\Pi\) |
...
**Row 9 baby picture:** EAM fits bulk moduli on trust until Part IX supplies SCF logs **and** evaluates quasiharmonic \(\alpha(T_w)\) and phonon lifetimes at the same \(T_w\) from row 8 — not at 300 K alone. The [IX.0 thermal phonon audit table](../part09-dft/00-opening.md#thermal-phonon-audit-at-tw) lists the three quantities at risk; the [preface row 9 skill checkpoint](../preface.md#skill-navigation-row-9) closes the competence loop; the [epilogue Closing the arc from Part IX](../epilogue/multiscale.md#closing-the-arc-from-part-ix) is where those audits compose with Handshakes 2–4a in workflow time.
