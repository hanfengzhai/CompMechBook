...
| [62](../preface.md#skill-navigation-row-62) | Row 61 closed I.4 → II.0 but II.0 Schematic syllabus and II.1 Lax–Milgram feel disconnected or `00-opening` → `01-motivation` feels like two mdBooks | [Row 61 → II.0 → II.1 reunion index](sources.md#row61-ii0-ii1-motivation-reunion-index-row-62) + [II.0 Bridge](../part02-functional-analysis/00-opening.md#bridge) | **row 61 → II.0 Bridge → bar-refinement Lab act** — Closing the arc before normed axioms |
| [63](../preface.md#skill-navigation-row-63) | Row 62 closed II.0 → II.1 but II.1 Lax–Milgram and II.2 metric axioms feel disconnected or `01-motivation` → `02-normed-spaces` feels like two mdBooks | [Row 62 → II.1 → II.2 reunion index](sources.md#row62-ii1-ii2-normed-spaces-reunion-index-row-63) + [II.1 Bridge](../part02-functional-analysis/01-motivation.md#bridge) | **row 62 → II.1 Bridge → hat-function Lab act** — energy norm before Hilbert geometry |
