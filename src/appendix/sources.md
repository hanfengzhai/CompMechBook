...
| 16 | Epilogue (Act VI orchestration) | [Parameter pedigree path](#parameter-pedigree-path-act-vi-reading-order), [preface row 16 three-way audit](../preface.md#skill-navigation-row-16), [prologue row 16 preview](../prologue/00-many-scales.md#prologue-preview-row-16), [prologue row 16 closing stitch](../prologue/00-many-scales.md#row-16-closing-stitch), [row 16 closing loop](../epilogue/multiscale.md#row-16-closing-loop), [Act VI baby picture](memory-sheet.md#act-vi-baby-picture-me-412-coupling-ladder) | Individual exports exist but no orchestrated `multiscale_export.yaml`; IX → IV pedigree before grips close; row 16 orchestrates Handshakes 1–4b in dependency order |
| 17 | Whole book (continuous read-through) | [Continuous read-through guide](#continuous-read-through-guide), [preface row 17 three-way audit](../preface.md#skill-navigation-row-17), [prologue row 17 preview](../prologue/00-many-scales.md#prologue-preview-row-17), [prologue row 17 closing stitch](../prologue/00-many-scales.md#row-17-closing-stitch), [row 17 closing loop](../epilogue/multiscale.md#row-17-closing-loop), [row 17 baby picture](memory-sheet.md#row-17-baby-picture-continuous-read-through), [chapter roadmap](#chapter-roadmap-one-continuous-arc) | Chapters feel choppy despite Bridges — trust Scene/Bridge rhythm; pause only at three ascent/descent gates (I.4, VI.4, IX.3); row 17 names when to defer rows 0–16 until a gate stalls |
| 18 | Part openings I.0–IX.0 | [Part-opening plot spine index](#part-opening-plot-spine-index-row-18), [preface row 18 three-way audit](../preface.md#skill-navigation-row-18), [prologue row 18 preview](../prologue/00-many-scales.md#prologue-preview-row-18), [prologue row 18 closing stitch](../prologue/00-many-scales.md#row-18-closing-stitch), [row 18 closing loop](../epilogue/multiscale.md#row-18-closing-loop), [row 18 baby picture](memory-sheet.md#row-18-baby-picture-part-opening-plot-spine) | A part opening feels like a new syllabus — read its [plot spine one line](../part01-linear-algebra/00-opening.md#plot-spine-one-line) aloud; row 18 names what each part should sound like when row 17 stalls at a part boundary |
| 19 | Numbered chapters I.1–IX.3 | [Numbered-chapter plot spine index](#numbered-chapter-plot-spine-index-row-19), [preface row 19 three-way audit](../preface.md#skill-navigation-row-19), [prologue row 19 preview](../prologue/00-many-scales.md#prologue-preview-row-19), [prologue row 19 closing stitch](../prologue/00-many-scales.md#row-19-closing-stitch), [row 19 closing loop](../epilogue/multiscale.md#row-19-closing-loop), [row 19 baby picture](memory-sheet.md#row-19-baby-picture-numbered-chapter-plot-spine) | Mid-chapter reading stalls despite a Bridge — read this chapter's [plot spine one line](../part01-linear-algebra/01-vectors-matrices.md#plot-spine-one-line) aloud; row 19 names what each chapter should sound like when row 18 stalls mid-part |
| 20 | Gate chapters I.4, VI.4, IX.3 | [Gate-chapter plot spine index](#gate-chapter-plot-spine-index-row-20), [preface row 20 three-way audit](../preface.md#skill-navigation-row-20), [prologue row 20 preview](../prologue/00-many-scales.md#prologue-preview-row-20), [prologue row 20 closing stitch](../prologue/00-many-scales.md#row-20-closing-stitch), [row 20 closing loop](../epilogue/multiscale.md#row-20-closing-loop), [epilogue Row 20 workflow exam](../epilogue/multiscale.md#row-20-workflow-exam), [row 20 baby picture](memory-sheet.md#row-20-baby-picture-gate-chapter-plot-spine) | A mandatory gate stalls the straight read — recite its [plot spine one line](../part01-linear-algebra/04-toward-infinity.md#plot-spine-one-line) aloud before the Bridge; row 20 names what each gate should sound like when row 19 stalls at a plot turn |
| 21 | Meta-stitch decision ladder (rows 17–20) | [Meta-stitch decision ladder index](#meta-stitch-decision-ladder-index-row-21), [preface row 21 three-way audit](../preface.md#skill-navigation-row-21), [prologue row 21 preview](../prologue/00-many-scales.md#prologue-preview-row-21), [prologue row 21 closing stitch](../prologue/00-many-scales.md#row-21-closing-stitch), [row 21 closing loop](../epilogue/multiscale.md#row-21-closing-loop), [epilogue Row 21 workflow exam](../epilogue/multiscale.md#row-21-workflow-exam), [row 21 baby picture](memory-sheet.md#row-21-baby-picture-meta-stitch-decision-ladder) | Rows 17–20 themselves feel like a syllabus — use the layered ladder: row 17 first pass → row 18 at part boundary → row 19 mid-chapter → row 20 at gates → rows 0–16 for workflow artifacts |
| 22 | Appendix reference mode (mid-project lookup) | [Appendix reference mode index](#appendix-reference-mode-index-row-22), [preface row 22 three-way audit](../preface.md#skill-navigation-row-22), [prologue row 22 preview](../prologue/00-many-scales.md#prologue-preview-row-22), [prologue row 22 closing stitch](../prologue/00-many-scales.md#row-22-closing-stitch), [row 22 closing loop](../epilogue/multiscale.md#row-22-closing-loop), [epilogue Row 22 workflow exam](../epilogue/multiscale.md#row-22-workflow-exam), [row 22 baby picture](memory-sheet.md#row-22-baby-picture-appendix-reference-mode), [glossary reference mode](../appendix/glossary.md#appendix-reference-mode-row-22) | Mid-project lookup — not cover-to-cover reading — and three appendices feel interchangeable; row 22 names which page to open first: glossary for symbols, sources row 21 for plot continuity, memory sheet for workflow habits |

## Appendix reference mode index (row 22) {#appendix-reference-mode-index-row-22}

Row 17 assumes a **straight-through read** (Preface → Epilogue). Row 22 names the **appendix decision tree** when you are mid-project — jumping between chapters, codes, and input decks — and the three back-matter pages feel interchangeable.

| Question you have | Open first | Secondary |
|-------------------|------------|-----------|
| What did symbol \(\rho\), \(\alpha\), or \(\mathbf{K}\) mean **last time**? | [Glossary](glossary.md#symbol-collision-guide) — symbol collision and continuity threads | Chapter Bridge where the symbol reappears |
| Where does chapter \(Y\) sit, or how do I **restore plot** continuity? | [Row 21 meta-stitch decision ladder](#meta-stitch-decision-ladder-index-row-21) — then [chapter roadmap](#chapter-roadmap-one-continuous-arc) | [Continuous read-through guide](#continuous-read-through-guide) if re-reading a span |
| What **habit, trap, or handshake** should I audit before trusting an export? | [Memory sheet](memory-sheet.md#continuity-hinges-master-map) rows 0–16 | [Epilogue](../epilogue/multiscale.md) sensitivity table for ranked handshakes |

**Baby picture:** three appendices, one decision — **glossary** for vocabulary, **sources** (via row 21) for reading-order continuity, **memory sheet** for workflow discipline. Row 22 does not replace row 21 — it names **which appendix** to open when you are not on row 17's novel path. The [preface row 22 skill checkpoint](../preface.md#skill-navigation-row-22) closes the competence loop; the [memory sheet row 22 baby picture](memory-sheet.md#row-22-baby-picture-appendix-reference-mode) compresses the three-way split for index-card review; the [glossary reference mode section](glossary.md#appendix-reference-mode-row-22) is the upstream entry when symbol collision is the stall; the [prologue row 22 closing stitch](../prologue/00-many-scales.md#row-22-closing-stitch) and [epilogue Row 22 workflow exam](../epilogue/multiscale.md#row-22-workflow-exam) reunite prologue preview, skill checkpoint, and workflow exam when the three-way split can be recited in one breath.
...
## Meta-stitch decision ladder index (row 21) {#meta-stitch-decision-ladder-index-row-21}

Rows 17–20 are **layered meta-stitches** for narrative smoothness — not a menu to open on every page. Row 21 names **which layer to try first** when the continuity hinges index feels overwhelming mid-read. Start at the top; descend only when the layer above did not restore continuity.

| Layer | Row | Try when… | One-line action |
|-------|-----|-----------|-----------------|
| **First pass** | [17](../preface.md#skill-navigation-row-17) | Starting the book or re-reading for plot | Read Scene → Bridge straight through; pause only at I.4, VI.4, IX.3 |
| **Part boundary** | [18](../preface.md#skill-navigation-row-18) | Row 17 stalls at a part opening (III→IV, VI→VII) | Recite [part plot spine one line](../part01-linear-algebra/00-opening.md#plot-spine-one-line) aloud |
| **Chapter interior** | [19](../preface.md#skill-navigation-row-19) | Scene and Bridge read fine but the chapter body loses the wire | Recite [chapter plot spine one line](../part01-linear-algebra/01-vectors-matrices.md#plot-spine-one-line) aloud |
| **Plot turn (gate)** | [20](../preface.md#skill-navigation-row-20) | Row 18–19 did not restore continuity at I.4, VI.4, or IX.3 | Recite [gate plot spine one line](../part01-linear-algebra/04-toward-infinity.md#plot-spine-one-line) aloud, then read the Bridge |
| **Workflow artifact** | [0–16](../preface.md#skill-navigation) | A computation, handshake, or pedigree export is missing | Open the matching skill row — not a meta-stitch |

**Baby picture:** row 21 is the **decision tree** for rows 17–20 — read like a novel first (row 17); add one sentence aloud only when continuity breaks at the matching layer. Do not open rows 0–16 during a first narrative pass unless a gate stalls **and** you need a concrete artifact (CHT log, SCF export, rate table). The [preface row 21 skill checkpoint](../preface.md#skill-navigation-row-21) closes the competence loop; the [memory sheet row 21 baby picture](memory-sheet.md#row-21-baby-picture-meta-stitch-decision-ladder) compresses the five-layer ladder for index-card review; the [prologue row 21 closing stitch](../prologue/00-many-scales.md#row-21-closing-stitch) and [epilogue Row 21 workflow exam](../epilogue/multiscale.md#row-21-workflow-exam) reunite prologue preview, skill checkpoint, and workflow exam when the decision tree can be recited in one breath.

## Continuous read-through guide {#continuous-read-through-guide}

Rows 0–16 in the [continuity hinges index](#continuity-hinges-index-when-the-plot-stutters) are **detour maps** — use them when abstraction rises faster than the specimen. Row 17 is the **straight-through map** — how to read Preface → Epilogue as one continuous story without opening every skill checkpoint mid-climb. When rows 17–20 themselves feel overwhelming, start with the [meta-stitch decision ladder (row 21)](#meta-stitch-decision-ladder-index-row-21) — five layers, one decision per stall. When you are **mid-project** (tuning input decks, debugging units, jumping between parts) and glossary, sources, and memory sheet feel interchangeable, start with the [appendix reference mode (row 22)](#appendix-reference-mode-index-row-22) — symbols → glossary, plot → row 21, workflow → memory sheet rows 0–16.
