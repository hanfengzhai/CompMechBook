...
When **Part VII forest statistics are clear but Part VIII LAMMPS still feels disconnected from OpenDiS mobility** — not at this Bridge, but after [VII.3](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-to-part-viii) — read the [Part VII → VIII descent hinge reunion index](../appendix/sources.md#part-vii-viii-descent-hinge-reunion-index-row-33) (row 33) at [VII.2's mobility Lab act](../part07-defects/02-dislocation-dynamics.md#lab-act-calibrate-screw-mobility-from-md-shear-act-iv--mobility-prelude). Row 33 reunites **mesoscale segments with atomistic pedigree**; row 32 remains the audit when return-mapping at the knee still feels like fitted \(H\) without reading the [intermission](#intermission-ascent-ends-descent-begins).
