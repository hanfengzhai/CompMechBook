...
| 9 | Sobolev energy-space bridge; Poincaré controls \(\|u\|_{L^2}\) by \(\|\nabla u\|_{L^2}\) | On a fixed domain with zero trace, gradient energy controls total energy | [II.2](02-normed-spaces.md), [II.3](03-hilbert-spaces.md); [Part III.3](../part03-pdes/03-sobolev-spaces.md) |
| 10 | Why Lebesgue and Sobolev: \(C^1\) too small; completion by integral norms | Classical smooth functions cannot fill \(L^2\); integral norms complete the space | [II.2](02-normed-spaces.md); [Part III.3](../part03-pdes/03-sobolev-spaces.md) |
| 11 | FEM existence in \(S_h\); Riesz gives unique \(u_h\); energy projection | A discrete trial space inherits existence from the same Riesz geometry as \(H^1\) | [II.5](05-spectral-theorem.md) → Part IV |
| 12 | Riemann vs Lebesgue integration; zero-measure changes | Changing a function on a set of measure zero does not change its integral | [II.2](02-normed-spaces.md) (motivation for \(L^p\)) |
| 13a | Baire Category Theorem: complete spaces are not countable unions of nowhere-dense sets | A complete room cannot be built from countably many paper-thin layers | [II.4](04-operators-duality.md) (Banach operators) |
| 13b | Open Mapping, Bounded Inverse, Banach–Steinhaus: stability of Banach operators | Surjective/invertible maps have bounded inverses; pointwise bounded families are uniformly bounded | [II.4](04-operators-duality.md) (uniform boundedness preview) |
| 14 | Variational + FEM ladder: strong → weak → Lax–Milgram → Galerkin → Céa | Existence climbs the ladder; convergence rates descend through interpolation | [II.5](05-spectral-theorem.md) → [Part III](../part03-pdes/00-opening.md#representative-schematics-me-412-part-iii) → Part IV |
...
Schematic **13a** is the **existence foundation** behind the Big Four: Baire guarantees that in a complete Banach space, "most" operators behave generically — the category-theoretic reason pathological counterexamples are rare in well-posed mechanics. Schematic **13b** is the **stability trio** engineers feel every day: Open Mapping and Bounded Inverse say invertible PDE operators have bounded solution maps; Banach–Steinhaus (uniform boundedness) says FEM stability constants must be **uniform in \(h\)** — the discrete echo previewed in [II.4's Lab act](04-operators-duality.md#lab-act-nodal-force-versus-distributed-weight-act-iii-load-handling). Read 13a when a proof invokes genericity; read 13b when mesh refinement oscillates despite a "correct" weak form.

Schematic **14** is the **plot spine** of Acts I–III in the book: existence climbs the ladder (strong PDE → weak form → coercivity → discrete Galerkin); convergence rates descend through interpolation (Céa's lemma, Aubin–Nitsche). Part II supplies the middle rungs; [Part III's ME 412 cross-index](../part03-pdes/00-opening.md#representative-schematics-me-412-part-iii) maps schematics 5, 8a, 8b, 9, 10, and 14 onto the copper wire's PDE chapters; [Part IV's ME 412 cross-index](../part04-fem/00-opening.md#representative-schematics-me-412-part-iv) completes schematics 6, 8a, 11, and 14 on assembly and convergence. The copper wire's tensile equilibrium is one instance of that ladder — the load cell curve is trustworthy only when every rung is in place.
