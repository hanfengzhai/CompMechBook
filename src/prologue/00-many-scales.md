...
| Joule heat → fixed-grip stress (row 13) | [Preface: row 13 skill checkpoint](../preface.md#skill-navigation-row-13) — [Handshake 2 opening](../epilogue/multiscale.md#handshake-2-opening) → [IX.3 \(\alpha\) Lab act](../part09-dft/03-dft-workflows.md#lab-act-quasiharmonic-alpha-handshake-3-pedigree) → [Handshake 3](../epilogue/multiscale.md#handshake-3--thermal-strain--mechanical-stiffness-part-vi--iv); [prologue row 13 preview](#prologue-row-13-preview); epilogue [Act II reunion paragraph](../epilogue/multiscale.md#act-ii-reunion-handshake-2) (Handshake 2) and [Act III reunion paragraph](../epilogue/multiscale.md#act-iii-reunion-handshake-3) (Handshake 3); [sensitivity derivation opening](../epilogue/multiscale.md#worked-example-sensitivity-ranks) (Handshake 2–3 chain) |
| DDD rate → lab load cell (Handshake 4a) | [Preface: row 14 skill checkpoint](../preface.md#skill-navigation-row-14) — [VII.3 rate handshake](../part07-defects/03-polycrystal-and-fem-handoff.md#scale-boundary-handshake-ddd-strain-rate-to-quasi-static-fem) → [epilogue Handshake 4a](../epilogue/multiscale.md#handshake-4--rate-dependent-hardening-and-notch-localization-part-vii--vi--viii); [prologue row 14 preview](#prologue-row-14-preview-handshake-4a); epilogue [Act IV reunion paragraph](../epilogue/multiscale.md#act-iv-reunion-handshake-4a); [`parse_rate.sh`](../scripts/parse_rate.sh); [sensitivity derivation opening](../epilogue/multiscale.md#worked-example-sensitivity-ranks) (Handshake 4a paragraph when Act IV bends the curve); [Act IV skill row](../epilogue/multiscale.md#what-you-should-be-able-to-do-after-the-book); [memory sheet row 14](../appendix/memory-sheet.md#continuity-hinges-master-map) |
| FE² notch → Act V localization (Handshake 4b) | [Preface: row 15 skill checkpoint](../preface.md#skill-navigation-row-15) — [VII.3 Step 4 FE²](../part07-defects/03-polycrystal-and-fem-handoff.md#step-4--when-offline-calibration-fails-fe-at-the-notch) → [epilogue Handshake 4b](../epilogue/multiscale.md#4b--when-continuum-fails-at-the-notch-md-subdomain-act-v--notch); [prologue row 15 preview](#prologue-row-15-preview-handshake-4b); epilogue [Handshake 4b opening paragraph](../epilogue/multiscale.md#handshake-4b-opening), [Act V reunion paragraph](../epilogue/multiscale.md#act-v-reunion-handshake-4b), and [VII.3 Bridge Act V reunion paragraph](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-act-v-reunion-handshake-4b); [`parse_fe2.sh`](../scripts/parse_fe2.sh); [sensitivity derivation](../epilogue/multiscale.md#worked-example-sensitivity-ranks) (Handshake 4b column); [Act V skill row](../epilogue/multiscale.md#what-you-should-be-able-to-do-after-the-book); [memory sheet row 15](../appendix/memory-sheet.md#continuity-hinges-master-map); upstream rate from [row 14](../preface.md#skill-navigation-row-14) |
| Part IX reunion → coupling (row 16) | [Preface: descent hinges](../preface.md#descent-continuity-hinges) — [VIII midpoint reunion](../part09-dft/00-opening.md#third-descent-rung-viii-midpoint-reunion) → [IX.3 intermission](../part09-dft/03-dft-workflows.md#intermission-electronics-ends-coupling-begins) → [epilogue ME 412 coupling ladder](../epilogue/multiscale.md#the-coupling-ladder-me-412-cross-index); [prologue row 16 preview](#prologue-row-16-preview-part-ix-reunion); [memory sheet row 10](../appendix/memory-sheet.md#continuity-hinges-master-map) |
...
| Row 13 preview (Acts II–III) | Name Handshake 2 vs Handshake 3 before the epilogue reunites them | One sentence: "\(\Delta T\) from CHT; \(\alpha\Delta T\) from IX.3" — [preface row 13](../preface.md#skill-navigation-row-13); [Handshake 2](../epilogue/multiscale.md#handshake-2--joule-heating--conjugate-heat-transfer-part-iv--v) → [IX.3 \(\alpha\) Lab act](../part09-dft/03-dft-workflows.md#lab-act-quasiharmonic-alpha-handshake-3-pedigree) → [Handshake 3](../epilogue/multiscale.md#handshake-3--thermal-strain--mechanical-stiffness-part-vi--iv); epilogue [Act II reunion paragraph](../epilogue/multiscale.md#act-ii-reunion-handshake-2) (Handshake 2) and [Act III reunion paragraph](../epilogue/multiscale.md#act-iii-reunion-handshake-3) (Handshake 3); [sensitivity derivation worksheet opening](../epilogue/multiscale.md#worked-example-sensitivity-ranks) (Handshake 2 paragraph when Act II activates, Handshake 3 paragraph when Act III ramps); [Act II skill row](../epilogue/multiscale.md#what-you-should-be-able-to-do-after-the-book) and [Act III skill row](../epilogue/multiscale.md#what-you-should-be-able-to-do-after-the-book); [memory sheet row 13](../appendix/memory-sheet.md#continuity-hinges-master-map) baby picture; [`parse_cht.sh`](../scripts/parse_cht.sh) and [`parse_alpha.sh`](../scripts/parse_alpha.sh) |
| Handshake 4a preview (Act IV) | Explain why DDD at \(10^3\,\text{s}^{-1}\) cannot feed a \(10^{-3}\,\text{s}^{-1}\) load cell without extrapolation | Sketch: power-law \(m\) bridges timestep and grip speed — [preface row 14](../preface.md#skill-navigation-row-14); [VII.3 rate handshake](../part07-defects/03-polycrystal-and-fem-handoff.md#scale-boundary-handshake-ddd-strain-rate-to-quasi-static-fem) → [epilogue Handshake 4a](../epilogue/multiscale.md#handshake-4--rate-dependent-hardening-and-notch-localization-part-vii--vi--viii); epilogue [Act IV reunion paragraph](../epilogue/multiscale.md#lab-act-reunion-six-acts-one-afternoon) (Handshake 4a); [sensitivity derivation worksheet opening](../epilogue/multiscale.md#worked-example-sensitivity-ranks) (Handshake 4a paragraph when Act IV bends the curve); [Act IV skill row](../epilogue/multiscale.md#what-you-should-be-able-to-do-after-the-book); [memory sheet row 14](../appendix/memory-sheet.md#continuity-hinges-master-map) baby picture; [`parse_rate.sh`](../scripts/parse_rate.sh) |
| Handshake 4b preview (Act V) | Explain why scalar hardening from 4a may match bulk flow stress but under-predict notch-root localization | Sketch: FE² with DDD-active Gauss points vs crystal plasticity — [preface row 15](../preface.md#skill-navigation-row-15); [VII.3 Step 4 FE²](../part07-defects/03-polycrystal-and-fem-handoff.md#step-4--when-offline-calibration-fails-fe-at-the-notch); [prologue row 15 preview](#prologue-row-15-preview-handshake-4b); epilogue [FE² worked example](../epilogue/multiscale.md#worked-example-fe-at-the-wire-notch-act-v--notch), [Act V reunion paragraph](../epilogue/multiscale.md#act-v-reunion-handshake-4b), [sensitivity derivation worksheet opening](../epilogue/multiscale.md#worked-example-sensitivity-ranks) (Handshake 4b paragraph when Act V activates), and [sensitivity derivation worksheet closing](../epilogue/multiscale.md#worked-example-sensitivity-ranks); [Act V skill row](../epilogue/multiscale.md#what-you-should-be-able-to-do-after-the-book); [memory sheet row 15](../appendix/memory-sheet.md#continuity-hinges-master-map) baby picture; upstream rate from [row 14](../preface.md#skill-navigation-row-14) |
| Row 16 preview (Act VI foundation → coupling) | Explain why SCF archive complete ≠ multiscale workflow complete | Sketch: `cu.foundation/` → `multiscale_export.yaml` — [preface row 16](../preface.md#skill-navigation-row-16); [VIII midpoint reunion](../part09-dft/00-opening.md#third-descent-rung-viii-midpoint-reunion) → [IX.3 intermission](../part09-dft/03-dft-workflows.md#intermission-electronics-ends-coupling-begins) → [IX.3 Bridge to epilogue](../part09-dft/03-dft-workflows.md#bridge-to-the-epilogue) → [epilogue ME 412 coupling ladder](../epilogue/multiscale.md#the-coupling-ladder-me-412-cross-index); [prologue row 16 preview](#prologue-row-16-preview-part-ix-reunion); [memory sheet row 10](../appendix/memory-sheet.md#continuity-hinges-master-map); [`parse_multiscale_workflow.sh`](../scripts/parse_multiscale_workflow.sh) |

None of these require running a code — but each one is the navigation discipline the Functional Analysis Notes layout assumes at every part opening. The last four rows are **forward-looking** mirrors of the [epilogue workflow exam](../epilogue/multiscale.md#what-you-should-be-able-to-do-after-the-book): you will not produce [`parse_alpha.sh`](../scripts/parse_alpha.sh), [`parse_rate.sh`](../scripts/parse_rate.sh), [`parse_fe2.sh`](../scripts/parse_fe2.sh), or [`parse_multiscale_workflow.sh`](../scripts/parse_multiscale_workflow.sh) artifacts until Parts IV–IX, but naming Handshakes 2–3, 4a, 4b, and the Part IX → coupling reunion here keeps Acts II–VI from feeling like separate courses when mathematical order (I→IX) and laboratory time diverge on the same afternoon. If you can locate a chapter on the ladder, name the four questions it answers, and say which lab act the operator is watching, Part I's \(\mathbf{K}\mathbf{u}=\mathbf{f}\) will not feel like a new subject. It will feel like the bottom rung of a story you have already started.

#### Row 13 preview — Joule heat → fixed-grip stress {#prologue-row-13-preview}

**Baby picture:** Handshake 2 sets \(\Delta T\); Handshake 3 sets \(\alpha\Delta T\) — conflating them is the most common multiscale pedigree error on the heated wire. The [epilogue Handshake 2 opening paragraph](../epilogue/multiscale.md#handshake-2-opening) is the downstream workflow mirror of this preview: conjugate heat transfer (Parts IV–V) converges \(T_w\) before [IX.3's quasiharmonic \(\alpha\) Lab act](../part09-dft/03-dft-workflows.md#lab-act-quasiharmonic-alpha-handshake-3-pedigree) and [Handshake 3](../epilogue/multiscale.md#handshake-3--thermal-strain--mechanical-stiffness-part-vi--iv) set fixed-grip thermal stress. When Act II activates, read the [Act II reunion paragraph](../epilogue/multiscale.md#act-ii-reunion-handshake-2); when Act III ramps load, read the [Act III reunion paragraph](../epilogue/multiscale.md#act-iii-reunion-handshake-3), [IX.3's Bridge Act III reunion paragraph](../part09-dft/03-dft-workflows.md#bridge-act-iii-reunion-handshake-3), and [memory sheet row 13](../appendix/memory-sheet.md#continuity-hinges-master-map); the [preface row 13 skill checkpoint](../preface.md#skill-navigation-row-13) and [sensitivity derivation worksheet closing](../epilogue/multiscale.md#worked-example-sensitivity-ranks) close the competence loop when that paragraph lands.

#### Row 14 preview — DDD rate → lab load cell {#prologue-row-14-preview-handshake-4a}

**Baby picture:** VII.3 sets \(\tau_{\text{flow}}(\dot\varepsilon_{\text{DDD}})\); Handshake 4a sets \(\tau_{\text{lab}}\) — conflating DDD timestep strain rate with lab grip speed overpredicts yield. The [epilogue Handshake 4a opening paragraph](../epilogue/multiscale.md#handshake-4a-opening) is the downstream workflow mirror of this preview: [VII.2's forest Lab act](../part07-defects/02-dislocation-dynamics.md#lab-act-read-the-hardening-bend-from-forest-density-act-iv) and [VII.3's rate handshake](../part07-defects/03-polycrystal-and-fem-handoff.md#scale-boundary-handshake-ddd-strain-rate-to-quasi-static-fem) export \(\tau(\gamma)\) before [Handshake 4a](../epilogue/multiscale.md#handshake-4--rate-dependent-hardening-and-notch-localization-part-vii--vi--viii) extrapolates to lab grip speed. When Act IV activates, read the [Act IV reunion paragraph](../epilogue/multiscale.md#act-iv-reunion-handshake-4a), [VII.3's Bridge Act IV reunion paragraph](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-act-iv-reunion-handshake-4a), and [memory sheet row 14](../appendix/memory-sheet.md#continuity-hinges-master-map); the [preface row 14 skill checkpoint](../preface.md#skill-navigation-row-14) and [sensitivity derivation worksheet closing](../epilogue/multiscale.md#worked-example-sensitivity-ranks) close the competence loop when that paragraph lands.

#### Row 15 preview — FE² notch → Act V localization {#prologue-row-15-preview-handshake-4b}

**Baby picture:** 4a sets bulk \(\tau_{\text{lab}}\); 4b asks whether scalar \(H\) suffices at the notch root — sequential homogenization can match bulk flow stress while under-predicting localization by 10–15%. The [epilogue Handshake 4b opening paragraph](../epilogue/multiscale.md#handshake-4b-opening) is the downstream workflow mirror of this preview: [VII.3 Step 4 FE²](../part07-defects/03-polycrystal-and-fem-handoff.md#step-4--when-offline-calibration-fails-fe-at-the-notch) marks DDD-active Gauss points before [Handshake 4b](../epilogue/multiscale.md#4b--when-continuum-fails-at-the-notch-md-subdomain-act-v--notch) quantifies the root-stress uplift. When Act V activates, read the [Act V reunion paragraph](../epilogue/multiscale.md#act-v-reunion-handshake-4b), [VII.3's Bridge Act V reunion paragraph](../part07-defects/03-polycrystal-and-fem-handoff.md#bridge-act-v-reunion-handshake-4b), and [memory sheet row 15](../appendix/memory-sheet.md#continuity-hinges-master-map); the [preface row 15 skill checkpoint](../preface.md#skill-navigation-row-15) and [sensitivity derivation worksheet closing](../epilogue/multiscale.md#worked-example-sensitivity-ranks) close the competence loop when that paragraph lands. Upstream rate extrapolation must come from [row 14 preview](#prologue-row-14-preview-handshake-4a) first — FE² inherits the same `hardening.yaml` that Handshake 4a calibrated.

#### Row 16 preview — Part IX reunion → coupling {#prologue-row-16-preview-part-ix-reunion}

**Baby picture:** Part IX archives SCF exports; the epilogue composes them — conflating *downward audit complete* with *workflow complete* is the most common pedigree error after the finest rung. The [Part IX third descent rung](../part09-dft/00-opening.md#third-descent-rung-viii-midpoint-reunion) reunites atomistic trajectories with electron density on the same fcc cell; [IX.3's intermission](../part09-dft/03-dft-workflows.md#intermission-electronics-ends-coupling-begins) is the last electronic page before upward homogenization. When Act VI foundation folders exist but no handshake connects them to the load cell, read the [IX.3 Bridge to epilogue](../part09-dft/03-dft-workflows.md#bridge-to-the-epilogue), the [epilogue ME 412 coupling ladder](../epilogue/multiscale.md#the-coupling-ladder-me-412-cross-index), and [memory sheet row 10](../appendix/memory-sheet.md#continuity-hinges-master-map); the [preface row 16 skill checkpoint](../preface.md#skill-navigation-row-16) and [sensitivity derivation worksheet closing](../epilogue/multiscale.md#worked-example-sensitivity-ranks) close the competence loop when that reunion lands; the [preface descent continuity hinges](../preface.md#descent-continuity-hinges) name the electronic → coupling turn in one row.
