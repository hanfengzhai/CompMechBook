...
The [preface ascent preview chain](../preface.md#ascent-preview-chain) placed energy methods as the last Part III chapter so Rayleigh–Ritz could hand directly to Galerkin assembly in Part IV — the same contract the scale-boundary table above names row by row.
