...
When pointwise PDEs break at the grip corner but virtual work still balances — that is the signal the weak form is the correct continuum statement, not a numerical convenience. Turn the page through [Writings canonical landing (II.5 → III.0)](#writings-canonical-landing-ii5-to-iii0) when [`writings/functional-analysis`](../../writings/functional-analysis/chapters/SUMMARY.md) closes and [`writings/pde`](../../writings/pde/chapters/SUMMARY.md) opens like two mdBooks — [III.1](01-strong-form.md) inherits \(a(u,v)\) and \(\ell\) from Part II, not a fresh symbol table.
