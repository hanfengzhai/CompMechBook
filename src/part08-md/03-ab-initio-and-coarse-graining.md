...
When **this Bridge names Part IX but Born–Oppenheimer still feels like a new course** after row 35 restored yaml handoff tables, read the [coarse-graining → electronic audit reunion index](../appendix/sources.md#coarse-graining-electronic-audit-reunion-index-row-36) (row 36) at the [preface reading rhythm](../preface.md#reading-rhythm) before opening [IX.1](../part09-dft/01-born-oppenheimer.md). Row 35 remains the audit when [VIII.2's Bridge](02-ensembles-integrators.md#bridge) named exports but trajectories still sit beside raw dump files without the [pedigree checklist](#pedigree-checklist-before-the-epilogue) above.
