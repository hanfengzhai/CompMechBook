...
When **this Bridge names Part IX but Born–Oppenheimer still feels like a new course** after row 35 restored yaml handoff tables, read the [coarse-graining → electronic audit reunion index](../appendix/sources.md#coarse-graining-electronic-audit-reunion-index-row-36) (row 36) at the [preface coarse-graining → electronic audit thread](../preface.md#reading-rhythm) before opening [IX.1](../part09-dft/01-born-oppenheimer.md). Row 35 remains the audit when [VIII.2's Bridge](02-ensembles-integrators.md#bridge) named exports but trajectories still sit beside raw dump files without the [pedigree checklist](#pedigree-checklist-before-the-epilogue) above.

When **the pedigree checklist has consumer rows filled but Part IX.0 still feels like standalone DFT coursework** — `cu.foundation/` lacks `cu.relax.out`, or phonon folders cite 300 K only — read the [coarse-graining → electronic audit reunion index](../appendix/sources.md#coarse-graining-electronic-audit-reunion-index-row-36) (row 36) and the [preface coarse-graining → electronic audit thread](../preface.md#reading-rhythm) before opening [Part IX](../part09-dft/00-opening.md). Row 36 reunites **handoff tables with SCF audit gates**; row 35 remains the audit when yaml exports still feel disconnected from converged trajectories.

When **`cu.relax.out` exists but Born–Oppenheimer still feels like a new course after Part IX opens** — SCF logs sit beside EAM moduli without naming \(V_{\text{BO}}(\{\mathbf{R}_I\})\) — read the [electronic audit → Born–Oppenheimer reunion index](../appendix/sources.md#electronic-audit-born-oppenheimer-reunion-index-row-37) (row 37) at the [preface electronic audit → Born–Oppenheimer thread](../preface.md#reading-rhythm) before opening [IX.1](../part09-dft/01-born-oppenheimer.md). Row 37 reunites **SCF audit with theorem vocabulary**; row 36 remains the audit when SCF pedigree itself is still missing.
